...
Begin VB.Form frmPOZIndefa 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   4
      Tag             =   "GID|T|N|||rae_hidrantes|gid||S|"
      Text            =   "Dat"
      Top             =   4680
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   5
      Tag             =   "Text|T|N|||rae_hidrantes|text|||"
      Text            =   "Dato2"
      Top             =   4680
      Width           =   1395
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmPOZIndefa.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   3
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmPOZIndefa"
...
Private Sub BotonVerTodos()
    If NumDigit = 0 Then
        CargaGrid "apudirec='S'"
    Else
        If ConApudirec Then
            CargaGrid "(length(codmacta) = " & NumDigit & " or apudirec = 'S')"
        Else
            CargaGrid "length(codmacta) = " & NumDigit
        End If
    End If
    CadB = ""
    PonerModo 2
    ...
    Select Case Modo
        Case 1  'BUSQUEDA
            ...
            If CadB <> "" Then
                PonerModo 2
                If NumDigit = 0 Then
                    CargaGrid CadB & " AND apudirec='S'"
                Else
                    If ConApudirec Then
                        CargaGrid CadB & " AND (length(codmacta) = " & NumDigit & " or apudirec = 'S')"
                    Else
                        CargaGrid CadB & " AND length(codmacta) = " & NumDigit
                    End If
                End If
...
'        Else
            ...
            If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codmacta like " & DBSet(CodigoActual, "T"), "", True
            End If
'        End If
    End If
End Sub
...
'    PonerOpcionesMenu  'En funcion del usuario
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "Select gid, text from rae_hidrantes "
    '************************************************************************
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    adodc1.ConnectionString = ConnIndefa 'BD de la Contabilidad
    If vSQL <> "" Then
    ...
    'codmacta, nommacta
    tots = "S|txtAux(0)|T|Código|1000|;S|txtAux(1)|T|Text|3400|;"
