...
Begin VB.Form frmManCGastosNom 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Conceptos Gastos Nómina / Campo"
   ClientHeight    =   6210
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   6375
   Icon            =   "frmManCGastosNom.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6210
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   40
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||rconcepgastonom|nomgasto|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|99|rconcepgastonom|codgasto|00|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManCGastosNom.frx":000C
      Height          =   4545
      Left            =   120
      TabIndex        =   6
      Top             =   885
   ...
   End
End
Attribute VB_Name = "frmManCGastosNom"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("rconcepgastonom", "codgasto")
    End If
    '********************************************************************
...
Private Sub BotonBuscar()
    ...
    CargaGrid "rconcepgastonom.codgasto = -1"
    '*******************************************************************************
    'Buscar
    For I = 0 To txtAux.Count - 1
        txtAux(I).Text = ""
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar el Concepto de Gasto Nómina?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from rconcepgastonom where codgasto=" & adodc1.Recordset!Codgasto
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rconcepgastonom.codgasto, rconcepgastonom.nomgasto"
    CadenaConsulta = CadenaConsulta & " FROM rconcepgastonom"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY rconcepgastonom.codgasto"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Código|800|;S|txtAux(1)|T|Descripción|4850|;"
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "rconcepgastonom"
        .Informe2 = "rManCGastosNom.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rconcepgastonom.codgasto}|"
