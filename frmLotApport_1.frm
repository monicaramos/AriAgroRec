...
Begin VB.Form frmLotApport_1 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   50
      TabIndex        =   11
      Tag             =   "Referencia|T|S|||lotapport1|Reference|||"
      Top             =   4905
      Width           =   2340
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Fecha|FH|N|||lotapport1|Creation_lot|dd/mm/yyyy hh:mm:ss||"
      Top             =   4920
      Width           =   2340
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   8
      TabIndex        =   0
      Tag             =   "Lote|N|N|0|99999999|lotapport1|Numero_lot|00000000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmLotApport_1.frx":000C
      Height          =   4545
      Left            =   150
      TabIndex        =   6
      Top             =   840
   ...
   End
End
Attribute VB_Name = "frmLotApport_1"
...
Private Sub BotonBuscar()
    ...
    CargaGrid "lotapport1.numero_lot = -1"
    '*******************************************************************************
    'Buscar
    For i = 0 To txtAux.Count - 1
        txtAux(i).Text = ""
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = Sql & vbCrLf & "Lote: " & adodc1.Recordset.Fields(0)
    Sql = Sql & vbCrLf & "Fecha Creación: " & adodc1.Recordset.Fields(1)
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from lotapportresultat1 where numero_lot=" & adodc1.Recordset!numero_lot
        conn.Execute Sql
        
        Sql = "Delete from lotapport1 where numero_lot=" & adodc1.Recordset!numero_lot
        conn.Execute Sql
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "coddeposito=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT lotapport1.numero_lot, lotapport1.Creation_lot, lotapport1.Reference "
    CadenaConsulta = CadenaConsulta & " FROM lotapport1 "
    CadenaConsulta = CadenaConsulta & " WHERE 1 = 1 and " & cadWhere
    '************************************************************************
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY lotapport1.Numero_lot"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Lote|1200|;S|txtAux(1)|T|Fecha Creación|2250|;S|txtAux(2)|T|Referencia|5600|;"
...
Private Sub txtAux_LostFocus(Index As Integer)
    ...
    Select Case Index
        ...
        Case 1
            txtAux(Index).Text = Format(txtAux(Index), "FH")
