...
Begin VB.Form frmEntPesadaPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   10725
   Icon            =   "frmEntPesadaPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   9225
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   13
      Tag             =   "Fecha Pesada|F|N|||rpesadas|fecpesada|dd/mm/yyyy||"
      Top             =   4950
      Width           =   1035
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   12
      Tag             =   "Kilos Neto|N|N|||rpesadas|kilosnet|###,###,##0||"
      Top             =   4950
      Width           =   1965
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   11
      Tag             =   "Kilos Bruto|N|N|||rpesadas|kilosbrut|###,###,##0||"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   2
      Tag             =   "Nombre Transportista|T|N|||rtransporte|nomtrans|||"
      Top             =   4950
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   1
      Tag             =   "Código Transp.|T|N|||rpesadas|codtrans||N|"
      Top             =   4950
      Width           =   1095
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Numero Pesada|N|S|1|9999999|rpesadas|nropesada|0000000|S|"
      Top             =   4950
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmEntPesadaPrev.frx":000C
      Height          =   8145
      Left            =   120
      TabIndex        =   7
      Top             =   330
   ...
   End
End
Attribute VB_Name = "frmEntPesadaPrev"
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select nropesada, fecpesada, rpesadas.codtrans, rtransporte.nomtrans, rpesadas.kilosbrut, rpesadas.kilosnet from rpesadas, rtransporte "
    CadenaConsulta = CadenaConsulta & " where rpesadas.codtrans = rtransporte.codtrans "
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    tots = "S|txtAux(0)|T|Pesada|1100|;S|txtAux(1)|T|Fecha|1300|;S|txtAux(2)|T|Código|1000|;S|txtAux(3)|T|Transportista|3670|;S|txtAux(4)|T|K.Bruto|1400|;S|txtAux(5)|T|K.Neto|1400|;"
