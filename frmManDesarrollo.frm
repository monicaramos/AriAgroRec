...
Begin VB.Form frmManDesarrollo 
   ...
   ClientTop       =   30
   ClientWidth     =   5940
   Icon            =   "frmManDesarrollo.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6060
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||rdesarrollo|nomdesa|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|99|rdesarrollo|coddesa|00|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManDesarrollo.frx":000C
      Height          =   4545
      Left            =   150
      TabIndex        =   6
      Top             =   780
   ...
   End
End
Attribute VB_Name = "frmManDesarrollo"
...
Private Sub BotonBuscar()
    ...
    CargaGrid "rdesarrollo.coddesa = -1"
    '*******************************************************************************
    'Buscar
    For i = 0 To txtAux.Count - 1
        txtAux(i).Text = ""
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar el Desarrollo Vegetativo?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from rdesarrollo where coddesa=" & adodc1.Recordset!Coddesa
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "coddesa=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rdesarrollo.coddesa, rdesarrollo.nomdesa"
    CadenaConsulta = CadenaConsulta & " FROM rdesarrollo"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY rdesarrollo.coddesa"
    '**************************************************************++
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "rdesarrollo"
        .Informe2 = "rManDesarrollo.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rdesarrollo.coddesa}|"
