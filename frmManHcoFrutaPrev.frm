...
Begin VB.Form frmManHcoFrutaPrev 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Histórico Fruta Clasificada"
   ClientHeight    =   6465
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   10725
   Icon            =   "frmManHcoFrutaPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6465
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   11
      Tag             =   "Nombre|T|N|||variedades|codvarie|000000||"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   2
      Tag             =   "Variedad|N|N|||rhisfruta|codvarie|000000||"
      Top             =   4950
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   1
      Tag             =   "Fecha|F|N|||rhisfruta|fecalbar|dd/mm/yyyy||"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código|N|N|||rhisfruta|numalbar|0000000|S|"
      Top             =   4950
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManHcoFrutaPrev.frx":000C
      Height          =   5265
      Left            =   120
      TabIndex        =   7
      Top             =   330
   ...
   End
End
Attribute VB_Name = "frmManHcoFrutaPrev"
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select rhisfruta.numalbar, rhisfruta.fecalbar, rhisfruta.codvarie, variedades.nomvarie, rhisfruta.codsocio, rsocios.nomsocio, rhisfruta.codcampo "
    CadenaConsulta = CadenaConsulta & " from (rhisfruta inner join variedades on rhisfruta.codvarie = variedades.codvarie) inner join rsocios on rhisfruta.codsocio = rsocios.codsocio where (1=1) "
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    tots = "S|txtAux(0)|T|Albarán|900|;S|txtAux(1)|T|Fecha|1200|;S|txtAux(2)|T|Codigo|900|;S|txtAux(3)|T|Nombre|2100|;S|txtAux(4)|T|Socio|900|;S|txtAux(5)|T|Nombre|2700|;S|txtAux(6)|T|Campo|1150|;"
