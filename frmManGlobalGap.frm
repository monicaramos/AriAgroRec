...
Begin VB.Form frmManGlobalGap 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   14
      TabIndex        =   2
      Tag             =   "Número GGN|N|S|||rglobalgap|numeroggn|00000000000000||"
      Top             =   4920
      Width           =   1485
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||rglobalgap|descripcion|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|T|N|||rglobalgap|codigo||S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManGlobalGap.frx":000C
      Height          =   4545
      Left            =   120
      TabIndex        =   7
      Top             =   810
   ...
   End
End
Attribute VB_Name = "frmManGlobalGap"
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar el registro de GlobalGap?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from rglobalgap where codigo=" & adodc1.Recordset!Codigo
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rglobalgap.codigo, rglobalgap.descripcion, rglobalgap.numeroggn "
    CadenaConsulta = CadenaConsulta & " FROM rglobalgap"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY rglobalgap.codigo"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Código|800|;S|txtAux(1)|T|Descripción|3950|;S|txtAux(2)|T|Numero GGN|1800|;"
