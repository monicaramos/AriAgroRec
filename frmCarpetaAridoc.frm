...
Begin VB.Form frmCarpetaAridoc 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Carpetas Aridoc"
   ClientHeight    =   5925
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5025
   Icon            =   "frmCarpetaAridoc.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5925
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   4
      Tag             =   "Código de Carpeta|N|N|||carpetas|codcarpeta|000|S|"
      Text            =   "Dat"
      Top             =   4680
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   5
      Tag             =   "Descripción de la Carpeta|T|N|||carpetas|nombre|||"
      Text            =   "Dato2"
      Top             =   4680
      Width           =   1395
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmCarpetaAridoc.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   3
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmCarpetaAridoc"
...
'        Else
            ...
            If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codcarpeta like " & DBSet(CodigoActual, "N"), "", True
            End If
'        End If
    End If
End Sub
...
'    PonerOpcionesMenu  'En funcion del usuario
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "Select codcarpeta, nombre FROM carpetas "
    '************************************************************************
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    adodc1.ConnectionString = ConnAridoc 'BD de la Contabilidad
    If vSQL <> "" Then
    ...
    'codmacta, nommacta
    tots = "S|txtAux(0)|T|Código|800|;S|txtAux(1)|T|Descripción|3000|;"
