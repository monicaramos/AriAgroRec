...
Begin VB.Form frmManHorasDestajoPica 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   8
      Tag             =   "Kilos Tirón|N|S|||horas|kilostiron|###,##0||"
      Top             =   4650
      Width           =   510
   End
   Begin VB.TextBox txtAux 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   3
      Tag             =   "Código|N|N|0|999999|horas|codcapat|000000|S|"
      Top             =   4650
      Width           =   800
   End
...
'    adodc1.ConnectionString = Conn
    ...
    tots = tots & "S|txtAux(0)|T|Codigo|1000|;S|btnBuscar(1)|B||195|;S|txtAux2(0)|T|Capataz|3400|;"
