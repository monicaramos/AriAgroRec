   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button9 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Object.ToolTipText     =   "Listado Comprobación"
         EndProperty
...
Dim I As Integer
    ...
    If Me.Adoaux(1).Recordset.RecordCount >= 7 Then
        MsgBox "Sólo se permiten un máximo de 7 líneas por albarán para que quepa en la impresión." & vbCrLf & vbCrLf & "Cree un nuevo albarán con el resto de movimientos.", vbExclamation
        Exit Sub
    End If
