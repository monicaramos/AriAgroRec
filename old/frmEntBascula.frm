...
Begin VB.Form frmEntBascula 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(17)=   "FrameDatosDtoAdministracion"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "Text5(3)"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "Text4(3)"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "Text3(3)"
      Tab(0).Control(20).Enabled=   0   'False
      Tab(0).Control(21)=   "Text1(2)"
      Tab(0).Control(21).Enabled=   0   'False
      Tab(0).Control(22)=   "Text2(2)"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "Combo1(0)"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "Text1(1)"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "Text2(1)"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "Text1(5)"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "Text2(3)"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "Text2(4)"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "Combo1(1)"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "Text2(12)"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "Text1(12)"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "Text2(6)"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "Text1(6)"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "Text2(7)"
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   8
         TabIndex        =   5
         Tag             =   "Código Campo|N|N|1|99999999|rcampos|codcampo|00000000|N|"
         Top             =   1272
         Width           =   855
      End
      Begin VB.TextBox Text2 
      ...
      Begin VB.Frame FrameDatosDtoAdministracion 
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.TextBox Text1 
               ...
               MaxLength       =   3
               TabIndex        =   12
               Tag             =   "Nro.Cajas 1|N|S|0|999|rentradas|numcajo1|##0||"
               Top             =   480
               Width           =   1215
            End
            Begin VB.TextBox Text1 
            ...
            Begin VB.TextBox Text1 
               ...
               MaxLength       =   3
               TabIndex        =   13
               Tag             =   "Nro.Cajas 2|N|S|0|999|rentradas|numcajo2|##0||"
               Top             =   840
               Width           =   1215
            End
            Begin VB.TextBox Text1 
               ...
               MaxLength       =   3
               TabIndex        =   14
               Tag             =   "Nro.Cajas 3|N|S|0|999|rentradas|numcajo3|##0||"
               Top             =   1200
               Width           =   1215
            End
            Begin VB.TextBox Text1 
               ...
               MaxLength       =   3
               TabIndex        =   15
               Tag             =   "Nro.Cajas 4|N|S|0|999|rentradas|numcajo4|##0||"
               Top             =   1560
               Width           =   1215
            End
            Begin VB.TextBox Text1 
               ...
               MaxLength       =   3
               TabIndex        =   16
               Tag             =   "Nro.Cajas 5|N|S|0|999|rentradas|numcajo5|##0||"
               Top             =   1890
               Width           =   1215
            End
            Begin VB.Line Line3 
...
Private Sub MandaBusquedaPrevia(CadB As String)
    ...
    NombreTabla1 = "(rcampos inner join rsocios on rcampos.codsocio = rsocios.codsocio) inner join variedades on rcampos.codvarie = variedades.codvarie "
...
'Dim Datos As String
    ...
    If b And (Modo = 3 Or Modo = 4) Then
        ...
        If b Then
            ...
            If Not CampoSocioVariedad(Text1(5).Text, Text1(1).Text, Text1(2).Text) Then
...
'                        frmCamp.NuevoCodigo = Text1(Index).Text
                ...
                Else
                    If Not EstaCampoDeAlta(Text1(Index).Text) Then
                        ...
                        PonerFoco Text1(Index)
                    Else
                        If Not CampoSocioVariedad(Text1(Index).Text, Text1(1).Text, Text1(2).Text) Then
...
Dim TaraVehi As Currency
    ...
    PesoNeto = PesoBruto - Tara1 - Tara2 - Tara3 - Tara4 - Tara5 - TaraVehi
