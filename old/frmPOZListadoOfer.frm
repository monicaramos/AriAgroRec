...
'
    ...
    Me.FrameEnvioMail.visible = False 'antes FrameEnvioFacMail????
    CommitConexion
    ...
    Select Case OpcionListado
        ...
        Case 315 'Envio masivo de Facturas
            indFrame = 18
            h = FrameEnvioMail.Height '??? antes framEnvioFacMail
            w = FrameEnvioMail.Width  '???
            PonerFrameVisible FrameEnvioMail, True, h, w '???
        ...
        If Cad1 <> "" Then 'HAY email --> ENVIAMOS e-mail
            ...
            If ImpresionNormal Then
                With frmImprimir
                    ...
                    .Opcion = 306
                    .FormulaSeleccion = Sql & " and " & "{tmpinformes.codusu} = " & vUsu.Codigo
                    .EnvioEMail = True
