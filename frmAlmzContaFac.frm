...
Begin VB.Form frmAlmzContaFac 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Integración Contable de Facturas de Almazara"
   ClientHeight    =   6540
   ClientLeft      =   45
   ClientTop       =   2430
   ClientWidth     =   6600
   Icon            =   "frmAlmzContaFac.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6540
   ...
   Begin VB.Frame FrameCobros 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.Image imgFec 
            ...
            Index           =   6
            Left            =   3315
            Picture         =   "frmAlmzContaFac.frx":000C
         ...
         Begin VB.Image imgFec 
            ...
            Index           =   5
            Left            =   1185
            Picture         =   "frmAlmzContaFac.frx":0097
            ToolTipText     =   "Buscar fecha"
            Top             =   645
            Width           =   240
         End
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Label Label1 
            Caption         =   "Serie Facturas Cliente"
            ForeColor       =   &H00972E0B&
            Height          =   195
            Index           =   1
            Left            =   180
         ...
         Begin VB.Image imgFec 
            ...
            Index           =   0
            Left            =   1710
            Picture         =   "frmAlmzContaFac.frx":0122
            ToolTipText     =   "Buscar fecha"
            Top             =   480
            Width           =   240
         End
         ...
         Begin VB.Image imgFec 
            ...
            Index           =   1
            Left            =   1710
            Picture         =   "frmAlmzContaFac.frx":01AD
            ToolTipText     =   "Buscar fecha"
            Top             =   810
            Width           =   240
         End
   ...
   End
End
Attribute VB_Name = "frmAlmzContaFac"
...
Dim cHasta As String
    ...
    If Not HayRegParaInforme("rcabfactalmz", cadSelect) Then Exit Sub

    ContabilizarFacturas "rcabfactalmz", cadSelect
     'Eliminar la tabla TMP
    BorrarTMPFacturas
    'Desbloqueamos ya no estamos contabilizando facturas
    DesBloqueoManual ("CONFAZ") 'CONtabilizar Facturas de AlmaZarara
...
Dim CCoste As String
    ...
    Sql = "CONALZ" 'contabilizar facturas de liquidacion de almazara
    
    'Bloquear para que nadie mas pueda contabilizar
    DesBloqueoManual (Sql)
    If Not BloqueoManual(Sql, "1") Then
        MsgBox "No se pueden Contabilizar Facturas de Almazara. Hay otro usuario contabilizando.", vbExclamation
        Screen.MousePointer = vbDefault
        Exit Sub
    End If
...
'    TerminaBloquear
    ...
    Sql = Sql & ".tipofichero=tmpFactu.tipofichero AND "
    ...
    'comprobar que todas las CUENTAS de ventas / gastos existen en la contabilidad
    'vparamaplic.ctaventasalmz, vparamaplic.ctagastosalmz IN (conta.cuentas.codmacta)
    '-----------------------------------------------------------------------------
    Me.lblProgres(1).Caption = "Comprobando Cuentas Contables Ventas/Gastos en contabilidad ..."
    ...
    'contabilizar existen en la Conta: rcabfactalmz.tipoiva IN (conta.tiposiva.codigiva)
    '--------------------------------------------------------------------------
    ...
    If vEmpresa.TieneAnalitica Then  'hay contab. analitica
       ...
       b = ComprobarCtaContable_new(cadTabla, 9)
       If b Then b = ComprobarCtaContable_new(cadTabla, 11)
       
' de momento catadau no tiene analitica
'       If b Then
...
'       End If
    ...
    '  LOG de acciones
    Set LOG = New cLOG
    LOG.Insertar 3, vUsu, "Contabilizar facturas Almazara: " & vbCrLf & cadTabla & vbCrLf & cadWHERE
    Set LOG = Nothing
    '-----------------------------------------------------------------------------
    ...
    If DevuelveValor("Select count(*) from tmpinformes where codusu = " & vUsu.Codigo) > 0 Then
        ...
        conSubRPT = False
        cadTitulo = "Listado contabilizacion FRAFAZ"
        cadNomRPT = "rContabFAZ.rpt"
        LlamarImprimir
    End If
    ...
    If numfactu > 0 Then
        ...
        While Not Rs.EOF And b
            ...
            If DBLet(Rs!tipofichero, "N") = 1 Then
               ...
               If PasarFacturaAlmzSoc(Sql, Orden2, txtcodigo(0).Text, txtcodigo(10).Text, TotalFactura, txtcodigo(3).Text) = False And b Then b = False
               TotalTesoreria = TotalTesoreria + TotalFactura
            Else
               TotalFactura = 0
               Facturas = Facturas & " " & Format(DBLet(Rs!numfactu, "N"), "0000000")
               If PasarFacturaAlmzCli(Sql, Orden2, txtcodigo(2).Text, TotalFactura, txtcodigo(9).Text) = False And b Then b = False
               TotalTesoreria = TotalTesoreria - TotalFactura
            End If
