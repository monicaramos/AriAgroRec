...
Begin VB.Form frmEntBasculaNat 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   8
         Tag             =   "Código Transporte|T1|S|||rentradas|codtrans|||"
         Top             =   3330
         Width           =   1005
      End
      Begin VB.TextBox Text2 
...
Private WithEvents frmEnt2 As frmEntBasculaNat2 'entrada de cajones de bascula
Attribute frmEnt2.VB_VarHelpID = -1
...
' de montifrut
    ...
    If crear = 1 Then
        ...
        b = InsertarPalets(Text1(0).Text, nroPalets, CStr(Numcajon), Text1(11).Text, Text1(10).Text, Text1(1).Text, Text1(2).Text, Palets)
        If Numcajon <> 0 Then
            If Palets <> "" Then
                Palets = "trzpalets.idpalet in (" & Mid(Palets, 1, Len(Palets) - 1) & ")"
                
                Set frmEnt2 = New frmEntBasculaNat2
                frmEnt2.NuevoCodigo = Palets
                frmEnt2.NumCajones = Numcajon
                frmEnt2.NumKilos = CLng(ComprobarCero(Text1(11).Text))
                frmEnt2.NumNotac = Text1(0).Text
                frmEnt2.Show vbModal
...
Private Function InsertarPalets(Albaran As String, Palets As Long, NumCajones As Long, NumKilos As Long, Fecha As Date, Socio As String, Variedad As String, ByRef IdPalets As String)
Dim nroPalets As Long
Dim Kilos As Long
Dim cajas As Long
Dim i As Long
...
Dim TotKilos As Long
    ...
    If Palets = 0 Then
        ...
        For i = 1 To nroPalets
            ...
            Sql = Sql & DBSet(KilosporPalet, "N") & "," & DBSet(Socio, "N") & "," & DBSet(Text1(5).Text, "N") & ","
    ...
    If Palets > 0 Then
        ...
        For i = 1 To nroPalets
            ...
            IdPalets = IdPalets & DBSet(NumF, "N") & ","
        Next i
...
Dim Cad As String
    ...
    '[Monica]11/04/2017: si la nota está volcada no permitimos hacer nada
    If NotaVolcada(Text1(0).Text) Then
        MsgBox "No se permite eliminar una nota que haya sido total o parcialmente volcada. Revise.", vbExclamation
        Exit Sub
    End If
...
'Dim Datos As String
    ...
    If Modo = 4 Then
        If (HanModificadoCajas Or HanModificadoKilos) Then
            If NotaVolcada(Text1(0).Text) Then
                MsgBox "No se permite modificar una nota que haya sido total o parcialmente volcada. Revise.", vbExclamation
                b = False
                PonerFoco Text1(25)
            End If
        End If
...
Private Function NotaVolcada(NumNotac As String) As Boolean
Dim Sql As String
    
    Sql = "select count(*) from trzlineas_cargas where idpalet in (select idpalet from trzpalets where numnotac = " & DBSet(NumNotac, "N") & ")"
    
    NotaVolcada = (TotalRegistros(Sql) <> 0)
...
'                        frmCamp.NuevoCodigo = Text1(Index).Text
                ...
                Else
                    If Not EstaCampoDeAlta(Text1(Index).Text) Then
                        ...
                        PonerFoco Text1(Index)
                    Else
                        '[Monica]13/08/2018: no se permiten entradas a campos de tratamientos
...
'    If Not (Modo = 3 Or Modo = 4) Then Exit Sub
    ...
    '[Monica]13/08/2018: no se permiten entradas a los campos de tratamiento
    Cad = Cad & " and rcampos.tipocampo <> 3"
...
Dim NumF As String
    ...
    Sql = Sql & " numcajo2, numcajo3, numcajo4, numcajo5 "
