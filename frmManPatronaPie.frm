...
Begin VB.Form frmManPatronaPie 
   ...
   ClientTop       =   30
   ClientWidth     =   5955
   Icon            =   "frmManPatronaPie.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6075
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||rpatronpie|nompatron|||"
      Top             =   4830
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|99|rpatronpie|codpatron|00|S|"
      Top             =   4830
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManPatronaPie.frx":000C
      Height          =   4545
      Left            =   120
      TabIndex        =   6
      Top             =   795
   ...
   End
End
Attribute VB_Name = "frmManPatronaPie"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("rpatronpie", "codpatron")
    End If
    '********************************************************************
...
Private Sub BotonBuscar()
    ...
    CargaGrid "rpatronpie.codpatron = -1"
    '*******************************************************************************
    'Buscar
    For I = 0 To txtAux.Count - 1
        txtAux(I).Text = ""
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar el Patrón Pie?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from rpatronpie where codpatron=" & adodc1.Recordset!Codpatron
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codpatron=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rpatronpie.codpatron, rpatronpie.nompatron"
    CadenaConsulta = CadenaConsulta & " FROM rpatronpie"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY rpatronpie.codpatron"
    '**************************************************************++
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "rpatronpie"
        .Informe2 = "rManPatronaPie.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rpatronpie.codpatron}|"
