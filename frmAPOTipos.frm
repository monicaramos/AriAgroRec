...
Begin VB.Form frmAPOTipos 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   3
      Tag             =   "Letra|T|S|||rtipoapor|letraser|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   2
      Tag             =   "Número|N|N|||rtipoapor|numero|0000000||"
      Top             =   4920
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||rtipoapor|nomaport|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|99|rtipoapor|codaport|000|S|"
      Top             =   4920
      Width           =   800
   End
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("rtipoapor", "codaport")
    End If
    '********************************************************************
...
Private Sub BotonBuscar()
    ...
    CargaGrid "rtipoapor.codaport = -1"
    '*******************************************************************************
    'Buscar
    For i = 0 To txtAux.Count - 1
        txtAux(i).Text = ""
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar el Tipo de Aportación?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from rtipoapor where codaport=" & adodc1.Recordset!Codaport
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codaport=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY rtipoapor.codaport"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Cód.|500|;S|txtAux(1)|T|Descripción|4050|;S|txtAux(2)|T|Número|1000|;S|txtAux(3)|T|Serie|600|;"
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "rtipoapor"
        .Informe2 = "rManTipoAportacion.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rtipoapor.codaport}|"
