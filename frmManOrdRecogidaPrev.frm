...
Begin VB.Form frmManOrdRecogidaPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   8880
   Icon            =   "frmManOrdRecogidaPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6465
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManOrdRecogidaPrev.frx":000C
      Height          =   5265
      Left            =   120
      TabIndex        =   7
      Top             =   330
   ...
   End
End
Attribute VB_Name = "frmManOrdRecogidaPrev"
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select nroorden, fecimpre, nrocampo, rordrecogida.codvarie, variedades.nomvarie "
    CadenaConsulta = CadenaConsulta & " from rordrecogida, variedades where rordrecogida.codvarie = variedades.codvarie "
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    tots = "S|txtAux(0)|T|Nro.Orden|1400|;S|txtAux(1)|T|Fecha|1400|;S|txtAux(2)|T|Nro.Campo|1400|;S|txtAux(3)|T|Variedad|1050|;S|txtAux(4)|T|Descripción|2700|;"
