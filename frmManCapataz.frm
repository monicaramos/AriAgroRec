...
Begin VB.Form frmManCapataz 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   3
      Tag             =   "Código|N|S|0|999999|rcapataz|codtraba|000000||"
      Top             =   4890
      Width           =   800
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   2
      Tag             =   "Código ETT|N|S|||rcapataz|codigoett|0000||"
      Top             =   4890
      Width           =   1005
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Nombre|T|N|||rcapataz|nomcapat|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
   ...
   End
End
Attribute VB_Name = "frmManCapataz"
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from rcapataz where codcapat=" & adodc1.Recordset!codcapat
        conn.Execute SQL
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rcapataz.codcapat, rcapataz.nomcapat, rcapataz.codigoett, rcapataz.codtraba, straba.nomtraba "
    CadenaConsulta = CadenaConsulta & " FROM rcapataz left join straba On rcapataz.codtraba = straba.codtraba "
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    SQL = SQL & " ORDER BY rcapataz.codcapat"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, SQL, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Código|800|;S|txtAux(1)|T|Descripción|3800|;S|txtAux(2)|T|Código ETT|1450|;"
    tots = tots & "S|txtAux(3)|T|Código|950|;S|btnBuscar(0)|B||195|;S|txtAux2(3)|T|Nombre Trabajador|4900|;"
...
Private Sub txtaux_KeyPress(Index As Integer, KeyAscii As Integer)
    If KeyAscii = teclaBuscar Then
        If Modo = 1 Or Modo = 3 Or Modo = 4 Then
            Select Case Index
                Case 3: KEYBusqueda KeyAscii, 0 'trabajador
            End Select
        End If
    Else
        KEYpress KeyAscii
