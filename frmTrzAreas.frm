...
Begin VB.Form frmTrzAreas 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   50
      TabIndex        =   1
      Tag             =   "Nombre|T|N|||trzareas|nomarea|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   0
      Tag             =   "Código|N|N|0|999|trzareas|codarea|000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmTrzAreas.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   6
      Top             =   675
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("trzareas", "codarea")
    End If
    '********************************************************************
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codarea=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT trzareas.codarea, trzareas.nomarea"
    CadenaConsulta = CadenaConsulta & " FROM trzareas"
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={trzareas.codarea}|"
