...
Begin VB.Form frmPOZPozos 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   8
      TabIndex        =   7
      Tag             =   "Importe Cuota Hda|N|N|||rtipopozos|imporcuotahda|##0.0000||"
      Top             =   4920
      Width           =   885
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   8
      TabIndex        =   5
      Tag             =   "Precio 2|N|S|||rtipopozos|precio2|##0.0000||"
      Top             =   4920
      Width           =   810
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   8
      TabIndex        =   3
      Tag             =   "Precio 1|N|N|||rtipopozos|precio1|##0.0000||"
      Top             =   4920
      Width           =   810
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   8
      TabIndex        =   6
      Tag             =   "Importe Cuota|N|N|||rtipopozos|imporcuota|##0.0000||"
      Top             =   4920
      Width           =   885
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   4
      Tag             =   "Hasta m3 2|N|S|||rtipopozos|hastametcub2|0000000||"
      Top             =   4920
      Width           =   1170
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   2
      Tag             =   "Hasta m3|N|N|||rtipopozos|hastametcub1|0000000||"
      Top             =   4920
      Width           =   750
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   40
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||rtipopozos|nompozo|||"
      Top             =   4920
      Width           =   1065
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código|N|N|0|999|rtipopozos|codpozo|000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmPOZPozos.frx":000C
      Height          =   4545
      Left            =   90
      TabIndex        =   12
      Top             =   945
...
'    '******************** canviar taula i camp **************************
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("rtipopozos", "codpozo")
    End If
'    '********************************************************************
...
Private Sub BotonModificar()
    ...
    'Llamamos al form
    txtAux(0).Text = DataGrid1.Columns(0).Text ' codpozo
    txtAux(1).Text = DataGrid1.Columns(1).Text ' nompozo
    txtAux(2).Text = DataGrid1.Columns(2).Text ' hasta m3 1
    
    txtAux(3).Text = DataGrid1.Columns(3).Text 'precio1
    txtAux(4).Text = DataGrid1.Columns(4).Text 'hasta m3 2
    
    txtAux(5).Text = DataGrid1.Columns(5).Text 'precio2
    txtAux(6).Text = DataGrid1.Columns(6).Text 'impcuota
    txtAux(7).Text = DataGrid1.Columns(7).Text 'impcuotahda
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codpozo=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rtipopozos.* "
    CadenaConsulta = CadenaConsulta & " FROM  rtipopozos where 1=1 "
    '************************************************************************
    
    '[Monica]04/09/2017: Si estamos en Monasterios estamos en comunidades
    If vParamAplic.Cooperativa = 17 Then Me.Caption = "Comunidades"
...
'    adodc1.ConnectionString = Conn
    ...
    If vParamAplic.Cooperativa = 17 Then
        tots = "S|txtAux(0)|T|Codigo|730|;S|txtAux(1)|T|Descripcion|4900|;"
    Else
        tots = "S|txtAux(0)|T|Codigo|730|;S|txtAux(1)|T|Descripcion|3700|;"
    End If
    
    If vParamAplic.Cooperativa = 17 Then
        tots = tots & "S|txtAux(2)|T|Hasta m3|1200|;"
    Else
        tots = tots & "S|txtAux(2)|T|Hasta m3|1500|;"
    End If
    
    '[Monica]08/05/2012: añadida Escalona que funciona como Utxera
    If vParamAplic.Cooperativa = 8 Or vParamAplic.Cooperativa = 10 Then ' utxera
        tots = tots & "S|txtAux(3)|T|Pr.Consumo|1500|;"
    Else
        If vParamAplic.Cooperativa = 17 Then
            tots = tots & "S|txtAux(3)|T|Precio 1|1200|;"
        Else
            tots = tots & "S|txtAux(3)|T|Precio 1|1500|;"
        End If
    End If
    
    If vParamAplic.Cooperativa = 17 Then
        tots = tots & "S|txtAux(4)|T|Hasta m3|1200|;"
    Else
        tots = tots & "S|txtAux(4)|T|Hasta m3|1500|;"
    End If
    
    '[Monica]08/05/2012: añadida Escalona que funciona como Utxera
    If vParamAplic.Cooperativa = 8 Or vParamAplic.Cooperativa = 10 Then
        tots = tots & "S|txtAux(5)|T|Pr.Celador|1500|;"
    Else
        If vParamAplic.Cooperativa = 17 Then
            tots = tots & "S|txtAux(5)|T|Precio 2|1200|;"
        Else
            tots = tots & "S|txtAux(5)|T|Precio 2|1500|;"
        End If
    End If
    
    tots = tots & "S|txtAux(6)|T|Importe Cuota|1500|;"
    tots = tots & "S|txtAux(7)|T|Importe Hda|1500|;"
...
Dim cadMen As String
    ...
    Select Case Index
        Case 0 'codigo de pozo
            PonerFormatoEntero txtAux(Index)
        
        Case 1 'nombre del pozo
            txtAux(Index) = UCase(txtAux(Index))
            
        Case 2, 4 ' hasta metro cubico 1, m3 2
            PonerFormatoEntero txtAux(Index)
            
        Case 3, 5 ' precio 1, precio 2
            PonerFormatoDecimal txtAux(Index), 7
        
        Case 6, 7 ' cuota contador, cuotas por hanegada
            PonerFormatoDecimal txtAux(Index), 7
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rtipopozos.codpozo}|"
