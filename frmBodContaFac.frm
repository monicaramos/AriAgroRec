...
Begin VB.Form frmBodContaFac 
   ...
   Caption         =   "Integración Contable de Facturas de Retirada"
   ClientHeight    =   4785
   ClientLeft      =   45
   ClientTop       =   2430
   ClientWidth     =   6600
...
eError:
    If Err.Number <> 0 Then
        MuestraError Err.Number, "No se ha realizado el proceso de contabilización de facturas de Retirada. Llame a soporte."
    End If
