...
Begin VB.Form frmPOZRecibosPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   10725
   Icon            =   "frmPOZRecibosPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6465
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   13
      Tag             =   "Codigo|N|N|||rrecibpozos|codsocio|000000||"
      Top             =   4950
      Width           =   1425
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   12
      Tag             =   "Linea|N|N|||rrecibpozos|numlinea|00||"
      Top             =   4950
      Width           =   795
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   11
      Tag             =   "Fecha|F|N|||rrecibpozos|fecfactu|dd/mm/yyyy||"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   2
      Tag             =   "Nro.Factura|N|N|||rrecibpozos|numfactu|0000000||"
      Top             =   4950
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código|T|N|||rrecibpozos|codtipom||S|"
      Top             =   4950
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmPOZRecibosPrev.frx":000C
      Height          =   5265
      Left            =   120
      TabIndex        =   7
      Top             =   330
   ...
   End
End
Attribute VB_Name = "frmPOZRecibosPrev"
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select case rrecibpozos.codtipom when ""RCP"" then ""RCP-Consumo"" when ""RMP"" then ""RMP-Mantenim"" when ""RVP"" then ""RVP-Contadores"" when ""RMT"" then ""RMT-Manta"" when ""TAL"" then ""TAL-Talla"" when ""RRC"" then ""RRC-Rect Consumo""  when ""RRM"" then ""RRM-Rect Mto"" when ""RRT"" then ""RRT-Rect Manta""  when ""RRV"" then ""RRV-Rect Cont"" when ""RTA"" then ""RTA-Rect Talla""  when ""FIN"" then ""FIN-Internas"" end as tipo, rrecibpozos.codtipom, "
    CadenaConsulta = CadenaConsulta & " rrecibpozos.numfactu, rrecibpozos.fecfactu, rrecibpozos.numlinea, rrecibpozos.codsocio, rsocios.nomsocio from rrecibpozos inner join rsocios on rrecibpozos.codsocio = rsocios.codsocio where (1=1)"
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    tots = "S|txtAux(0)|T|Tipo Fichero|2000|;S|txtAux(1)|T|Tipo|600|;S|txtAux(2)|T|Factura|1300|;S|txtAux(3)|T|Fecha|1250|;S|txtAux(4)|T|Lin|500|;S|txtAux(5)|T|Codigo|900|;S|txtAux(6)|T|Nombre|3300|;"
