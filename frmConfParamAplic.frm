...
Begin VB.Form frmConfParamAplic 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   179
         Tag             =   "Porcentaje Incr.kilos entrada|N|S|||rparam|porckilosbod2|##0.00||"
         Top             =   4275
         Width           =   585
      End
      Begin VB.TextBox Text1 
      ...
      Begin VB.Frame Frame18 
         ...
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   10
            TabIndex        =   422
            Tag             =   "Tarifa transporte local|N|S|||rparam|tracodtarif|000||"
            Top             =   870
            Width           =   855
         End
         Begin VB.TextBox Text2 
         ...
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   10
            TabIndex        =   414
            Tag             =   "Tarifa transporte local|N|S|||rparam|tracodtarif2|000||"
            Top             =   1320
            Width           =   855
         End
         Begin VB.TextBox Text2 
    ...
    If Modo = 4 Then 'MODIFICAR
        If DatosOk Then
            If Not vParamAplic Is Nothing Then
                ...
                '[Monica]03/09/2018: incremento de entrada p.integrado 2
                vParamAplic.PorcKilosBOD2 = ComprobarCero(Text1(143).Text)
...
'                    End If
    ...
    ' ***********BODEGA*********
       ...
       Case 128, 143  ' porcentaje de incremento de kilos de entrada e bodega
            If Text1(Index).Text <> "" Then PonerFormatoDecimal Text1(Index), 4
