...
Begin VB.Form frmManClasAux 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Notas a reproducir clasificación"
   ClientHeight    =   6090
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   13725
   Icon            =   "frmManClasAux.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6090
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   1
      Tag             =   "Nota|N|N|||tmpclasifica|numnotac|0000000|S|"
      Text            =   "nota"
      Top             =   4950
      Width           =   1425
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   12
      TabIndex        =   2
      Tag             =   "Destrio|N|N|||tmpclasifica|kilosnet|###,##0||"
      Text            =   "destrio"
      Top             =   4950
      Width           =   900
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManClasAux.frx":000C
      Height          =   4545
      Left            =   150
      TabIndex        =   7
      Top             =   810
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   0
      Tag             =   "Usuario|N|N|0|999999|tmpclasifica|codusu|000000|S|"
      Text            =   "usuari"
      Top             =   4905
      Width           =   825
   End
   ...
   End
End
Attribute VB_Name = "frmManClasAux"
...
Private Sub BotonBuscar()
    ...
    CargaGrid "tmpclasifica.numnotac is null "
    '*******************************************************************************
    'Buscar
    For I = 0 To txtAux.Count - 1
        txtAux(I).Text = ""
...
Dim temp As Boolean
    ...
    Sql = "¿Seguro que desea eliminar la Nota a procesar?"
    Sql = Sql & vbCrLf & "Nota: " & adodc1.Recordset.Fields(1)
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = Sql & " and numnotac = " & adodc1.Recordset!NumNotac
        conn.Execute Sql
        CargaGrid CadB
...
'                        If Not adodc1.Recordset.EOF Then adodc1.Recordset.MoveLast
                        If Not adodc1.Recordset.EOF Then
                            SituarDataMULTI adodc1, "codusu = " & txtAux(0) & " and numnotac = " & txtAux(1), "" ' Find (adodc1.Recordset.Fields(2).Name & " =" & NuevoCodigo)
                        End If
                        cmdRegresar_Click
                    Else
                        BotonAnyadir
...
Dim cad As String, Indicador As String
    ...
    cad = "codusu = " & adodc1.Recordset.Fields(0) & " and numnotac = " & adodc1.Recordset.Fields(1)
    ' ***************************************
    CargaGrid CadB
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT tmpclasifica.codusu, tmpclasifica.numnotac, rclasifica.fechaent, rclasifica.codvarie, variedades.nomvarie,"
    CadenaConsulta = CadenaConsulta & "rclasifica.codsocio, rsocios.nomsocio, rclasifica.codcampo,  tmpclasifica.kilosnet "
    CadenaConsulta = CadenaConsulta & " FROM tmpclasifica, rclasifica, variedades, rsocios"
    CadenaConsulta = CadenaConsulta & " WHERE rclasifica.codvarie = variedades.codvarie "
    CadenaConsulta = CadenaConsulta & " and rclasifica.codsocio = rsocios.codsocio "
    CadenaConsulta = CadenaConsulta & " and rclasifica.numnotac = tmpclasifica.numnotac "
    CadenaConsulta = CadenaConsulta & " and tmpclasifica.codusu = " & vUsu.Codigo
...
'    adodc1.ConnectionString = Conn
    ...
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY tmpclasifica.numnotac"
    '**************************************************************++
...
Dim Mens As String
    ...
    If Modo = 3 Then   'Estamos insertando
        Sql = DevuelveDesdeBDNew(cAgro, "tmpclasifica", "numnotac", "codusu", txtAux(0).Text, "N", , "numnotac", txtAux(1).Text, "N")
        If Sql <> "" Then
            MsgBox "Nota existente para realizar el proceso. Reintroduzca.", vbExclamation
            PonerFoco txtAux(1)
            B = False
        End If
    End If
    ...
    If B And (Modo = 3) Then
        Sql = DevuelveDesdeBDNew(cAgro, "rclasifica", "numnotac", "numnotac", txtAux(1).Text, "N")
        If Sql = "" Then
            MsgBox "Nota no existe para realizar el proceso. Reintroduzca.", vbExclamation
            PonerFoco txtAux(1)
            B = False
        End If
    End If
