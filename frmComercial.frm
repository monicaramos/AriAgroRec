...
Begin VB.Form frmComercial 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Ayuda Comercial"
   ClientHeight    =   5925
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5475
   Icon            =   "frmComercial.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5925
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|999|sfamia|codfamia|0000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmComercial.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   6
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmComercial"
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, CadenaSituar & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
'    CadenaConsulta = "SELECT sfamia.codfamia, sfamia.nomfamia "
'    CadenaConsulta = CadenaConsulta & " FROM sfamia "
