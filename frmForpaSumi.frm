...
Begin VB.Form frmForpaSumi 
   ...
   Caption         =   "Formas de Pago Suministros"
   ClientHeight    =   5925
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5355
   Icon            =   "frmForpaSumi.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5925
   ...
   Begin VB.ComboBox Combo1 
      Appearance      =   0  'Flat
      Height          =   315
      ItemData        =   "frmForpaSumi.frx":000C
      Left            =   2520
      List            =   "frmForpaSumi.frx":000E
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   4
      Tag             =   "Código de Forma de Pago|N|N|||sforpa|codforpa|000|S|"
      Text            =   "Dat"
      Top             =   4680
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   5
      Tag             =   "Descripción de la Forpa|T|N|||sforpa|nomforpa|||"
      Text            =   "Dato2"
      Top             =   4680
      Width           =   1395
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmForpaSumi.frx":0010
      Height          =   4410
      Left            =   120
      TabIndex        =   3
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmForpaSumi"
...
'        Else
            ...
            If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codforpa like " & DBSet(CodigoActual, "N"), "", True
            End If
'        End If
    End If
End Sub
...
'    PonerOpcionesMenu  'En funcion del usuario
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "Select codforpa, nomforpa, sforpa.tipforpa, destippa FROM sforpa, stippa where sforpa.tipforpa = stippa.tipforpa "
    '************************************************************************
...
Dim miRsAux As ADODB.Recordset
    ...
    adodc1.ConnectionString = ConnAriges
    miRsAux.Open "Select * from stippa order by destippa", ConnAriges, adOpenForwardOnly, adLockOptimistic, adCmdText
