...
Begin VB.Form frmADVArticulos 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(18)=   "Text1(16)"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "Text1(14)"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "Text1(12)"
      Tab(0).Control(20).Enabled=   0   'False
      Tab(0).Control(21)=   "Text1(11)"
      ...
      Tab(0).Control(25)=   "Text1(20)"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "chkCtrStock(0)"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "txtSumaStock"
      ...
      Tab(0).Control(36)=   "Text1(5)"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "Text2(5)"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "FrameDatosAlmacen"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "Text1(4)"
    ...
    If PrimeraVez Then
        ...
        Else
            ...
            Else
                ...
                Text1(0).BackColor = vbLightBlue 'codartic
            End If
        End If
    End If
...
'    End If
    ...
    AyudaArticulosADVPrev frmB, , cadB
...
Dim tots As String
    ...
    Select Case Index
        Case 0 'stocks en almacenes
            ...
            tots = tots & "S|btnBuscar(0)|B|||;S|txtAux2(0)|T|Denominación|1900|;"
            tots = tots & "S|Text3(2)|T|Cant.Stock|1200|;"
            tots = tots & "S|Text3(3)|T|Stock Min.|1200|;"
            tots = tots & "S|Text3(4)|T|Punto Ped.|1200|;"
            tots = tots & "S|Text3(5)|T|Stock Max.|1200|;"
            tots = tots & "S|Text3(6)|T|Stock Inv.|1200|;"
            tots = tots & "S|Text3(7)|T|Fecha Inv.|1400|;"
