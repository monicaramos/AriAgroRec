...
Begin VB.Form frmManPartidas 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   2
      TabIndex        =   4
      Tag             =   "Globalgap|T|N|||rpartida|globalgap|||"
      Top             =   4950
      Width           =   720
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   3
      Tag             =   "Zona|N|N|||rpartida|codzonas|0000||"
      Top             =   4950
      Width           =   720
   End
   Begin VB.TextBox txtAux2 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Nombre Partida|T|N|||rpartida|nomparti|||"
      Top             =   4945
      Width           =   1215
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   2
      Tag             =   "Codigo Pueblo|T|N|||rpartida|codpobla|||"
      Top             =   4945
      Width           =   945
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código Partida|N|N|0|9999|rpartida|codparti|0000|S|"
      Top             =   4945
      Width           =   800
   End
   ...
   End
End
Attribute VB_Name = "frmManPartidas"
...
Private WithEvents frmZon As frmManZonas
...
'    SelComboBool DataGrid1.Columns(2).Text, Combo1(0)
    ...
    '[Monica]20/09/2013: cuando me modifican una zona he de modificar los campos si no es escalona
    ZonaAnt = txtAux(3).Text
...
Private Sub LLamaLineas(alto As Single, xModo As Byte)
    ...
    ' ### [Monica] 12/09/2006
    txtAux2(2).Top = alto
    btnBuscar(0).Top = alto - 20
    txtAux2(3).Top = alto
    btnBuscar(1).Top = alto - 20
End Sub
 ...
 TerminaBloquear
    ...
    Select Case Index
        ...
        Case 1 ' zonas
            ...
            frmZon.CodigoActual = txtAux(Indice).Text
            frmZon.Show vbModal
            Set frmZon = Nothing
            PonerFoco txtAux(Indice)
        ...
        Case 3 'INSERTAR
            If DatosOK Then
                If InsertarDesdeForm(Me) Then
                    'chivato
                    CargarUnaPartida CLng(txtAux(0).Text), "I"
...
'                    TerminaBloquear
'                    'chivato
'                    CargarUnaPartida CLng(txtAux(0).Text), "U"
'
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codparti=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rpartida.codparti, rpartida.nomparti, rpartida.codpobla, rpueblos.despobla,  "
    CadenaConsulta = CadenaConsulta & "rpartida.codzonas, rzonas.nomzonas, rpartida.globalgap "
    CadenaConsulta = CadenaConsulta & " FROM rpartida, rpueblos, rzonas"
    CadenaConsulta = CadenaConsulta & " WHERE rpartida.codzonas = rzonas.codzonas "
    CadenaConsulta = CadenaConsulta & " and rpartida.codpobla = rpueblos.codpobla "
...
'Zonas
    txtAux(Indice).Text = RecuperaValor(CadenaSeleccion, 1) 'codzona
    txtAux2(Indice).Text = RecuperaValor(CadenaSeleccion, 2) 'nombre zona
End Sub
...
'    adodc1.ConnectionString = Conn
    ...
    tots = tots & "S|txtAux(1)|T|Nombre|2800|;"
    tots = tots & "S|txtAux(2)|T|C.Pueblo|1150|;S|btnBuscar(0)|B|||;"
    tots = tots & "S|txtAux2(2)|T|Población|3300|;S|txtAux(3)|T|Zona|800|;"
    tots = tots & "S|btnBuscar(1)|B|||;S|txtAux2(3)|T|Denominación|3300|;"
    tots = tots & "S|txtAux(4)|T|GG|400|;"
    ...
    Select Case Index
        ...
        Case 3 'codigo de zona
            If PonerFormatoEntero(txtAux(Index)) Then
                txtAux2(3).Text = PonerNombreDeCod(txtAux(Index), "rzonas", "nomzonas", "codzonas", "N")
                If txtAux2(Index).Text = "" Then
                    cadMen = "No existe la Zona: " & txtAux(Index).Text & vbCrLf
                    cadMen = cadMen & "¿Desea crearla?" & vbCrLf
                    If MsgBox(cadMen, vbQuestion + vbYesNo) = vbYes Then
                        Set frmZon = New frmManSituacion
                        frmZon.DatosADevolverBusqueda = "0|1|"
                        frmZon.NuevoCodigo = txtAux(Index).Text
                        txtAux(Index).Text = ""
                        TerminaBloquear
                        frmZon.Show vbModal
                        Set frmZon = Nothing
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rpartida.codparti}|"
