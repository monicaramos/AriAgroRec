...
Begin VB.Form frmManPlantacion 
   ...
   ClientTop       =   30
   ClientWidth     =   5985
   Icon            =   "frmManPlantacion.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6090
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||rplantacion|nomplanta|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|99|rplantacion|codplanta|00|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManPlantacion.frx":000C
      Height          =   4545
      Left            =   150
      TabIndex        =   6
      Top             =   810
   ...
   End
End
Attribute VB_Name = "frmManPlantacion"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("rplantacion", "codplanta")
    End If
    '********************************************************************
...
Private Sub BotonBuscar()
    ...
    CargaGrid "rplantacion.codplanta = -1"
    '*******************************************************************************
    'Buscar
    For I = 0 To txtAux.Count - 1
        txtAux(I).Text = ""
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar el Marco de Plantación?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from rplantacion where codplanta=" & adodc1.Recordset!Codplanta
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codplanta=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rplantacion.codplanta, rplantacion.nomplanta"
    CadenaConsulta = CadenaConsulta & " FROM rplantacion"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY rplantacion.codplanta"
    '**************************************************************++
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "rplantacion"
        .Informe2 = "rManPlantacion.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rplantacion.codplanta}|"
