...
Begin VB.Form frmPOZListado 
   ...
   Begin VB.Frame FrameRecPdtesCobro 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   24
         Left            =   1500
         MouseIcon       =   "frmPOZListado.frx":0567
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   23
         Left            =   1500
         MouseIcon       =   "frmPOZListado.frx":06B9
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1230
         Width           =   240
   ...
   Begin VB.Frame FrameReciboContador 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Image imgFecha 
            ...
            Index           =   4
            Left            =   1350
            Picture         =   "frmPOZListado.frx":0978
            Top             =   240
            Width           =   240
         End
      End
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   1590
         MouseIcon       =   "frmPOZListado.frx":0A03
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1440
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   1590
         MouseIcon       =   "frmPOZListado.frx":0B55
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1080
         Width           =   240
   ...
   Begin VB.Frame FrameReciboTalla 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   14
         Left            =   1590
         Picture         =   "frmPOZListado.frx":0CA7
         Top             =   2160
         Width           =   240
      End
      Begin VB.Image imgBuscar 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   13
         Left            =   1635
         MouseIcon       =   "frmPOZListado.frx":0E84
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1515
         Width           =   240
   ...
   Begin VB.Frame FrameReciboConsumoManta 
      ...
      Begin VB.Frame Frame17 
         ...
         Begin VB.Image imgFecha 
            ...
            Index           =   16
            Left            =   1350
            Picture         =   "frmPOZListado.frx":0FD6
            Top             =   240
            Width           =   240
         End
         Begin VB.Label Label2 
