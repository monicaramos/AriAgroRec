...
Begin VB.Form frmPOZListado 
   ...
   Begin VB.Frame FrameReciboMantenimiento 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   13
         Left            =   3810
         Picture         =   "frmPOZListado.frx":1AC8
         Top             =   3570
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   12
         Left            =   1560
         Picture         =   "frmPOZListado.frx":1B53
         Top             =   3540
         Width           =   240
      End
      Begin VB.Label Label2 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   6
         Left            =   1560
         MouseIcon       =   "frmPOZListado.frx":1BDE
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1080
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   7
         Left            =   1560
         MouseIcon       =   "frmPOZListado.frx":1D30
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1440
         Width           =   240
