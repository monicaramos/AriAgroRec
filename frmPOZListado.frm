...
Begin VB.Form frmPOZListado 
   ...
   Begin VB.Frame FrameFacturasHidrante 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   5
         Left            =   1500
         MouseIcon       =   "frmPOZListado.frx":0E69
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1620
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   4
         Left            =   1500
         MouseIcon       =   "frmPOZListado.frx":0FBB
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1230
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   10
         Left            =   1485
         Picture         =   "frmPOZListado.frx":110D
         ToolTipText     =   "Buscar fecha"
         Top             =   2775
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   9
         Left            =   1485
         Picture         =   "frmPOZListado.frx":1198
         ToolTipText     =   "Buscar fecha"
         Top             =   2415
         Width           =   240
      End
...
'            TImporte = TImporte + Importe
            ...
            SqlRec = SqlRec & "contabilizado) values ("
