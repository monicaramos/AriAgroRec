...
Begin VB.Form frmComVar 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   10
      Tag             =   "Producto|T|N|||variedades|codprodu|||"
      Text            =   "Dato2"
      Top             =   4680
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   4
      Tag             =   "Código Variedad|T|N|||variedades|codvarie||S|"
      Text            =   "Dat"
      Top             =   4680
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   5
      Tag             =   "Descripción|T|N|||variedades|nomvarie|||"
      Text            =   "Dato2"
      Top             =   4680
      Width           =   1395
   End
...
'        Else
            ...
            If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codvarie like " & DBSet(CodigoActual, "N"), "", True
            End If
'        End If
    End If
End Sub
...
'    PonerOpcionesMenu  'En funcion del usuario
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "Select codvarie, nomvarie, variedades.codprodu, productos.nomprodu FROM variedades, productos "
    CadenaConsulta = CadenaConsulta & " where variedades.codprodu = productos.codprodu "
    '************************************************************************
    
    If Condicion <> "" Then CadenaConsulta = CadenaConsulta & " and " & Condicion
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    'codmacta, nommacta
    tots = "S|txtAux(0)|T|Código|800|;S|txtAux(1)|T|Descripción|2300|;S|txtAux(2)|T|Código|800|;S|txtAux(3)|T|Descripción|2300|;"
