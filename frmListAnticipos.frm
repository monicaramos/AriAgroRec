...
Private Sub cmdAceptarAnt_Click()
    ...
    Select Case vParamAplic.Cooperativa
        ...
        '[Monica]27/12/2018: liquidacion de frutas inma masiva
        Case 18 ' COOPERATIVA FRUTAS INMA
               ProcesoCatadau

        Case 19 ' COOPERATIVA RIBERCAQUI
               ProcesoCatadau
...
'                        NTabla = "(" & NTabla & ") INNER JOIN rsocios ON rhisfruta.codsocio = rsocios.codsocio "
                    ...
                    Case 13 '13- listado de prevision de pagos de liquidaciones
                        ...
                        Else
                            'catadau
                            If CargarTemporalLiquidacionCatadau(Tabla1, cadSelect1, (vParamAplic.Cooperativa = 5 And Check1(11).Value = 1)) Then
                                cadFormula = ""
                                If Not AnyadirAFormula(cadFormula, "{tmpinformes.codusu} = " & vUsu.Codigo) Then Exit Sub
...
Private Sub FrameReimpresionVisible(visible As Boolean, ByRef H As Integer, ByRef W As Integer)
    ...
    If visible = True Then
        ...
        Me.FrameReimpresion.Width = 8920 '6675
...
Private Sub CargaCombo()
    ...
    'recolectado por
    Combo1(2).Clear
    '[Monica]19/11/2018: para el caso de Ribercaqui es recolectado por la SAT
    If vParamAplic.Cooperativa = 19 Then
        Combo1(2).AddItem "SAT"
    Else
...
Dim Sql As String
 ...
 '   ListView1.ColumnHeaders.Add , , "Tipo", 650
    ListView1(Index).ColumnHeaders.Add , , "Tipo Movimiento", 4750
    ...
    While Not Rs.EOF
        ...
        '[Monica]04/04/2019: que se vea el tipo de movimiento delante
        ItmX.Text = Rs.Fields(0).Value & " - " & Rs.Fields(1).Value ' Format(Rs.Fields(0).Value)
...
Private Function CargarTemporalLiquidacionCatadau(cTabla As String, cWhere As String, Optional Estercero As Boolean) As Boolean
Dim Rs As ADODB.Recordset
Dim Sql As String
Dim SQL1 As String
Dim Sql2 As String
    ...
    If CargarTemporalCatadau(cTabla, cWhere, 1) Then
        ...
        While Not Rs.EOF
            ...
            If VarieAnt <> Rs!Codvarie Or SocioAnt <> Rs!Codsocio Then
                ...
                Sql4 = Sql4 & " from rfactsoc_variedad INNER JOIN rfactsoc ON rfactsoc_variedad.codtipom = rfactsoc.codtipom and "
                Sql4 = Sql4 & " rfactsoc_variedad.numfactu = rfactsoc.numfactu and rfactsoc_variedad.fecfactu = rfactsoc.fecfactu "
                Sql4 = Sql4 & " where rfactsoc_variedad.codtipom = "
                '[Monica]13/11/2018: para el caso de castelduc tienen distinto contador los terceros
                If Estercero Then
                    Sql4 = Sql4 & "'FAT' "
                Else
                    Sql4 = Sql4 & DBSet(vSocio.CodTipomAnt, "T")  ' "FAA"
                End If
                Sql4 = Sql4 & " and rfactsoc.codsocio = " & DBSet(SocioAnt, "N")
        ...
        If HayReg Then
            ...
            Sql4 = Sql4 & " rfactsoc_variedad.numfactu = rfactsoc.numfactu and rfactsoc_variedad.fecfactu = rfactsoc.fecfactu "
            Sql4 = Sql4 & " where rfactsoc_variedad.codtipom = "
            '[Monica]13/11/2018: para el caso de castelduc si es tercero tiene distinto contador
            If Estercero Then
                Sql4 = Sql4 & "'FAT'"
            Else
                Sql4 = Sql4 & DBSet(vSocio.CodTipomAnt, "T") ' "FAA"
...
Dim HayPrecio As Boolean
    ...
    '[Monica]28/12/2018: en el caso de frutas inma se pagan los kilos transportados
    If vParamAplic.Cooperativa = 18 Then
        Sql2 = Sql2 & " sum(rhisfruta_clasif.kilostra) as kilos  "
    Else
    ...
    '[Monica]28/12/2018: en el caso de frutas inma se pagan los kilos transportados
    If vParamAplic.Cooperativa = 18 Then
        Sql2 = Sql2 & " having sum(rhisfruta_clasif.kilostra) <> 0 "
    Else
    ...
    '[Monica]28/12/2018: en el caso de frutas inma se pagan los kilos transportados
    If vParamAplic.Cooperativa = 18 Then
        Sql = Sql & " sum(rhisfruta_clasif.kilostra) as kilos "
    Else
        Sql = Sql & " sum(rhisfruta_clasif.kilosnet) as kilos "
    End If
    ...
    '[Monica]28/12/2018: en el caso de frutas inma se pagan los kilos transportados
    If vParamAplic.Cooperativa = 18 Then
        Sql = Sql & " having sum(rhisfruta_clasif.kilostra) <> 0 "
    Else
...
'[Monica]17/10/2013: Si y solo si no es Montifrut que tiene en otro ariagro otra cosa
    ...
    '[Monica]23/01/2019: añado frutas inma
If vParamAplic.Cooperativa <> 12 And vParamAplic.Cooperativa <> 9 And vParamAplic.Cooperativa <> 14 And vParamAplic.Cooperativa <> 18 Then
                ...
                If Not Rs2.EOF Then
                    ...
                    If DifBase <> 0 Or DifRete <> 0 Then
                        ...
                        If vParamAplic.Cooperativa = 2 Then
                            ...
                            Sql2 = Sql2 & " and codigo1 = " & DBSet(Rs.Fields(0).Value, "N")
                            Sql2 = Sql2 & " and nombre2 = " & DBSet(Rs!Codigo, "T")
                            Sql2 = Sql2 & " and importe1 = " & DBSet(Producto, "T")
...
Dim Rs As ADODB.Recordset
    ...
    While Not Rs.EOF
        ...
        Sql = Sql & " and imporvar + " & DBSet(Rs!imporvar, "N") & " > 0 and codcampo <> 0"
