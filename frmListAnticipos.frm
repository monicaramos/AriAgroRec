...
Begin VB.Form frmListAnticipos 
   ...
   Begin VB.Frame FrameRecalculoImporte 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   48
         Left            =   870
         MouseIcon       =   "frmListAnticipos.frx":015E
         MousePointer    =   4  'Icon
   ...
   Begin VB.Frame FrameGenFactAnticipoVC 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   6
         Left            =   1710
         MouseIcon       =   "frmListAnticipos.frx":02B0
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   2775
         Width           =   240
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   16
         Left            =   1710
         Picture         =   "frmListAnticipos.frx":0402
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   9
         Left            =   1710
         MouseIcon       =   "frmListAnticipos.frx":048D
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   49
         Left            =   1710
         MouseIcon       =   "frmListAnticipos.frx":05DF
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   2340
         Width           =   240
   ...
   Begin VB.Frame FrameGeneraFactura 
      ...
      Begin VB.ComboBox Combo1 
         ...
         Height          =   360
         Index           =   0
         ItemData        =   "frmListAnticipos.frx":0731
         Left            =   1920
         List            =   "frmListAnticipos.frx":0733
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   17
         Left            =   1590
         MouseIcon       =   "frmListAnticipos.frx":0735
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   2400
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   16
         Left            =   1590
         MouseIcon       =   "frmListAnticipos.frx":0887
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   2010
         Width           =   240
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   8
         Left            =   1590
         Picture         =   "frmListAnticipos.frx":09D9
         ToolTipText     =   "Buscar fecha"
         Top             =   4215
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   7
         Left            =   1590
         Picture         =   "frmListAnticipos.frx":0A64
         ToolTipText     =   "Buscar fecha"
         Top             =   3840
         Width           =   240
      End
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   19
         Left            =   1590
         MouseIcon       =   "frmListAnticipos.frx":0AEF
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   18
         Left            =   1590
         MouseIcon       =   "frmListAnticipos.frx":0C41
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar clase"
         Top             =   2910
         Width           =   240
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   5
         Left            =   1590
         Picture         =   "frmListAnticipos.frx":0D93
         ToolTipText     =   "Buscar fecha"
         Top             =   1560
         Width           =   240
      End
   ...
   Begin VB.Frame FrameResultados 
      ...
      Begin VB.Frame FrameFechaCertif 
         ...
         Begin VB.Image imgFec 
            ...
            Index           =   13
            Left            =   1800
            Picture         =   "frmListAnticipos.frx":0E1E
            ToolTipText     =   "Buscar fecha"
            Top             =   135
            Width           =   240
         End
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   2
         Left            =   1425
         MouseIcon       =   "frmListAnticipos.frx":0EA9
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   3
         Left            =   1425
         MouseIcon       =   "frmListAnticipos.frx":0FFB
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar transportista"
         Top             =   2475
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   29
         Left            =   1440
         MouseIcon       =   "frmListAnticipos.frx":114D
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar clase"
         Top             =   3465
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   28
         Left            =   1440
         MouseIcon       =   "frmListAnticipos.frx":129F
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar clase"
         Top             =   3075
         Width           =   240
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   10
         Left            =   1440
         Picture         =   "frmListAnticipos.frx":13F1
         ToolTipText     =   "Buscar fecha"
         Top             =   4680
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   9
         Left            =   1440
         Picture         =   "frmListAnticipos.frx":147C
         ToolTipText     =   "Buscar fecha"
         Top             =   4320
         Width           =   240
      End
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   25
         Left            =   1440
         MouseIcon       =   "frmListAnticipos.frx":1507
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1485
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   24
         Left            =   1440
         MouseIcon       =   "frmListAnticipos.frx":1659
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1110
         Width           =   240
      ...
      Begin VB.Image Image1 
         ...
         Index           =   2
         Left            =   6555
         Picture         =   "frmListAnticipos.frx":17AB
      ...
      Begin VB.Image Image1 
         ...
         Index           =   3
         Left            =   6795
         Picture         =   "frmListAnticipos.frx":7FFD
   ...
   Begin VB.Frame FrameAnticipos 
      ...
      Begin VB.Frame FrameFechaAnt 
         ...
         Begin VB.Image imgFec 
            ...
            Index           =   2
            Left            =   960
            Picture         =   "frmListAnticipos.frx":89FF
            ToolTipText     =   "Buscar fecha"
            Top             =   240
            Width           =   240
         End
      ...
      Begin VB.CommandButton Command4 
         Height          =   440
         Left            =   7860
         Picture         =   "frmListAnticipos.frx":8A8A
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   1440
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command3 
         Height          =   440
         Left            =   7860
         Picture         =   "frmListAnticipos.frx":8D94
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   2215
         Visible         =   0   'False
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   21
         Left            =   1350
         MouseIcon       =   "frmListAnticipos.frx":909E
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar clase"
         Top             =   2430
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   20
         Left            =   1350
         MouseIcon       =   "frmListAnticipos.frx":91F0
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar clase"
         Top             =   2040
         Width           =   240
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   0
         Left            =   1350
         Picture         =   "frmListAnticipos.frx":9342
         ToolTipText     =   "Buscar fecha"
         Top             =   2880
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   1
         Left            =   1350
         Picture         =   "frmListAnticipos.frx":93CD
         ToolTipText     =   "Buscar fecha"
         Top             =   3285
         Width           =   240
      End
      Begin VB.Image imgBuscar 
         ...
         Index           =   13
         Left            =   1350
         MouseIcon       =   "frmListAnticipos.frx":9458
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1485
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   12
         Left            =   1350
         MouseIcon       =   "frmListAnticipos.frx":95AA
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1095
         Width           =   240
   ...
   Begin VB.Frame FrameReimpresion 
      ...
      Begin VB.Image Image1 
         ...
         Index           =   1
         Left            =   6060
         Picture         =   "frmListAnticipos.frx":96FC
         ToolTipText     =   "Desmarcar todos"
         Top             =   840
         Width           =   240
      End
      Begin VB.Image Image1 
         ...
         Index           =   0
         Left            =   5820
         Picture         =   "frmListAnticipos.frx":A0FE
         ToolTipText     =   "Marcar todos"
         Top             =   840
         Width           =   240
      End
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   1470
         MouseIcon       =   "frmListAnticipos.frx":10950
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   3780
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   1470
         MouseIcon       =   "frmListAnticipos.frx":10AA2
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   3360
         Width           =   240
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   4
         Left            =   1485
         Picture         =   "frmListAnticipos.frx":10BF4
         ToolTipText     =   "Buscar fecha"
         Top             =   2685
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   3
         Left            =   1485
         Picture         =   "frmListAnticipos.frx":10C7F
         ToolTipText     =   "Buscar fecha"
         Top             =   2280
         Width           =   240
      End
   ...
   Begin VB.Frame FrameAnticiposPdtes 
      ...
      Begin VB.CommandButton Command10 
         Height          =   440
         Left            =   7860
         Picture         =   "frmListAnticipos.frx":10D0A
         Style           =   1  'Graphical
         TabIndex        =   319
         Top             =   1440
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command7 
         Height          =   440
         Left            =   7860
         Picture         =   "frmListAnticipos.frx":11014
         Style           =   1  'Graphical
         TabIndex        =   318
         Top             =   2215
         Visible         =   0   'False
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   66
         Left            =   1290
         MouseIcon       =   "frmListAnticipos.frx":1131E
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar clase"
         Top             =   2400
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   67
         Left            =   1290
         MouseIcon       =   "frmListAnticipos.frx":11470
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar clase"
         Top             =   2805
         Width           =   240
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   19
         Left            =   1290
         Picture         =   "frmListAnticipos.frx":115C2
         ToolTipText     =   "Buscar fecha"
         Top             =   3960
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   18
         Left            =   1290
         Picture         =   "frmListAnticipos.frx":1164D
         ToolTipText     =   "Buscar fecha"
         Top             =   3540
         Width           =   240
      End
      Begin VB.Image imgBuscar 
         ...
         Index           =   65
         Left            =   1290
         MouseIcon       =   "frmListAnticipos.frx":116D8
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1755
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   64
         Left            =   1290
         MouseIcon       =   "frmListAnticipos.frx":1182A
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1350
         Width           =   240
   ...
   Begin VB.Frame FrameDesFacturacion 
      ...
      Begin VB.Frame FrameTipoFactura 
         ...
         Begin VB.ComboBox Combo1 
            ...
            Height          =   360
            Index           =   1
            ItemData        =   "frmListAnticipos.frx":1197C
            Left            =   1800
            List            =   "frmListAnticipos.frx":1197E
            Style           =   2  'Dropdown List
            TabIndex        =   56
            Tag             =   "Recolección|N|N|0|3|rhisfruta|recolect|||"
            Top             =   90
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   6
         Left            =   1470
         Picture         =   "frmListAnticipos.frx":11980
         ToolTipText     =   "Buscar fecha"
         Top             =   3360
         Width           =   240
      End
   ...
   Begin VB.Frame FrameAportaciones 
      ...
      Begin VB.CommandButton Command6 
         Height          =   440
         Left            =   7860
         Picture         =   "frmListAnticipos.frx":11A0B
         Style           =   1  'Graphical
         TabIndex        =   247
         Top             =   2215
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command5 
         Height          =   440
         Left            =   7860
         Picture         =   "frmListAnticipos.frx":11D15
         Style           =   1  'Graphical
         TabIndex        =   246
         Top             =   1440
         Visible         =   0   'False
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   56
         Left            =   1290
         MouseIcon       =   "frmListAnticipos.frx":1201F
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   2415
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   55
         Left            =   1290
         MouseIcon       =   "frmListAnticipos.frx":12171
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   2085
         Width           =   240
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   17
         Left            =   1290
         Picture         =   "frmListAnticipos.frx":122C3
         ToolTipText     =   "Buscar fecha"
         Top             =   4035
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   15
         Left            =   1290
         Picture         =   "frmListAnticipos.frx":1234E
         ToolTipText     =   "Buscar fecha"
         Top             =   4425
         Width           =   240
      End
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   54
         Left            =   1290
         MouseIcon       =   "frmListAnticipos.frx":123D9
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar clase"
         Top             =   3390
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   53
         Left            =   1290
         MouseIcon       =   "frmListAnticipos.frx":1252B
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar clase"
         Top             =   3060
         Width           =   240
   ...
   Begin VB.Frame FrameLiqDirecta 
      ...
      Begin VB.CommandButton Command9 
         Height          =   440
         Left            =   7860
         Picture         =   "frmListAnticipos.frx":1267D
         Style           =   1  'Graphical
         TabIndex        =   293
         Top             =   2215
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command8 
         Height          =   440
         Left            =   7860
         Picture         =   "frmListAnticipos.frx":12987
         Style           =   1  'Graphical
         TabIndex        =   292
         Top             =   1440
         Visible         =   0   'False
...
'[Monica]27/01/2016: complementaria catadau
            ...
            FrameTipo.Enabled = ((vParamAplic.Cooperativa = 0 Or vParamAplic.Cooperativa = 18) And Not LiquidacionIndustria)
            FrameTipo.visible = ((vParamAplic.Cooperativa = 0 Or vParamAplic.Cooperativa = 18) And Not LiquidacionIndustria)
            FrameTipo.Top = 4530
...
Dim Tabla1 As String
    ...
    If DatosOk Then
        ...
        If (vParamAplic.Cooperativa = 0 Or vParamAplic.Cooperativa = 18) And (OpcionListado = 12 Or OpcionListado = 13 Or OpcionListado = 14) Then
...
'        Me.Check1(3).Value = 1
    ...
    Case 8, 9   '8= Informe de Resultados de facturas de SOCIOS
        ...
        Check1(27).Enabled = OpcionListado = 9 And (vParamAplic.Cooperativa = 0 Or vParamAplic.Cooperativa = 18)
        Check1(27).visible = OpcionListado = 9 And (vParamAplic.Cooperativa = 0 Or vParamAplic.Cooperativa = 18)
...
'Frame para el listado de socios por seccion
    ...
    If visible = True Then
        ...
        Check1(11).Enabled = (vParamAplic.Cooperativa = 4 Or vParamAplic.Cooperativa = 2 Or vParamAplic.Cooperativa = 16) And B
        Check1(11).visible = (vParamAplic.Cooperativa = 4 Or vParamAplic.Cooperativa = 2 Or vParamAplic.Cooperativa = 16) And B
    ...
    While Not Rs.EOF And B
        ...
        Else
            If DBLet(Rs!codvarie, "N") <> VarieAnt Then
                ...
                B = (NumReg <> 0) Or (Tipo = 3 And (vParamAplic.Cooperativa = 0 Or vParamAplic.Cooperativa = 18))
...
'07/07/2014
    ...
    If B Then
        If Tipo = 3 And (vParamAplic.Cooperativa = 0 Or vParamAplic.Cooperativa = 18) Then
...
Dim HayReg As Boolean
    ...
    If CargarTemporalCatadau(cTabla, cWhere, 1) Then
        ...
        If (vParamAplic.Cooperativa = 0 Or vParamAplic.Cooperativa = 18) And Check1(5).Value = 1 Then
