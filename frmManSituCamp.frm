...
Begin VB.Form frmManSituCamp 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Situaciones Campos"
   ClientHeight    =   6330
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   6375
   Icon            =   "frmManSituCamp.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6330
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   20
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||rsituacioncampo|nomsitua|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|99|rsituacioncampo|codsitua|00|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManSituCamp.frx":000C
      Height          =   4560
      Left            =   120
      TabIndex        =   6
      Top             =   945
   ...
   End
End
Attribute VB_Name = "frmManSituCamp"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("rsituacioncampo", "codsitua")
    End If
    '********************************************************************
...
Private Sub BotonBuscar()
    ...
    CargaGrid "rsituacioncampo.codsitua = -1"
    '*******************************************************************************
    'Buscar
    For i = 0 To txtAux.Count - 1
        txtAux(i).Text = ""
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar la Situación del Campo?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from rsituacioncampo where codsitua=" & adodc1.Recordset!codsitua
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rsituacioncampo.codsitua, rsituacioncampo.nomsitua"
    CadenaConsulta = CadenaConsulta & " FROM rsituacioncampo"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY rsituacioncampo.codsitua"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Código|800|;S|txtAux(1)|T|Descripción|4750|;"
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "rsituacioncampo"
        .Informe2 = "rManSituCamp.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rsituacioncampo.codsitua}|"
