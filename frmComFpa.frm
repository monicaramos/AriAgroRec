...
Begin VB.Form frmComFpa 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   5
      Tag             =   "Resto vencimientos|N|N|||forpago|restoven|##0||"
      Text            =   "Res"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   4
      Tag             =   "Primer Vencimiento|N|N|||forpago|primerve|##0||"
      Text            =   "Vto"
      Top             =   4950
      Width           =   1395
   End
   ...
   Begin VB.ComboBox Combo1 
      ...
      TabIndex        =   2
      Tag             =   "Tipo F.Pago|N|N|0|5|forpago|tipoforp|||"
      Top             =   4920
      Width           =   735
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción de F.Pago|T|N|||forpago|nomforpa|||"
      Text            =   "Nombre"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código de F.Pago|N|N|0|999|forpago|codforpa|000|S|"
      Text            =   "Cod"
      Top             =   4920
      Width           =   800
   End
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("forpago", "codforpa")
    End If
    '********************************************************************
...
'                lblIndicador.Caption = "BUSQUEDA: " & PonerContRegistros(Me.adodc1)
        ...
        Case 3 'INSERTAR
            If DatosOK Then
                ...
                '[Monica]04/01/2018: no lo hacia como en comercial, ahora inserta en la contabilidad si no existe la forma de pago
...
'                        If Not adodc1.Recordset.EOF Then adodc1.Recordset.MoveLast
        ...
        Case 4 'MODIFICAR
            If DatosOK Then
                ...
                '[Monica]04/01/2018: no lo hacia como en comercial, ahora modifica en la contabilidad si no existe la forma de pago
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT forpago.codforpa, forpago.nomforpa, forpago.tipoforp, "
    CadenaConsulta = CadenaConsulta & "CASE forpago.tipoforp WHEN 0 THEN ""Efectivo"" WHEN 1 THEN ""Transferencia"" WHEN 2 THEN ""Talon"" WHEN 3 THEN ""Pagare"" "
    CadenaConsulta = CadenaConsulta & "WHEN 4 THEN ""Recibo Bancario"" WHEN 5 THEN ""Confirming"" WHEN 6 THEN ""Tarjeta Crédito""END, "
    CadenaConsulta = CadenaConsulta & "forpago.numerove, forpago.primerve, forpago.restoven "
    
    CadenaConsulta = CadenaConsulta & " FROM forpago"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    SQL = SQL & " ORDER BY forpago.codforpa"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, SQL, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Código|800|;S|txtAux(1)|T|Descripción|3650|;"
    tots = tots & "N||||0|;S|Combo1(0)|C|Tipo|1850|;"
    tots = tots & "S|txtAux(2)|T|Vtos.|700|;S|txtAux(3)|T|Dias 1er.Vto|1300|;S|txtAux(4)|T|Resto Vto.|1100|;"
...
Dim Rs As ADODB.Recordset
    ...
    Combo1(0).AddItem "Tarjeta Crédito"
