...
Begin VB.Form frmManCamposPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   13725
   Icon            =   "frmManCamposPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   9315
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   16
      Tag             =   "Nro Orden|N|N|||rcampos|nrocampo|000000||"
      Top             =   5010
      Width           =   825
   End
   Begin VB.TextBox txtAux 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   14
      Tag             =   "Parcela|N|N|||rcampos|parcela|000000||"
      Top             =   4980
      Width           =   825
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   13
      Tag             =   "Poligono|N|N|||rcampos|poligono|000||"
      Top             =   4950
      Width           =   825
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   12
      Tag             =   "Partida|T|N|||rpartida|nomparti|||"
      Top             =   4950
      Width           =   1965
   End
   Begin VB.TextBox txtAux 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   1
      Tag             =   "Codsocio|N|N|||rcampos|codsocio|000000||"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   0
      Tag             =   "Código|N|N|||rcampos|codcampo|00000000|S|"
      Top             =   4950
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManCamposPrev.frx":000C
      Height          =   8145
      Left            =   120
      TabIndex        =   7
      Top             =   330
   ...
   End
End
Attribute VB_Name = "frmManCamposPrev"
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select rcampos.codcampo, rcampos.codsocio, rsocios.nomsocio, variedades.nomvarie, rpartida.nomparti, rcampos.poligono, rcampos.parcela, rcampos.subparce, rcampos.nrocampo "
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    tots = "S|txtAux(0)|T|Código|1100|;S|txtAux(1)|T|Socio|900|;S|txtAux(2)|T|Nombre|3300|;S|txtAux(3)|T|Variedad|2300|;S|txtAux(4)|T|Partida|1800|;S|txtAux(5)|T|Pol|650|;S|txtAux(6)|T|Par|850|;"
    tots = tots & "S|txtAux(7)|T|SPar|750|;S|txtAux(8)|T|Nro.Orden|1200|;"
