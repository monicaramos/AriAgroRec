...
Begin VB.Form frmManTarTra 
   ...
   Begin VB.ComboBox Combo1 
      ...
      Height          =   360
      Index           =   0
      ItemData        =   "frmManTarTra.frx":000C
      Left            =   3900
      List            =   "frmManTarTra.frx":000E
      Style           =   2  'Dropdown List
      TabIndex        =   3
      Tag             =   "Tipo Calidad|N|N|0|2|rtarifatra|tipotarifa|||"
      Top             =   4890
      Width           =   735
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   2
      Tag             =   "Precio Kg|N|S|||rtarifatra|preciokg|0.0000||"
      Top             =   4905
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   20
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||rtarifatra|nomtarif|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   0
      Tag             =   "Código|T|N|||rtarifatra|codtarif|00|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManTarTra.frx":0010
      Height          =   4900
      Left            =   150
      TabIndex        =   8
      Top             =   870
   ...
   End
End
Attribute VB_Name = "frmManTarTra"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("rtarifatra", "codtarif")
    End If
    '********************************************************************
...
Private Sub BotonBuscar()
    ...
    CargaGrid "rtarifatra.codtarif = -1"
    '*******************************************************************************
    'Buscar
    For I = 0 To txtAux.Count - 1
        txtAux(I).Text = ""
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    SQL = "¿Seguro que desea eliminar la Tarifa de Transporte?"
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from rtarifatra where codtarif=" & DBLet(adodc1.Recordset!Codtarif, "N")
        conn.Execute SQL
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rtarifatra.codtarif, rtarifatra.nomtarif, rtarifatra.preciokg, "
    CadenaConsulta = CadenaConsulta & " rtarifatra.tipotarifa, "
    CadenaConsulta = CadenaConsulta & " CASE rtarifatra.tipotarifa WHEN 0 THEN ""Tipo 1"" WHEN 1 THEN ""Tipo 2""  WHEN 2 THEN ""Sin Tipo"" END "
    CadenaConsulta = CadenaConsulta & " FROM rtarifatra"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    SQL = SQL & " ORDER BY rtarifatra.codtarif"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, SQL, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Código|1000|;S|txtAux(1)|T|Descripción|2800|;S|txtAux(2)|T|Precio Kg.|1100|;N||||0|;S|Combo1(0)|C|Tipo|1220|;"
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "rtarifatra"
        .Informe2 = "rManTarifaTra.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rtarifatra.codtarif}|"
...
Private Sub CargaCombo()
    ...
    Combo1(0).AddItem "Tipo 1"
    Combo1(0).ItemData(Combo1(0).NewIndex) = 0
    Combo1(0).AddItem "Tipo 2"
    Combo1(0).ItemData(Combo1(0).NewIndex) = 1
    Combo1(0).AddItem "Sin Tipo"
