...
Begin VB.Form frmManInciden 
   ...
   Begin VB.ComboBox Combo1 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "frmManInciden.frx":000C
      Left            =   3240
      List            =   "frmManInciden.frx":000E
      Style           =   2  'Dropdown List
      TabIndex        =   2
      Tag             =   "Tipo Incidencia|N|N|0|2|rincidencia|tipincid|||"
      Top             =   4920
      Width           =   735
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   1
      Tag             =   "Descripción de Incidencia|T|N|||rincidencia|nomincid|||"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código de Incidencia|N|N|0|9999|rincidencia|codincid|0000|S|"
      Top             =   4950
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManInciden.frx":0010
      Height          =   4560
      Left            =   120
      TabIndex        =   5
      Top             =   930
   ...
   End
End
Attribute VB_Name = "frmManInciden"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("rincidencia", "codincid")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from rincidencia where codincid=" & adodc1.Recordset!codincid
        conn.Execute SQL
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rincidencia.codincid, rincidencia.nomincid, rincidencia.tipincid, CASE tipincid WHEN 0 THEN ""Leve"" WHEN 1 THEN ""Grave"" WHEN 2 THEN ""Muy Grave"" END "
    CadenaConsulta = CadenaConsulta & " FROM rincidencia WHERE 1=1 "
    '************************************************************************
...
'    DataGrid1.RowHeight = 290
    ...
    tots = "S|txtAux(0)|T|Código|800|;S|txtAux(1)|T|Descripción|4087|;"
    tots = tots & "N|||||;S|Combo1|C|Tipo|1500|;"
...
Dim Rs As ADODB.Recordset
    ...
    Combo1.AddItem "Grave"
    Combo1.ItemData(Combo1.NewIndex) = 1
    
    Combo1.AddItem "Muy grave"
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "rincidencia"
        .Informe2 = "rManIncidencia.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rincidencia.codincid}|"
