...
Begin VB.Form frmTelFacturas 
   ...
   Caption         =   "Facturas de Teléfono"
   ClientHeight    =   5925
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   12810
   Icon            =   "frmTelFacturas.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5925
   ...
   Begin VB.CheckBox chkAux 
      ...
      Left            =   8280
      TabIndex        =   17
      Tag             =   "Int.Contable|N|N|||rtelmovil|intconta|||"
      Top             =   4995
      Visible         =   0   'False
      Width           =   210
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   5
      Tag             =   "Total Factura|N|N|||rtelmovil|totalfac|##,###,#0.00||"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   4
      Tag             =   "Cuota Iva|N|N|||rtelmovil|cuotaiva|##,###,#0.00||"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   3
      Tag             =   "Base Imponible|N|N|||rtelmovil|baseimpo|##,###,#0.00||"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   2
      Tag             =   "Fecha de Factura|F|N|||rtelmovil|fecfactu|dd/mm/yyyy|S|"
      Top             =   4950
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   6
      Tag             =   "Socio|N|N|||rtelmovil|codsocio|000000||"
      Top             =   4950
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Numero de Factura|N|N|0|9999999|rtelmovil|numfactu|0000000|S|"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   2
      TabIndex        =   0
      Tag             =   "N.Serie|T|N|||rtelmovil|numserie||S|"
      Top             =   4950
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmTelFacturas.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   11
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmTelFacturas"
...
Private Sub BotonModificar()
    ...
    ' *****************************************************
    ' ### [Monica] 12/09/2006
    txtAux2(2).Text = DataGrid1.Columns(9).Text
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rtelmovil.numserie, rtelmovil.numfactu, rtelmovil.fecfactu, "
    CadenaConsulta = CadenaConsulta & "rtelmovil.baseimpo, rtelmovil.cuotaiva, rtelmovil.totalfac, rtelmovil.intconta, IF(rtelmovil.intconta=1,'*','') as dintconta, "
    CadenaConsulta = CadenaConsulta & "rtelmovil.codsocio, rsocios.nomsocio "
    CadenaConsulta = CadenaConsulta & "from rtelmovil inner join rsocios on rtelmovil.codsocio = rsocios.codsocio "
...
'mantenimiento de socios
    txtAux(indice).Text = RecuperaValor(CadenaSeleccion, 1) 'codsocio
    txtAux2(indice).Text = RecuperaValor(CadenaSeleccion, 2) 'nomsocio
End Sub
...
'    adodc1.ConnectionString = Conn
    ...
    tots = tots & "S|txtAux(3)|T|Fecha|1000|;"
    tots = tots & "S|txtAux(4)|T|Base Imponible|1500|;"
    tots = tots & "S|txtAux(5)|T|Cuota Iva|1500|;"
    tots = tots & "S|txtAux(6)|T|Total Factura|1500|;"
    tots = tots & "N||||0|;S|chkAux(0)|CB|IC|360|;"
    tots = tots & "S|txtAux(2)|T|Socio|800|;"
    tots = tots & "S|btnBuscar(0)|B|||;S|txtAux2(2)|T|Nombre de Socio|3930|;"
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rtelmovil.numfactu}|"
