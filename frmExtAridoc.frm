...
Begin VB.Form frmExtAridoc 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   4
      Tag             =   "Código de Extension|N|N|||extension|codext|000|S|"
      Text            =   "Dat"
      Top             =   4680
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   5
      Tag             =   "Descripción|T|N|||extension|descripcion|||"
      Text            =   "Dato2"
      Top             =   4680
      Width           =   1395
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmExtAridoc.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   3
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmExtAridoc"
...
'        Else
            ...
            If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codext like " & DBSet(CodigoActual, "N"), "", True
            End If
'        End If
    End If
End Sub
...
'    PonerOpcionesMenu  'En funcion del usuario
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "Select codext, descripcion FROM extension "
    '************************************************************************
