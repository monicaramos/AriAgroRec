...
Begin VB.Form frmManPartesTMP 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   5
      TabIndex        =   1
      Tag             =   "Horas|N|N|||tmpliquidacion|gastos|##0.00||"
      Text            =   "Horas"
      Top             =   4950
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   12
      TabIndex        =   2
      Tag             =   "Importe|N|N|||tmpliquidacion|importe|###,##0.00||"
      Text            =   "importe"
      Top             =   4950
      Width           =   900
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   0
      Tag             =   "Código Trabajador|N|N|0|999999|tmpliquidacion|codvarie|000000|S|"
      Text            =   "Trab"
      Top             =   4920
      Width           =   800
   End
   ...
   End
End
Attribute VB_Name = "frmManPartesTMP"
...
'                        If Not adodc1.Recordset.EOF Then adodc1.Recordset.MoveLast
                        If Not adodc1.Recordset.EOF Then
                            SituarDataMULTI adodc1, "codvarie = " & txtAux(0) & " and codusu = " & vUsu.Codigo, "" ' Find (adodc1.Recordset.Fields(2).Name & " =" & NuevoCodigo)
                        End If
                        cmdRegresar_Click
                    Else
                        BotonAnyadir
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    Me.Caption = "Trabajadores del Parte " & ParamVariedad
...
'Trabajadores
    txtAux(Indice).Text = RecuperaValor(CadenaSeleccion, 1) 'codtraba
    txtAux2(Indice + 2).Text = RecuperaValor(CadenaSeleccion, 2) 'nombre trabajador
End Sub
