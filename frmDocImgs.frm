...
Begin VB.Form frmDocImgs 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Nombre|T|N|||rfichdocs|descripfich|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|9999|rfichdocs|codigo|0000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmDocImgs.frx":000C
      Height          =   4410
      Left            =   150
      TabIndex        =   6
      Top             =   660
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("rfichdocs", "codcapat")
    End If
    '********************************************************************
...
Private Sub BotonBuscar()
    ...
    CargaGrid "rfichdocs.codcapat = -1"
    '*******************************************************************************
    'Buscar
    For I = 0 To txtAux.Count - 1
        txtAux(I).Text = ""
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar el Capataz?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        'chivato
        CargarUnaCuadrilla CLng(adodc1.Recordset!codcapat), "D"
        
        
        Sql = "Delete from rfichdocs where codcapat=" & adodc1.Recordset!codcapat
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codcapat=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rfichdocs.codcapat, rfichdocs.nomcapat, rfichdocs.codigoett, rfichdocs.codtraba, straba.nomtraba "
    CadenaConsulta = CadenaConsulta & " FROM rfichdocs left join straba On rfichdocs.codtraba = straba.codtraba "
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY rfichdocs.codcapat"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Cód.|500|;S|txtAux(1)|T|Descripción|3550|;S|txtAux(2)|T|Código ETT|1150|;"
    tots = tots & "S|txtAux(3)|T|Cód.|800|;S|btnBuscar(0)|B||195|;S|txtAux2(3)|T|Nombre Trabajador|2700|;"
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rfichdocs.codcapat}|"
