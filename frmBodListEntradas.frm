...
Begin VB.Form frmBodListEntradas 
   ...
   Begin VB.Frame FrameBonificacion 
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   8
         Left            =   1350
         Picture         =   "frmBodListEntradas.frx":13E4
         ToolTipText     =   "Buscar fecha"
         Top             =   3285
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   7
         Left            =   1350
         Picture         =   "frmBodListEntradas.frx":146F
         ToolTipText     =   "Buscar fecha"
         Top             =   2880
         Width           =   240
      End
   ...
   Begin VB.Frame FrameEntradasCampo 
      ...
      Begin VB.CommandButton Command4 
         Height          =   440
         Left            =   7860
         Picture         =   "frmBodListEntradas.frx":179E
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   1440
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command3 
         Height          =   440
         Left            =   7860
         Picture         =   "frmBodListEntradas.frx":1AA8
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   2215
         Visible         =   0   'False
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   0
         Left            =   1590
         Picture         =   "frmBodListEntradas.frx":22FA
         ToolTipText     =   "Buscar fecha"
         Top             =   5040
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   1
         Left            =   1590
         Picture         =   "frmBodListEntradas.frx":2385
         ToolTipText     =   "Buscar fecha"
         Top             =   5445
         Width           =   240
      End
      Begin VB.Image imgBuscar 
         ...
         Index           =   15
         Left            =   1620
         MouseIcon       =   "frmBodListEntradas.frx":2410
         MousePointer    =   4  'Icon
   ...
   Begin VB.Frame FrameListadoConsumo 
      ...
      Begin VB.CommandButton Command2 
         Height          =   440
         Left            =   7860
         Picture         =   "frmBodListEntradas.frx":2958
         Style           =   1  'Graphical
         TabIndex        =   42
         Top             =   2215
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command1 
         Height          =   440
         Left            =   7860
         Picture         =   "frmBodListEntradas.frx":2C62
         Style           =   1  'Graphical
         TabIndex        =   41
         Top             =   1440
         Visible         =   0   'False
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   11
         Left            =   1620
         MouseIcon       =   "frmBodListEntradas.frx":2F6C
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1665
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   10
         Left            =   1620
         MouseIcon       =   "frmBodListEntradas.frx":30BE
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1305
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   9
         Left            =   1620
         MouseIcon       =   "frmBodListEntradas.frx":3210
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   3510
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   8
         Left            =   1620
         MouseIcon       =   "frmBodListEntradas.frx":3362
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   3120
         Width           =   240
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   3
         Left            =   1620
         Picture         =   "frmBodListEntradas.frx":34B4
         ToolTipText     =   "Buscar fecha"
         Top             =   2565
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   2
         Left            =   1620
         Picture         =   "frmBodListEntradas.frx":353F
         ToolTipText     =   "Buscar fecha"
         Top             =   2160
         Width           =   240
      End
   ...
   Begin VB.Frame FrameDiarioFrasRetirada 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   19
            Left            =   1050
            MouseIcon       =   "frmBodListEntradas.frx":423C
            MousePointer    =   4  'Icon
            ToolTipText     =   "Buscar cooperativa"
            Top             =   270
            Width           =   240
      ...
      Begin VB.CommandButton Command13 
         Height          =   440
         Left            =   7860
         Picture         =   "frmBodListEntradas.frx":438E
         Style           =   1  'Graphical
         TabIndex        =   170
         Top             =   1440
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command12 
         Height          =   440
         Left            =   7860
         Picture         =   "frmBodListEntradas.frx":4698
         Style           =   1  'Graphical
         TabIndex        =   169
         Top             =   2215
         Visible         =   0   'False
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   11
         Left            =   1620
         Picture         =   "frmBodListEntradas.frx":49A2
         ToolTipText     =   "Buscar fecha"
         Top             =   2550
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   10
         Left            =   1620
         Picture         =   "frmBodListEntradas.frx":4A2D
         ToolTipText     =   "Buscar fecha"
         Top             =   2130
         Width           =   240
      End
      Begin VB.Image imgBuscar 
         ...
         Index           =   23
         Left            =   1620
         MouseIcon       =   "frmBodListEntradas.frx":4AB8
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   3120
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   24
         Left            =   1620
         MouseIcon       =   "frmBodListEntradas.frx":4C0A
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   3510
         Width           =   240
...
Dim SQL As String
    ...
    If txtcodigo(22).Text = "" Then
        MsgBox "Debe introducir obligatoriamente un precion de venta. Revise.", vbExclamation
