...
Begin VB.Form frmBodListEntradas 
   ...
   Begin VB.Frame FrameBonificacion 
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   8
         Left            =   1350
         Picture         =   "frmBodListEntradas.frx":08C4
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   7
         Left            =   1350
         Picture         =   "frmBodListEntradas.frx":094F
         ToolTipText     =   "Buscar fecha"
         Top             =   3105
         Width           =   240
      End
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   21
         Left            =   1350
         MouseIcon       =   "frmBodListEntradas.frx":0B2C
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar clase"
         Top             =   2565
         Width           =   240
   ...
   Begin VB.Frame FrameEntradasCampo 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   7
         Left            =   1485
         MouseIcon       =   "frmBodListEntradas.frx":1536
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar clase"
         Top             =   2700
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   6
         Left            =   1485
         MouseIcon       =   "frmBodListEntradas.frx":1688
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar clase"
         Top             =   2265
         Width           =   240
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   0
         Left            =   1455
         Picture         =   "frmBodListEntradas.frx":17DA
         ToolTipText     =   "Buscar fecha"
         Top             =   5040
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   1
         Left            =   1455
         Picture         =   "frmBodListEntradas.frx":1865
         ToolTipText     =   "Buscar fecha"
         Top             =   5445
         Width           =   240
      End
      Begin VB.Image imgBuscar 
         ...
         Index           =   15
         Left            =   1485
         MouseIcon       =   "frmBodListEntradas.frx":18F0
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   14
         Left            =   1485
         MouseIcon       =   "frmBodListEntradas.frx":1A42
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   3210
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   13
         Left            =   1485
         MouseIcon       =   "frmBodListEntradas.frx":1B94
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1755
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   12
         Left            =   1485
         MouseIcon       =   "frmBodListEntradas.frx":1CE6
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1320
         Width           =   240
   ...
   Begin VB.Frame FrameDiarioFrasRetirada 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   19
            Left            =   1050
            MouseIcon       =   "frmBodListEntradas.frx":1E38
            MousePointer    =   4  'Icon
      ...
      Begin VB.CommandButton Command13 
         Height          =   440
         Left            =   7860
         Picture         =   "frmBodListEntradas.frx":1F8A
         Style           =   1  'Graphical
         TabIndex        =   170
         Top             =   1440
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command12 
         Height          =   440
         Left            =   7860
         Picture         =   "frmBodListEntradas.frx":2294
         Style           =   1  'Graphical
         TabIndex        =   169
         Top             =   2215
         Visible         =   0   'False
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   11
         Left            =   1620
         Picture         =   "frmBodListEntradas.frx":259E
         ToolTipText     =   "Buscar fecha"
         Top             =   2595
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   10
         Left            =   1620
         Picture         =   "frmBodListEntradas.frx":2629
         ToolTipText     =   "Buscar fecha"
         Top             =   2175
         Width           =   240
      End
   ...
   Begin VB.Frame FrameAutoconsumo 
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   9
         Left            =   1350
         Picture         =   "frmBodListEntradas.frx":30BE
         ToolTipText     =   "Buscar fecha"
         Top             =   3240
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   6
         Left            =   1350
         Picture         =   "frmBodListEntradas.frx":3149
         ToolTipText     =   "Buscar fecha"
         Top             =   3645
         Width           =   240
      End
      Begin VB.Image imgBuscar 
         ...
         Index           =   33
         Left            =   1380
         MouseIcon       =   "frmBodListEntradas.frx":31D4
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1530
         Width           =   240
   ...
   Begin VB.Frame FrameListadoConsumo 
      ...
      Begin VB.CommandButton Command2 
         Height          =   440
         Left            =   7860
         Picture         =   "frmBodListEntradas.frx":3478
         Style           =   1  'Graphical
         TabIndex        =   42
         Top             =   2215
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command1 
         Height          =   440
         Left            =   7860
         Picture         =   "frmBodListEntradas.frx":3782
         Style           =   1  'Graphical
         TabIndex        =   41
         Top             =   1440
         Visible         =   0   'False
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   9
         Left            =   1395
         MouseIcon       =   "frmBodListEntradas.frx":3D30
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   3600
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   8
         Left            =   1395
         MouseIcon       =   "frmBodListEntradas.frx":3E82
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   3210
         Width           =   240
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   3
         Left            =   1395
         Picture         =   "frmBodListEntradas.frx":3FD4
         ToolTipText     =   "Buscar fecha"
         Top             =   2655
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   2
         Left            =   1395
         Picture         =   "frmBodListEntradas.frx":405F
         ToolTipText     =   "Buscar fecha"
         Top             =   2250
         Width           =   240
      End
