...
Begin VB.Form frmBodListEntradas 
   ...
   Begin VB.Frame FrameListadoConsumo 
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   3
         Left            =   1620
         Picture         =   "frmBodListEntradas.frx":1688
         ToolTipText     =   "Buscar fecha"
         Top             =   2565
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   2
         Left            =   1620
         Picture         =   "frmBodListEntradas.frx":1713
         ToolTipText     =   "Buscar fecha"
         Top             =   2160
         Width           =   240
      End
   ...
   Begin VB.Frame FrameDiarioFrasRetirada 
      ...
      Begin VB.CommandButton Command13 
         Height          =   440
         Left            =   7860
         Picture         =   "frmBodListEntradas.frx":2562
         Style           =   1  'Graphical
         TabIndex        =   170
         Top             =   1440
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command12 
         Height          =   440
         Left            =   7860
         Picture         =   "frmBodListEntradas.frx":286C
         Style           =   1  'Graphical
         TabIndex        =   169
         Top             =   2215
         Visible         =   0   'False
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   11
         Left            =   1620
         Picture         =   "frmBodListEntradas.frx":2B76
         ToolTipText     =   "Buscar fecha"
         Top             =   2550
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   10
         Left            =   1620
         Picture         =   "frmBodListEntradas.frx":2C01
         ToolTipText     =   "Buscar fecha"
         Top             =   2130
         Width           =   240
      End
      Begin VB.Image imgBuscar 
         ...
         Index           =   23
         Left            =   1620
         MouseIcon       =   "frmBodListEntradas.frx":2C8C
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   3120
         Width           =   240
