        ...
        Else
            ...
            Select Case Combo1(0).ListIndex
                ...
                Case 1, 2
                    ...
                    If Not AnyadirAFormula(cadSelect, "{rsocios_pozos.numfases} = " & Combo1(0).ListIndex) Then Exit Sub
                    If Not AnyadirAFormula(cadFormula, "{rsocios_pozos.numfases} = " & Combo1(0).ListIndex) Then Exit Sub
            End Select
