...
'    KilosNet = TotalRegistros(Sql)
    ...
    If vParamAplic.Cooperativa = 2 Then KilosNet = CLng(ImporteSinFormato(ComprobarCero(Text1(23).Text)))
    ...
    If vParamAplic.Cooperativa = 2 Then GasRecol = Round2(KilosNet * EurDesta, 2)
