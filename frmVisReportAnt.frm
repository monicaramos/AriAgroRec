...
Begin VB.Form frmVisReportAnt 
   ...
   End
End
Attribute VB_Name = "frmVisReportAnt"
...
'    If mrpt.PrinterSetupEx(0) = 0 Then     'de momento comentado pq solo el quieren una pantalla
     mrpt.PrintOutEx True, NroCopias
...
'    Next i
    ...
    If InfConta Then
        For I = 1 To mrpt.Database.Tables.Count
           mrpt.Database.Tables(I).SetLogOnInfo "vconta", "conta" & vParamAplic.NumeroConta, vParamAplic.UsuarioConta, vParamAplic.PasswordConta '"root", "aritel"
...
'
'                    For i = 1 To smrpt.Database.Tables.Count
'                         smrpt.Database.Tables(i).SetLogOnInfo "Arigasol", , "root", "aritel"
    ...
    For Each crxSection In mrpt.Sections
        For Each crxObject In crxSection.ReportObjects
             If TypeOf crxObject Is SubreportObject Then
                ...
                ' unicamente pasamos el cadformula a uno de los subreports del report
                If InStr(1, Informe, "rInfPesadas.rpt") <> 0 And crxSubreportObject.SubreportName = "rep1" Then
                    smrpt.RecordSelectionFormula = FormulaSeleccion
                End If
             End If
        Next crxObject
