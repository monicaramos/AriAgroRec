...
Begin VB.Form frmManSociosPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   10725
   Icon            =   "frmManSociosPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6465
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   2
      Tag             =   "Nif Socio|T|N|||rsocios|nifsocio|||"
      Top             =   4950
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código|N|N|||rsocios|codsocio|000000|S|"
      Top             =   4950
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManSociosPrev.frx":000C
      Height          =   5265
      Left            =   120
      TabIndex        =   7
      Top             =   330
   ...
   End
End
Attribute VB_Name = "frmManSociosPrev"
