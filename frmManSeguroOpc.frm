...
Begin VB.Form frmManSeguroOpc 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||rseguroopcion|nomseguro|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   2
      TabIndex        =   0
      Tag             =   "Código|T|N|||rseguroopcion|codseguro||S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManSeguroOpc.frx":000C
      Height          =   4545
      Left            =   120
      TabIndex        =   6
      Top             =   825
   ...
   End
End
Attribute VB_Name = "frmManSeguroOpc"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("rseguroopcion", "codseguro")
    End If
    '********************************************************************
...
Private Sub BotonBuscar()
    ...
    CargaGrid "rseguroopcion.codseguro = '-1'"
    '*******************************************************************************
    'Buscar
    For I = 0 To txtAux.Count - 1
        txtAux(I).Text = ""
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    SQL = "¿Seguro que desea eliminar la Opción?"
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from rseguroopcion where codseguro='" & adodc1.Recordset!Codseguro & "'"
        conn.Execute SQL
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codseguro='" & CodigoActual & "'", "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rseguroopcion.codseguro, rseguroopcion.nomseguro"
    CadenaConsulta = CadenaConsulta & " FROM rseguroopcion"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    SQL = SQL & " ORDER BY rseguroopcion.codseguro"
    '**************************************************************++
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "rseguroopcion"
        .Informe2 = "rManSeguroOpcion.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rseguroopcion.codseguro}|"
