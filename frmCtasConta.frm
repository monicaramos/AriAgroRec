...
Begin VB.Form frmCtasConta 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   4
      Tag             =   "Código de Cuenta|T|N|||cuentas|codmacta||S|"
      Text            =   "Dat"
      Top             =   4680
      Width           =   800
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmCtasConta.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   3
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmCtasConta"
...
'    PonerOpcionesMenu  'En funcion del usuario
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "Select codmacta, nommacta from cuentas "
    '************************************************************************
