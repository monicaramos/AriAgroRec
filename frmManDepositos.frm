...
Begin VB.Form frmManDepositos 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Nombre|T|N|||rdeposito|nomdeposito|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|9999|rdeposito|coddeposito|0000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManDepositos.frx":000C
      Height          =   4545
      Left            =   150
      TabIndex        =   6
      Top             =   840
   ...
   End
End
Attribute VB_Name = "frmManDepositos"
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    SQL = "¿Seguro que desea eliminar el Depósito?"
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from rdeposito where coddeposito=" & adodc1.Recordset!coddeposito
        conn.Execute SQL
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rdeposito.coddeposito, rdeposito.nomdeposito"
    CadenaConsulta = CadenaConsulta & " FROM rdeposito"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    SQL = SQL & " ORDER BY rdeposito.coddeposito"
    '**************************************************************++
