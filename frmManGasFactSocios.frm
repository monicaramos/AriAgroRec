...
Begin VB.Form frmManGasFactSocios 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Gastos de Facturas Socios"
   ClientHeight    =   6435
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   7830
   Icon            =   "frmManGasFactSocios.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6435
   ...
   Begin VB.Frame FrameAux0 
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   7
         TabIndex        =   5
         Tag             =   "Linea|N|N|||rfactsoc_gastos|numlinea|##0||"
         Text            =   "Linea"
         Top             =   1800
         Visible         =   0   'False
         Width           =   570
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   3
         TabIndex        =   26
         Tag             =   "Concepto|N|N|0|999|rfactsoc_gastos|codconcep|000|S|"
         Text            =   "con"
         Top             =   1800
         Visible         =   0   'False
         Width           =   570
      ...
      Begin MSDataGridLib.DataGrid DataGridAux 
         Bindings        =   "frmManGasFactSocios.frx":000C
         Height          =   1695
         Index           =   0
         Left            =   150
         TabIndex        =   17
   ...
   End
End
Attribute VB_Name = "frmManGasFactSocios"
