...
'                        frmCamp.NuevoCodigo = Text1(Index).Text
                ...
                Else
                    ...
                    Else
                        ...
                        If EsCampoDeTratamiento(Text1(Index)) Then
...
Dim i As Integer
    ...
    'tipo de recoleccion
    '[Monica]19/11/2018: para el caso de Ribercaqui en lugar de cooperativa es recolectado por la SAT
...
Dim NumF As String
    ...
    Sql = Sql & "kilosbru, kilosnet, tipoentr, fechaent, codtrans, nropesada, numcajo2, numcajo3, numcajo4, numcajo5 "
