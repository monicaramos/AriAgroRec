...
Begin VB.Form frmManCategorias 
   ...
   Begin VB.ComboBox Combo1 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "frmManCategorias.frx":000C
      Left            =   3960
      List            =   "frmManCategorias.frx":000E
      Style           =   2  'Dropdown List
      TabIndex        =   3
      Tag             =   "Tipo Categoria|N|N|0|1|rcategorias|tipo|||"
      Top             =   4950
      Width           =   735
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   1
      Tag             =   "Nombre|T|N|||rcategorias|nomcateg|||"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|9999|rcategorias|codcateg|0000|S|"
      Top             =   4950
      Width           =   800
   End
   ...
   End
End
Attribute VB_Name = "frmManCategorias"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("rcategorias", "codcateg")
    End If
    '********************************************************************
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rcategorias.codcateg, rcategorias.nomcateg, rcategorias.precio, rcategorias.tipo, CASE tipo WHEN 0 THEN ""Horas"" WHEN 1 THEN ""Kilos"" END ntipo, "
    CadenaConsulta = CadenaConsulta & " rcategorias.codbanpr, banpropi.nombanpr "
    CadenaConsulta = CadenaConsulta & " FROM rcategorias left join banpropi on rcategorias.codbanpr = banpropi.codbanpr WHERE 1=1 "
    '************************************************************************
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "rcategorias"
        .Informe2 = "rManCategorias.rpt"
        If CadB <> "" Then
