...
'    DataGridAux(0).ClearFields
    ...
    SSTab1.TabVisible(9) = (vParamAplic.Cooperativa = 0 Or vParamAplic.Cooperativa = 18)
...
'
    ...
    If vParamAplic.Cooperativa = 8 Or vParamAplic.Cooperativa = 10 Or vParamAplic.Cooperativa = 0 Or vParamAplic.Cooperativa = 18 Then
