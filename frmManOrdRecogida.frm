...
Private WithEvents frmOrdPrev As frmBasico2 ' previsualizacion de ordenes de recogida
...
Private Sub MandaBusquedaPrevia(cadB As String)
    ...
    Set frmOrdPrev = New frmBasico2
    
    AyudaOrdenesRecogidaPrev frmOrdPrev, , cadB
