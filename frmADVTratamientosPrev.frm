...
Begin VB.Form frmADVTratamientosPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   8685
   Icon            =   "frmADVTratamientosPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   9390
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmADVTratamientosPrev.frx":000C
      Height          =   8145
      Left            =   135
      TabIndex        =   7
      Top             =   330
   ...
   End
End
Attribute VB_Name = "frmADVTratamientosPrev"
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select codtrata, nomtrata, fechaini, fechafin from advtrata where (1=1)"
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    tots = "S|txtAux(0)|T|Código|900|;S|txtAux(1)|T|Nombre|3870|;S|txtAux(2)|T|Fec.Inicio|1450|;S|txtAux(3)|T|Fec.Fin|1450|;"
