...
Begin VB.Form frmControlDestrio 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   7
         TabIndex        =   6
         Tag             =   "Porc.Pixat|N|S|||rcontrol|porcpixat|##0.00||"
         Text            =   "1234567"
         Top             =   345
         Width           =   1000
      End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   6
         TabIndex        =   1
         Tag             =   "Socio|N|N|||rcontrol|codsocio|000000|S|"
         Text            =   "123456"
         Top             =   720
         Width           =   870
      End
...
Private WithEvents frmCtrolDes As frmBasico2
Attribute frmCtrolDes.VB_VarHelpID = -1
'
'*****************************************************
...
'    DesplazamientoVisible Me.Toolbar1, btnPrimero, B, NumReg
    ...
    BloquearTxt Text1(8), (Modo <> 1), False
...
Dim cadB As String
    ...
    If CadenaSeleccion <> "" Then
        ...
        Text1(4).Text = RecuperaValor(CadenaSeleccion, 2) 'socio
        Text1(3).Text = RecuperaValor(CadenaSeleccion, 3) 'variedad
...
'                        PonerCamposSocioVariedad
        ...
        Case 8 ' porcentaje de pixat
            If Modo = 1 Then Exit Sub
            PonerFormatoDecimal Text1(8), 4
...
Dim tots As String
    ...
    Select Case Index
        Case 0 'controldestrio_plagas
            ...
            tots = tots & "S|txtAux2(0)|T|Tipo|1100|;"
            tots = tots & "S|txtAux(5)|T|Kilos 1|900|;S|txtAux(6)|T|Kilos 2|900|;S|txtAux(7)|T|Kilos 3|900|;"
            tots = tots & "S|txtAux(8)|T|Kilos 4|900|;S|txtAux(9)|T|Kilos 5|900|;S|txtAux(10)|T|Kilos 6|900|;"
            tots = tots & "S|txtAux(11)|T|Kilos 7|900|;S|txtAux(12)|T|Kilos 8|900|;S|txtAux(13)|T|Kilos 9|900|;"
            tots = tots & "S|txtAux(14)|T|Kilos 10|900|;S|txtAux(15)|T|Kilos 11|900|;N||||0|;S|txtAux(17)|T|Total|900|;S|txtAux(18)|T|Porcen|900|;N|txtAux(19)|T|Ordinal|800|;"
...
Dim SqlPixat As String
    ...
    If SeAplicaPixat(Text1(3).Text, Text1(1).Text) Then
        SqlPixat = "SELECT "
        If KilosTot <> 0 Then
            SqlPixat = SqlPixat & " round((kilosplaga1+kilosplaga2+kilosplaga3+kilosplaga4+kilosplaga5+kilosplaga6+kilosplaga7+kilosplaga8+kilosplaga9+kilosplaga10+kilosplaga11) * 100 / " & DBSet(KilosTot, "N") & ",2) "
        Else
            SqlPixat = SqlPixat & "0 "
        End If
        
        SqlPixat = SqlPixat & " from rcontrol_plagas "
        SqlPixat = SqlPixat & ObtenerWhereCab(True)
        SqlPixat = SqlPixat & " and rcontrol_plagas.idplaga = 15 "
    Else
        SqlPixat = "SELECT 0 from rcontrol_plagas where " & ObtenerWhereCab(True)
    End If
