...
Begin VB.Form frmListTrazabilidad 
   ...
   Begin VB.Frame FrameListadoStocks 
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   2
         Left            =   1440
         Picture         =   "frmListTrazabilidad.frx":03D9
         ToolTipText     =   "Buscar fecha"
         Top             =   2370
         Width           =   240
      End
      Begin VB.Image imgBuscar 
         ...
         Index           =   29
         Left            =   1440
         MouseIcon       =   "frmListTrazabilidad.frx":0464
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   28
         Left            =   1440
         MouseIcon       =   "frmListTrazabilidad.frx":05B6
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar clase"
         Top             =   1290
         Width           =   240
   ...
   Begin VB.Frame FrameCreacionPalets 
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   10
         Left            =   1320
         Picture         =   "frmListTrazabilidad.frx":0708
         Top             =   1290
         Width           =   240
      End
   End
   Begin VB.Frame FramePaletsEntrada 
      ...
      Begin VB.CommandButton Command6 
         Height          =   440
         Left            =   7860
         Picture         =   "frmListTrazabilidad.frx":0793
         Style           =   1  'Graphical
         TabIndex        =   45
         Top             =   2215
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command5 
         Height          =   440
         Left            =   7860
         Picture         =   "frmListTrazabilidad.frx":0A9D
         Style           =   1  'Graphical
         TabIndex        =   44
         Top             =   1440
         Visible         =   0   'False
   ...
   Begin VB.Frame FrameCargasFecha 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Image imgFec 
            ...
            Index           =   6
            Left            =   1110
            Picture         =   "frmListTrazabilidad.frx":0F48
            ToolTipText     =   "Buscar fecha"
            Top             =   240
            Width           =   240
         End
      ...
      Begin VB.CommandButton Command8 
         Height          =   440
         Left            =   7860
         Picture         =   "frmListTrazabilidad.frx":0FD3
         Style           =   1  'Graphical
         TabIndex        =   83
         Top             =   1440
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command7 
         Height          =   440
         Left            =   7860
         Picture         =   "frmListTrazabilidad.frx":12DD
         Style           =   1  'Graphical
         TabIndex        =   82
         Top             =   2215
         Visible         =   0   'False
   ...
   Begin VB.Frame FrameDesviacionAforos 
      ...
      Begin VB.CommandButton Command1 
         Height          =   440
         Left            =   7860
         Picture         =   "frmListTrazabilidad.frx":15E7
         Style           =   1  'Graphical
         TabIndex        =   26
         Top             =   1440
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command2 
         Height          =   440
         Left            =   7860
         Picture         =   "frmListTrazabilidad.frx":18F1
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   2215
         Visible         =   0   'False
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   1350
         MouseIcon       =   "frmListTrazabilidad.frx":1BFB
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar clase"
         Top             =   2160
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   1350
         MouseIcon       =   "frmListTrazabilidad.frx":1D4D
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar clase"
         Top             =   2565
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   9
         Left            =   1320
         MouseIcon       =   "frmListTrazabilidad.frx":1E9F
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   10
         Left            =   1320
         MouseIcon       =   "frmListTrazabilidad.frx":1FF1
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar socio"
         Top             =   1545
         Width           =   240
