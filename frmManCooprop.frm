...
Begin VB.Form frmManCooprop 
   ...
   Begin VB.TextBox txtaux 
      ...
      MaxLength       =   10
      TabIndex        =   3
      Tag             =   "Porcentaje|N|N|||rcopropiedad|porcentaje|##0.00||"
      Top             =   4560
      Width           =   1395
   End
   Begin VB.TextBox txtaux 
      ...
      MaxLength       =   8
      TabIndex        =   2
      Tag             =   "Código Campo|N|N|||rcopropiedad|codcampo|00000000||"
      Top             =   4545
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtaux 
      ...
      MaxLength       =   3
      TabIndex        =   1
      Tag             =   "Linea|N|N|||rcopropiedad|numlinea|000|S|"
      Top             =   4560
      Width           =   885
   End
   Begin VB.TextBox txtaux 
      ...
      MaxLength       =   10
      TabIndex        =   0
      Tag             =   "Código|N|N|||rcopropiedad|codpropiedad|0000000000|S|"
      Top             =   4560
      Width           =   1245
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManCooprop.frx":000C
      Height          =   4410
      Left            =   150
      TabIndex        =   8
      Top             =   570
   ...
   End
End
Attribute VB_Name = "frmManCooprop"
...
'        NumF = NuevoCodigo
'    Else
'        NumF = SugerirCodigoSiguienteStr("rcopropiedad", "codpropiedad")
'    End If
'    '********************************************************************
...
Private Sub DataGrid1_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    ...
    'Poner datos del campo
    If Not adodc1.Recordset.EOF Then
        PonerDatosCampo Me.adodc1.Recordset.Fields(2).Value
    End If
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codpropiedad=" & DBSet(CodigoActual, "N"), "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rcopropiedad.codpropiedad, rcopropiedad.numlinea, rcopropiedad.codcampo, rcopropiedad.porcentaje "
    CadenaConsulta = CadenaConsulta & " FROM rcopropiedad"
...
'    adodc1.ConnectionString = Conn
    ...
    tots = "S|txtaux(0)|T|Código|1500|;S|txtaux(1)|T|Linea|800|;S|txtaux(2)|T|Campo|1500|;S|cmdAux(0)|B|||;S|txtaux(3)|T|Porcentaje|1000|;"
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "rcopropiedad"
        .Informe2 = "rManCooprop.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rcopropiedad.codpropiedad}|"
