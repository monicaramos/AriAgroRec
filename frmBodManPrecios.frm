...
Begin VB.Form frmBodManPrecios 
   ...
   ClientTop       =   330
   ClientWidth     =   8835
   Icon            =   "frmBodManPrecios.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6915
   ...
   Begin VB.Frame FrameAux1 
      ...
      Begin VB.TextBox txtaux1 
         ...
         MaxLength       =   6
         TabIndex        =   26
         Tag             =   "Tipo Factura|N|N|0|1|rprecios_calidad|tipofact||S|"
         Text            =   "tipo"
         Top             =   2925
         Visible         =   0   'False
         Width           =   645
      ...
      Begin MSDataGridLib.DataGrid DataGridAux 
         Bindings        =   "frmBodManPrecios.frx":000C
         Height          =   3195
         Index           =   1
         Left            =   45
         TabIndex        =   32
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   1
         Left            =   2520
         Picture         =   "frmBodManPrecios.frx":0024
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   0
         Left            =   1170
         Picture         =   "frmBodManPrecios.frx":00AF
         ToolTipText     =   "Buscar fecha"
         Top             =   810
         Width           =   240
      End
   ...
   End
End
Attribute VB_Name = "frmBodManPrecios"
...
Dim Direccion As String
    'http://sigpac.mapa.es/fega/visor/AspLayerInfoProvider.aspx?layer=PARCELA&id=OID&image=ORTOFOTOS
    Direccion = "http://sigpac.mapa.es/fega/visor/AspLayerInfoProvider.aspx?layer=PARCELA&id=" & Trim(Text1(18).Text) & "&image=ORTOFOTOS"
...
'        End If
    ...
    If vParamAplic.Cooperativa = 0 Then ' caso de Catadau
