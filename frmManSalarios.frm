...
Begin VB.Form frmManSalarios 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   8
      Tag             =   "Dto Retención|N|S|||salarios|dtoreten|##0.00||"
      Top             =   4920
      Width           =   720
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   7
      Tag             =   "Plus capataz|N|S|||salarios|pluscapataz|###,##0.00||"
      Top             =   4890
      Width           =   720
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   6
      Tag             =   "Seg.Soc.|N|N|||salarios|dtosegso|#0.00||"
      Top             =   4905
      Width           =   720
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   5
      Tag             =   "IRPF|N|N|||salarios|dtosirpf|#0.00||"
      Top             =   4905
      Width           =   720
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   4
      Tag             =   "Imp.Hora Extra Festivo|N|N|||salarios|imphorafest|#0.0000||"
      Top             =   4905
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   3
      Tag             =   "Imp.Hora Extra|N|N|||salarios|imphorae|#0.0000||"
      Top             =   4905
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   2
      Tag             =   "Imp.Hora|N|N|||salarios|impsalar|#0.0000||"
      Top             =   4905
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   15
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||salarios|nomcateg|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   2
      TabIndex        =   0
      Tag             =   "Código|N|N|0|99|salarios|codcateg|00|S|"
      Top             =   4905
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManSalarios.frx":000C
      Height          =   4545
      Left            =   120
      TabIndex        =   13
      Top             =   810
   ...
   End
End
Attribute VB_Name = "frmManSalarios"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("salarios", "codcateg")
    End If
    '********************************************************************
...
Private Sub BotonModificar()
    ...
    txtAux(8).Text = DataGrid1.Columns(8).Text
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from salarios where codcateg=" & adodc1.Recordset!Codcateg
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codcateg=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT codcateg, nomcateg, impsalar, imphorae, imphorafest, dtosirpf, dtosegso, pluscapataz, dtoreten  "
    CadenaConsulta = CadenaConsulta & " FROM salarios"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY salarios.codcateg"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Código|800|;S|txtAux(1)|T|Descripción|2100|;S|txtAux(2)|T|Imp.Hora|1600|;"
    tots = tots & "S|txtAux(3)|T|Imp.Hora Extra|1600|;S|txtAux(4)|T|Imp.Hora Fest.|1600|;S|txtAux(5)|T|IRPF|900|;"
    tots = tots & "S|txtAux(6)|T|Seg.Soc.|900|;S|txtAux(7)|T|Plus Capataz|1400|;S|txtAux(8)|T|Retención|1400|;"
...
Private Sub txtAux_LostFocus(Index As Integer)
    ...
    Select Case Index
        ...
        Case 2, 3, 4
            ...
            PonerFormatoDecimal txtAux(Index), 8
        Case 5, 6
            If Modo = 1 Then Exit Sub
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={salarios.codcateg}|"
