...
Begin VB.Form frmPOZHidrantesMonastPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   9165
   Icon            =   "frmPOZHidrantesMonastPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6465
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmPOZHidrantesMonastPrev.frx":000C
      Height          =   5265
      Left            =   120
      TabIndex        =   7
      Top             =   330
   ...
   End
End
Attribute VB_Name = "frmPOZHidrantesMonastPrev"
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    tots = "S|txtAux(0)|T|Contador|1600|;S|txtAux(1)|T|Socio|1100|;S|txtAux(2)|T|Nombre|4200|;S|txtAux(3)|T|Orden|1400|;"
