...
Begin VB.Form frmManIngresos 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   3
      Tag             =   "Importe|N|N|||ringresos|importe|###,##0.00||"
      Top             =   4890
      Width           =   990
   End
   Begin VB.TextBox txtAux2 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   80
      TabIndex        =   2
      Tag             =   "Concepto|T|N|||ringresos|concepto||S|"
      Top             =   4890
      Width           =   4515
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   1
      Tag             =   "Variedad|N|N|||ringresos|codvarie|000000|S|"
      Top             =   4905
      Width           =   1320
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   0
      Tag             =   "Código|N|N|0|999999|ringresos|codsocio|000000|S|"
      Top             =   4905
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManIngresos.frx":000C
      Height          =   4550
      Left            =   90
      TabIndex        =   8
      Top             =   810
   ...
   End
End
Attribute VB_Name = "frmManIngresos"
...
Private WithEvents frmVar As frmComVar 'mantenimiento de variedades
...
Private Sub BotonBuscar()
    ...
    CargaGrid "ringresos.codsocio = -1"
    '*******************************************************************************
    'Buscar
    For I = 0 To txtAux.Count - 1
        txtAux(I).Text = ""
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT ringresos.codsocio, rsocios.nomsocio, ringresos.codvarie, variedades.nomvarie, ringresos.concepto, ringresos.importe "
    CadenaConsulta = CadenaConsulta & " FROM ringresos, rsocios, variedades"
    CadenaConsulta = CadenaConsulta & " WHERE ringresos.codsocio = rsocios.codsocio and "
    CadenaConsulta = CadenaConsulta & " ringresos.codvarie = variedades.codvarie "
    '************************************************************************
...
'    adodc1.ConnectionString = Conn
    ...
    tots = "S|txtAux(0)|T|Socio|1000|;S|btnBuscar(0)|B||195|;S|txtAux2(0)|T|Nombre Socio|3000|;"
    tots = tots & "S|txtAux(1)|T|Código|1000|;S|btnBuscar(1)|B||195|;S|txtAux2(1)|T|Variedad|2000|;"
    tots = tots & "S|txtAux(2)|T|Concepto|6000|;"
    tots = tots & "S|txtAux(3)|T|Importe|1650|;"
        ...
        Case 0 'codigo de socio
            If PonerFormatoEntero(txtAux(Index)) Then
                ...
                If txtAux2(Index).Text = "" Then
                    cadMen = "No existe el Socio. Reintroduzca." & txtAux(Index).Text & vbCrLf
                    MsgBox (cadMen)
...
'                          If Not vSocio.Estercero(txtAux(Index).Text) Then PonerFoco txtAux(Index)
        ...
        Case 1 'variedad
            If PonerFormatoEntero(txtAux(Index)) Then
                ...
                If txtAux2(Index).Text = "" Then
                    cadMen = "No existe la Variedad. Reintroduzca." & txtAux(Index).Text & vbCrLf
                    MsgBox (cadMen)
                    PonerFoco txtAux(Index)
                End If
            End If
    ...
    If KeyAscii = teclaBuscar Then
        If Modo = 1 Or Modo = 3 Or Modo = 4 Then
            Select Case Index
                ...
                Case 1: KEYBusqueda KeyAscii, 1 'variedad
            End Select
        End If
    Else
        KEYpress KeyAscii
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={ringresos.codsocio}|"
