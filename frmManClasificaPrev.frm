...
Begin VB.Form frmManClasificaPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   10725
   Icon            =   "frmManClasificaPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6465
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   13
      Tag             =   "Campo|N|N|||rclasifica|codcampo|00000000||"
      Top             =   4950
      Width           =   1425
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   12
      Tag             =   "Variedad|T|N|||vaeriedades|nomvarie|||"
      Top             =   4950
      Width           =   1965
   End
   Begin VB.TextBox txtAux 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   2
      Tag             =   "Codigo Socio|N|N|||rclasifica|codsocio|000000||"
      Top             =   4950
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   7
      TabIndex        =   1
      Tag             =   "Fecha|F|N|||rsocios|fechaent|dd/mm/yyyy||"
      Top             =   4950
      Width           =   1305
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Nro.Nota|N|N|||rclasifica|numnotac|0000000|S|"
      Top             =   4950
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManClasificaPrev.frx":000C
      Height          =   5265
      Left            =   120
      TabIndex        =   7
      Top             =   330
   ...
   End
End
Attribute VB_Name = "frmManClasificaPrev"
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select rclasifica.numnotac, rclasifica.fechaent, rclasifica.codsocio, rsocios.nomsocio, variedades.nomvarie, rclasifica.codcampo "
    CadenaConsulta = CadenaConsulta & " from (rclasifica left join rsocios on rclasifica.codsocio = rsocios.codsocio) "
    CadenaConsulta = CadenaConsulta & " left join variedades on rclasifica.codvarie = variedades.codvarie where (1 = 1) "
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    tots = "S|txtAux(0)|T|Nota|1000|;S|txtAux(1)|T|Fecha|1270|;S|txtAux(2)|T|Codigo|950|;S|txtAux(3)|T|Socio|3600|;S|txtAux(4)|T|Variedad|1900|;S|txtAux(5)|T|Campo|1250|;"
