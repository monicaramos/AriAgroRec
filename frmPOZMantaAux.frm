...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    tots = tots & "N|txtAux(2)|T|Código|900|;S|btnBuscar(1)|B||195|;S|Text2(3)|T|Variedad|2400|;"
    tots = tots & "S|txtAux(3)|T|Código|600|;S|btnBuscar(2)|B||195|;S|Text2(0)|T|Partida|1500|;"
    tots = tots & "S|txtAux(10)|T|Cód.|600|;S|btnBuscar(3)|B||195|;S|Text2(1)|T|Zona|2000|;"
