...
Dim b As Boolean
    ...
    'Importacion
    Toolbar1.Buttons(12).Enabled = UCase(Dir(App.Path & "\controlclas.cfg")) = UCase("controlclas.cfg")
...
Private Sub Form_Load()
    ...
    With Me.Toolbar1
        ...
        .Buttons(12).Image = 35  'exportacion a excel
...
'    adodc1.ConnectionString = Conn
    ...
    tots = "S|txtAux(3)|T|Nota|1000|;S|txtAux(1)|T|Fecha|1100|;S|btnBuscar(1)|B||195|;"
    tots = tots & "S|txtAux(5)|T|Código|800|;S|btnBuscar(3)|B||195|;S|txtAux2(5)|T|Variedad|1700|;"
    tots = tots & "S|txtAux(0)|T|Código|800|;S|btnBuscar(0)|B||195|;S|txtAux2(0)|T|Nombre Socio|2500|;"
    tots = tots & "S|txtAux(2)|T|Campo|1500|;S|btnBuscar(2)|B||195|;"
    tots = tots & "S|txtAux(6)|T|Cajones|900|;"
    tots = tots & "S|txtAux(4)|T|Kilos|900|;N||||0|;S|chkAux(0)|CB|IA|360|;"
