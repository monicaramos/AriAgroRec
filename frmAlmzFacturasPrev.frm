...
Begin VB.Form frmAlmzFacturasPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   10425
   Icon            =   "frmAlmzFacturasPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   9450
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código|N|N|||rcabfactalmz|tipofichero|000000|S|"
      Top             =   4950
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmAlmzFacturasPrev.frx":000C
      Height          =   8145
      Left            =   120
      TabIndex        =   7
      Top             =   330
   ...
   End
End
Attribute VB_Name = "frmAlmzFacturasPrev"
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select rcabfactalmz.tipofichero, case rcabfactalmz.tipofichero when 0 then ""Aceite"" when 1 then ""Aceituna"" when 2 then ""Stock"" end, "
    CadenaConsulta = CadenaConsulta & "rcabfactalmz.numfactu, rcabfactalmz.fecfactu, rcabfactalmz.codsocio, rsocios.nomsocio from rcabfactalmz, rsocios where rcabfactalmz.codsocio = rsocios.codsocio "
...
'    tots = "S|txtAux(0)|T|Tipo|900|;S|txtAux(1)|T|Nombre|3870|;S|txtAux(2)|T|Nif|1250|;S|txtAux(3)|T|Teléfono|1300|;S|txtAux(4)|T|Móvil|1300|;S|txtAux(5)|T|Fecha Alta|1250|;"
    tots = "N||||0|;S|txtAux(0)|T|Tipo|1300|;S|txtAux(1)|T|Factura|1270|;S|txtAux(2)|T|Fecha|1450|;S|txtAux(3)|T|Codigo|1100|;S|txtAux(4)|T|Socio|4400|;"
