...
Begin VB.Form frmManPreciosPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   10725
   Icon            =   "frmManPreciosPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6465
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   13
      Tag             =   "Fecha Fin|F|N|||rprecios|fechafin|dd/mm/yyyy||"
      Top             =   4950
      Width           =   1425
   End
   Begin VB.TextBox txtAux 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   11
      Tag             =   "Contador|N|N|||rprecios|contador|0000000||"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   2
      Tag             =   "Tipo|T|N|||rprecios|tipofact|||"
      Top             =   4950
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código|N|N|||rprecios|codvarie|000000|S|"
      Top             =   4950
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManPreciosPrev.frx":000C
      Height          =   5265
      Left            =   120
      TabIndex        =   7
      Top             =   330
   ...
   End
End
Attribute VB_Name = "frmManPreciosPrev"
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    tots = "S|txtAux(0)|T|Código|900|;S|txtAux(1)|T|Variedad|3170|;S|txtAux(2)|T|Tipo|1900|;S|txtAux(3)|T|Contador|1300|;S|txtAux(4)|T|Fecha Inicio|1300|;S|txtAux(5)|T|Fecha Fin|1300|;N|||||;"
