      ...
      Begin MSComctlLib.Toolbar Toolbar2 
         ...
         BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty Button1 {66833FEA-8583-11D1-B16A-00C0F0283628} 
               Object.ToolTipText     =   "Generar Modelo"
               Object.Tag             =   "2"
            EndProperty
         EndProperty
      End
...
'    btnBuscar(2).Enabled = (Modo = 1)
    ...
    BloquearChk Me.chkAux(0), (Modo = 4 And vParamAplic.Cooperativa <> 0) Or (Modo = 3)
    Me.chkAux(0).visible = ((Modo = 1) Or (Modo = 4 And vParamAplic.Cooperativa = 0))
...
Private Sub Form_Load()
    ...
    With Me.Toolbar2
        ...
        .DisabledImageList = frmPpal.imgListComun_BN
        .ImageList = frmPpal.imgListComun
        .Buttons(1).Image = 22  'generar fichero
    End With
...
Dim ConSubInforme As Boolean
    ...
    With frmImprimir2
        .cadTabla2 = "horasanticipos"
        .Informe2 = "rAnticipos.rpt"
        If CadB <> "" Then
            .cadRegSelec = SQL2SF(CadB)
        Else
            .cadRegSelec = ""
        End If
        .cadRegActua = POS2SF(Me.adodc1, Me)
...
'    adodc1.ConnectionString = Conn
    ...
    tots = tots & "S|txtAux(3)|T|F.Pago|1400|;S|btnBuscar(2)|B||195|;N||||0|;S|chkAux(0)|CB|D|360|;"
    ...
    If KeyAscii = teclaBuscar Then
        If Modo = 1 Or Modo = 3 Or Modo = 4 Then
            ...
            Select Case Index
                ...
                Case 3: KEYBusqueda KeyAscii, 2 'fecha de pago
            End Select
        End If
    Else
        KEYpress KeyAscii
...
Dim Sql As String
    ...
    If vParamAplic.Cooperativa = 0 Then
        Sql = Sql & ", descontado = " & DBSet(Me.chkAux(0).Value, "N")
    End If
