...
Begin VB.Form frmMensajes 
   ...
   Begin VB.Frame FrameFrasPteContabilizar 
      ...
      Begin VB.ComboBox Combo1 
         ...
         Height          =   360
         Index           =   0
         ItemData        =   "frmMensajes.frx":0A62
         Left            =   240
         List            =   "frmMensajes.frx":0A6C
...
'66 .- Mostramos el texto que se va a imprimir en el informe de campos/huerto de catadau

'67 .- Seleccionamos los socios a facturar

'68 .- Facturas pendientes de contabilizar
...
Private Sub CmdAcepContratos_Click()
    ...
    For NumRegElim = 1 To ListView21.ListItems.Count
        If ListView21.ListItems(NumRegElim).Checked Then
            If OpcionMensaje = 72 Or OpcionMensaje = 73 Or OpcionMensaje = 74 Or OpcionMensaje = 75 Or OpcionMensaje = 76 Then
                cadena = cadena & DBSet(ListView21.ListItems(NumRegElim).Text, "N") & ","
            Else
...
Dim c1 As String * 10, c2 As String * 10, c3 As String * 10
    ...
    ElseIf OpcionMensaje = 8 Or OpcionMensaje = 9 Or OpcionMensaje = 17 Or OpcionMensaje = 42 Or OpcionMensaje = 55 Or OpcionMensaje = 67 Then
...
Dim OK As Boolean
    ...
    Select Case OpcionMensaje
        ...
        Case 8, 9, 17, 42, 55, 67 'Etiquetas de clientes/Proveedores/Socios
            CargarListaClientes
        ...
        Case 60 ' matriculas de transportistas
            CargarMatriculas
...
'            PulsadoSalir = False
        ...
        Case 9, 42, 55, 67  'Etiquetas de Socios
            PonerFrameNSeriesVisible True, H, W
            Me.Caption = "Socios"
            PulsadoSalir = False
        ...
        Case 69 ' histórico de facturas de consumo del contador
...
Dim Sql As String
    ...
    ListView1.Width = 10100
    ListView1.Left = 160
    
    'Los encabezados
    ListView1.ColumnHeaders.Clear
    
    ListView1.ColumnHeaders.Add , , "Serie", 760
    ListView1.ColumnHeaders.Add , , "NºFactura", 1200, 1
    ListView1.ColumnHeaders.Add , , "Fec. Factura", 1550, 2
    ListView1.ColumnHeaders.Add , , "Fec. Vencim", 1500, 2
    ListView1.ColumnHeaders.Add , , "Imp.Vencim(€)", 1650, 1
    ListView1.ColumnHeaders.Add , , "Imp. Cobro(€)", 1650, 1
    ListView1.ColumnHeaders.Add , , "Pte. Cobro(€)", 1650, 1
...
Dim Sql As String, Men As String
    ...
    If Not Rs.EOF Then
        ...
        While Not Rs.EOF
             ...
             If OpcionMensaje = 67 Then ItmX.Checked = True
...
Dim ItmX As ListItem
    ...
    If Not Rs.EOF Then
        ...
        ListView7.ColumnHeaders.Add , , "", 3600, 0
...
Dim b As Boolean
    If Index < 2 Then
        ...
        For TotalArray = 1 To ListView3.ListItems.Count
            ...
            '[Monica]24/04/2018: si no esta entregada la ficha de cultivo se queda siempre desmarcado
            If OpcionMensaje = 51 Then
                If ComprobarCero(ListView3.ListItems(TotalArray).ToolTipText) = 0 Then
                    ListView3.ListItems(TotalArray).Checked = False
                End If
            End If
...
Dim It As ListItem
    ...
    Case 5
        ...
        '[Monica]24/04/2018: se ponen en rojo los que no tienen entregada la ficha de cultivo: entregafichaculti
        Sql = Sql & " rsocios.nomsocio, rcampos.entregafichaculti  from rcampos, variedades, rsocios, rpartida  where "
        Sql = Sql & " rcampos.codvarie = variedades.codvarie and rcampos.codsocio = rsocios.codsocio and rcampos.codparti = rpartida.codparti "
...
'        Sql = Sql & " order by rcampos.codvarie, rcampos.codsocio "
    ...
    Select Case Opcion
        Case 0
            ...
            ListView3.ColumnHeaders.Add , , "Codigo", 1000, 1
            ListView3.ColumnHeaders.Add , , "Variedad", 1500
            ListView3.ColumnHeaders.Add , , "Partida", 1800
            ListView3.ColumnHeaders.Add , , "Poligono", 1100 '800
            ListView3.ColumnHeaders.Add , , "Parcela", 1000 '600
'            ListView3.ColumnHeaders.Add , , "SbP", 600
        ...
        Case 2
            ...
            ListView4.ColumnHeaders.Add , , "Codigo", 1000 '800, 1
            ListView4.ColumnHeaders.Add , , "Variedad", 2500 '2000, 1
            ListView4.ColumnHeaders.Add , , "Partida", 2000 '1800
            ListView4.ColumnHeaders.Add , , "Poligono", 1500 '1000
            ListView4.ColumnHeaders.Add , , "Parcela", 1600 '800
'            ListView4.ColumnHeaders.Add , , "SbP", 600
            ListView4.ColumnHeaders.Add , , "Nro.", 800 '600
        ...
        Case 3
            ...
            ListView3.ColumnHeaders.Add , , "Partida", 2000 '1800
            ListView3.ColumnHeaders.Add , , "Variedad", 1800 '1500
        ...
        Case 4 ' campos de un socio
            ...
            ListView3.ColumnHeaders.Add , , "Campo", 1200
            ListView3.ColumnHeaders.Add , , "NºOrden", 1000 '900, 1
            ListView3.ColumnHeaders.Add , , "Partida", 2000 '1800
            ListView3.ColumnHeaders.Add , , "Variedad", 1700 '1500
            ListView3.ColumnHeaders.Add , , "Socio", 2900 '2400
   
        Case 5 ' campos de un socio
            ListView3.ColumnHeaders.Clear
        
            ListView3.ColumnHeaders.Add , , "NºOrden", 1000
            ListView3.ColumnHeaders.Add , , "Partida", 2000 '1800
            ListView3.ColumnHeaders.Add , , "Variedad", 1800 '1500
            ListView3.ColumnHeaders.Add , , "Socio", 3400
            '[Monica]24/04/2018: se pnen en rojo los que no tienen ficha de cultivo entregada
            ListView3.ColumnHeaders.Add , , "FichCulti", 0 ' para indicar si tiene ficha de cultivo
   
        Case 6 ' ordenes de recoleccion emitidas
            ListView4.ColumnHeaders.Clear
        
            ListView4.ColumnHeaders.Add , , "NºOrden", 1200 '1000
            ListView4.ColumnHeaders.Add , , "Fecha", 1400 '1100
            ListView4.ColumnHeaders.Add , , "NºCampo", 1000
            ListView4.ColumnHeaders.Add , , "Partida", 1500
            ListView4.ColumnHeaders.Add , , "Variedad", 1500 '1100
            ListView4.ColumnHeaders.Add , , "Socio", 2900 '2800
        ...
        Case 7
            ...
            ListView3.ColumnHeaders.Add , , "Poligono", 1100 ' 800
            ListView3.ColumnHeaders.Add , , "Parcela", 800 '600
            ListView3.ColumnHeaders.Add , , "SbP", 600
            ListView3.ColumnHeaders.Add , , "Variedad", 1500
   ...
   End Select
    ...
    While Not Rs.EOF
        ...
        Else
            ...
            Else
                If Opcion = 5 Then
                    ...
                    It.ToolTipText = DBLet(Rs!entregafichaculti, "N")
                    '[Monica]24/08/2018: si no entregada la ficha se pone en color rojo
                    If DBLet(Rs!entregafichaculti, "N") = 0 Then
                        It.ForeColor = vbRed
        ...
        If Opcion = 4 Then It.Checked = True
        '[Monica]24/04/2018: si no ha entregado la ficha de cultivo no se permite crearla
        If Opcion = 5 Then
            If ComprobarCero(It.ToolTipText) <> 0 Then It.Checked = True
        End If
...
'    If Ordenar Then SQL = SQL & " order by 1"
    ...
    If DadoProducto Then
        ListView6.ColumnHeaders.Add , , "Código", 1200.0631 '1000
        ListView6.ColumnHeaders.Add , , "Variedad", 2500 ' 2200.2522 , 1
...
Dim Consumido As Currency
    ...
    ListView8.ColumnHeaders.Add , , "Código", 900
    ListView8.ColumnHeaders.Add , , "Variedad", 2440 ' 1450 '1740
    ListView8.ColumnHeaders.Add , , "Unidades", 1200, 1
    ListView8.ColumnHeaders.Add , , "Cantidad", 1200, 1
    ...
    ListView9.ColumnHeaders.Add , , "Código", 900
    ListView9.ColumnHeaders.Add , , "Producto", 2440
    ListView9.ColumnHeaders.Add , , "Unidades", 1200, 1
    ListView9.ColumnHeaders.Add , , "Cantidad", 1200, 1
...
Dim It As ListItem
    ...
    ListView13.ColumnHeaders.Add , , "Codigo", 1100, 1
    ListView13.ColumnHeaders.Add , , "Partida", 2700
    ListView13.ColumnHeaders.Add , , "Poligono", 1200
    ListView13.ColumnHeaders.Add , , "Parcela", 1900
...
Dim It As ListItem
    ...
    ListView13.ColumnHeaders.Add , , "Contador", 1200
    ListView13.ColumnHeaders.Add , , "Codigo", 900, 1
    ListView13.ColumnHeaders.Add , , "Socio", 2400
    ListView13.ColumnHeaders.Add , , "Partida", 1200
    ListView13.ColumnHeaders.Add , , "Poligono", 1100
    ListView13.ColumnHeaders.Add , , "Parcela", 1300
...
Dim NomFic As String
    ...
    ListView15.ColumnHeaders.Add , , "Variedad", 1100, 1
    ListView15.ColumnHeaders.Add , , "Socio", 1100
    ListView15.ColumnHeaders.Add , , "Campo", 1300
...
Dim It As ListItem
    ...
    ListView4.ColumnHeaders.Add , , "Albarán", 1200
    ListView4.ColumnHeaders.Add , , "Fecha", 1400
    ListView4.ColumnHeaders.Add , , "Variedad", 2800
    ListView4.ColumnHeaders.Add , , "Campo", 1500
    ListView4.ColumnHeaders.Add , , "Nota", 1400, 1
    ListView4.ColumnHeaders.Add , , "Kilos", 1500, 1
    ListView4.ColumnHeaders.Add , , "Importe", 1900, 1
...
Dim It As ListItem
    ...
    ListView12.ColumnHeaders.Add , , "Albarán", 1000
    ListView12.ColumnHeaders.Add , , "Fecha", 1400
    ListView12.ColumnHeaders.Add , , "Variedad", 2200
    ListView12.ColumnHeaders.Add , , "Campo", 1200
    ListView12.ColumnHeaders.Add , , "Kilos", 1500, 1
...
Dim It As ListItem
    ...
    ListView10.ColumnHeaders.Add , , "Fecha", 1400
    ListView10.ColumnHeaders.Add , , "Hora", 1200
    ListView10.ColumnHeaders.Add , , "Código", 950
    ListView10.ColumnHeaders.Add , , "Variedad", 1300
    ListView10.ColumnHeaders.Add , , "Código", 950
    ListView10.ColumnHeaders.Add , , "Socio", 3050
...
Dim It As ListItem
    ...
    ListView10.ColumnHeaders.Add , , "Albarán", 1100
    ListView10.ColumnHeaders.Add , , "Fecha", 1400
    ListView10.ColumnHeaders.Add , , "Hora", 1100
    ListView10.ColumnHeaders.Add , , "Código", 900
    ListView10.ColumnHeaders.Add , , "Variedad", 1300
    ListView10.ColumnHeaders.Add , , "Código", 900
    ListView10.ColumnHeaders.Add , , "Socio", 3050
...
Dim i As Integer
    ...
    ListView6.ColumnHeaders.Add , , "Código", 1200.0631
    ListView6.ColumnHeaders.Add , , "Fecha", 1400.2522
    ListView6.ColumnHeaders.Add , , "Variedad", 2400.2522
    ListView6.ColumnHeaders.Add , , "Kilos", 1600.2522, 1
    ...
    While Not Rs.EOF
        ...
        '[Monica]18/01/2019: en el caso de frutas inma los kilos pagados al socio son los transportados
        If vParamAplic.Cooperativa = 18 Then
            It.SubItems(3) = DBLet(Rs!KilosTra, "N")
        Else
...
Dim Consumido As Currency
    ...
    ListView16.ColumnHeaders.Add , , "Contador", 1150
    ListView16.ColumnHeaders.Add , , "Socio", 3140 ' 1450 '1740
    ListView16.ColumnHeaders.Add , , "Consumo", 1200, 1
    ...
    ListView17.ColumnHeaders.Add , , "Contador", 1150
    ListView17.ColumnHeaders.Add , , "Socio", 3140 ' 1450 '1740
    ListView17.ColumnHeaders.Add , , "Consumo", 1200, 1
...
Dim It As ListItem
    ...
    If columna = 1 Then
        If Orden = 0 Then
            ListView19.ColumnHeaders.Add , , "NºRecibo", 1100, 1
        Else
            ListView19.ColumnHeaders.Add , , "NºRecibo v", 1100, 1
        End If
    Else
        If Columna2 = 1 Then
            If Orden2 = 0 Then
    ...
    If columna = 2 Then
        If Orden = 0 Then
            ListView19.ColumnHeaders.Add , , "Fecha", 1400, 0
        Else
            ListView19.ColumnHeaders.Add , , "Fecha v", 1400, 0
        End If
    Else
        If Columna2 = 2 Then
            If Orden2 = 0 Then
    ...
    If columna = 3 Then
        If Orden = 0 Then
            ListView19.ColumnHeaders.Add , , "Socio", 1100, 1
        Else
            ListView19.ColumnHeaders.Add , , "Socio v", 1100, 1
        End If
    Else
        If Columna2 = 3 Then
            If Orden2 = 0 Then
    ...
    If columna = 4 Then
        If Orden = 0 Then
            ListView19.ColumnHeaders.Add , , "Nombre", 3550, 0
        Else
            ListView19.ColumnHeaders.Add , , "Nombre v", 3550, 0
        End If
    Else
        If Columna2 = 4 Then
            If Orden2 = 0 Then
    ...
    If columna = 5 Then
        If Orden = 0 Then
            ListView19.ColumnHeaders.Add , , "Total", 2000, 1
        Else
            ListView19.ColumnHeaders.Add , , "Total v", 2000, 1
        End If
    Else
        If Columna2 = 5 Then
            If Orden2 = 0 Then
    ...
    If columna = 6 Then
        If Orden = 0 Then
            ListView19.ColumnHeaders.Add , , "Cobrado", 1300, 0
        Else
            ListView19.ColumnHeaders.Add , , "Cobrado v", 1300, 0
        End If
    Else
        If Columna2 = 6 Then
            If Orden2 = 0 Then
...
Dim It As ListItem
    ...
    ListView20.ColumnHeaders.Add , , "Fecha", 1400
    ListView20.ColumnHeaders.Add , , "Socio", 1200, 1
...
Dim It As ListItem
    ...
    ListView21.ColumnHeaders.Add , , "Contrato", 2500
...
Dim It As ListItem
    ...
    ListView22.ColumnHeaders.Add , , "Tipo Factura", 3000
...
Dim It As ListItem
    ...
    ListView21.ColumnHeaders.Add , , "Codigo", 1500
    ListView21.ColumnHeaders.Add , , "Nombre", 4600
...
Dim It As ListItem
    ...
    While Not Rs.EOF
        ...
        'It.Tag = DevNombreSQL(RS!codCampo)
        It.Text = DBLet(Rs!codzonas, "N")
        It.SubItems(1) = DBLet(Rs!nomzonas, "T")
...
Dim It As ListItem
    ...
    While Not Rs.EOF
        ...
        'It.Tag = DevNombreSQL(RS!codCampo)
        It.Text = DBLet(Rs!codparti, "N")
        It.SubItems(1) = DBLet(Rs!nomparti, "T")
