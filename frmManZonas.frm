...
Begin VB.Form frmManZonas 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   4
      Tag             =   "Prec.Manta €/Hda|N|S|||rzonas|preciomanta|###0.0000||"
      Top             =   4890
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   3
      Tag             =   "Prec.Talla Ordinaria €/Hda|N|S|||rzonas|precio2|###0.0000||"
      Top             =   4890
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   2
      Tag             =   "Prec.Amort.Canal €/Hda|N|S|||rzonas|precio1|###0.0000||"
      Top             =   4890
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||rzonas|nomzonas|||"
      Top             =   4890
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|9999|rzonas|codzonas|0000|S|"
      Top             =   4890
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManZonas.frx":000C
      Height          =   4190
      Left            =   150
      TabIndex        =   9
      Top             =   870
   ...
   Begin VB.Menu mnOpciones 
      ...
      Begin VB.Menu mnAsignacion 
         Caption         =   "&Asignacion Precios Masiva"
         Shortcut        =   ^A
      End
...
Dim B As Boolean
    ...
    'Asignacion Precios Masiva
    Toolbar2.Buttons(1).Enabled = B And Not Me.DeInformes
    Me.mnAsignacion.Enabled = B And Not Me.DeInformes
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("rzonas", "codzonas")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    If vParamAplic.Cooperativa = 8 Or vParamAplic.Cooperativa = 10 Then
        SQL = "¿Seguro que desea eliminar el Braçal?"
    Else
        SQL = "¿Seguro que desea eliminar la Zona?"
    End If
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from rzonas where codzonas=" & adodc1.Recordset!codzonas
        conn.Execute SQL
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codzonas=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'        .Buttons(12).Image = 13  'asignacion de precios masiva
'        .Buttons(13).Image = 11  'Salir
    ...
    With Me.Toolbar2
        ...
        .DisabledImageList = frmPpal.imgListComun_BN
        .ImageList = frmPpal.imgListComun
        .Buttons(1).Image = 13  'asignacion de precios masiva
    End With
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rzonas.codzonas, rzonas.nomzonas, rzonas.precio1, rzonas.precio2,"
    CadenaConsulta = CadenaConsulta & "if(if(rzonas.precio1 is null,0,rzonas.precio1) + if(rzonas.precio2 is null,0,rzonas.precio2)= 0,'',if(rzonas.precio1 is null,0,rzonas.precio1) + if(rzonas.precio2 is null,0,rzonas.precio2)), "
    CadenaConsulta = CadenaConsulta & "rzonas.preciomanta "
    CadenaConsulta = CadenaConsulta & " FROM rzonas"
...
'    End If
    ...
    '[Monica]07/06/2013: Zonas / Braçals
    If vParamAplic.Cooperativa = 8 Or vParamAplic.Cooperativa = 10 Then
        frmManZonas.Caption = "Braçals"
    End If
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    SQL = SQL & " ORDER BY rzonas.codzonas"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, SQL, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Código|800|;S|txtAux(1)|T|Descripción|3250|;"
    tots = tots & "S|txtAux(2)|T|Am.Canal  €/Hda|1850|;S|txtAux(3)|T|Talla Ord  €/Hda|1850|;"
    tots = tots & "S|txtAux(4)|T|TOTAL   €/Hda|1750|;S|txtAux(5)|T|Pr.Manta  €/Hda|1850|;"
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rzonas.codzonas}|"
