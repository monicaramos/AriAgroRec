...
Begin VB.Form frmManConcepGasto 
   ...
   ClientTop       =   30
   ClientWidth     =   10770
   Icon            =   "frmManConcepGasto.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7155
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   40
      TabIndex        =   4
      Tag             =   "Cta.Contable Gtos|T|S|||rconcepgasto|codmacgto|||"
      Top             =   4920
      Width           =   1425
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   40
      TabIndex        =   3
      Tag             =   "Cta.Contable|T|S|||rconcepgasto|codmacta|||"
      Top             =   4935
      Width           =   1425
   End
   Begin VB.ComboBox Combo1 
      ...
      Height          =   360
      Index           =   0
      ItemData        =   "frmManConcepGasto.frx":000C
      Left            =   2385
      List            =   "frmManConcepGasto.frx":000E
      Style           =   2  'Dropdown List
      TabIndex        =   2
      Tag             =   "Tipo Gasto|N|N|0|1|rconcepgasto|tipogasto|||"
      Top             =   4905
      Width           =   1220
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   40
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||rconcepgasto|nomgasto|||"
      Top             =   4950
      Width           =   1425
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|99|rconcepgasto|codgasto|00|S|"
      Top             =   4950
      Width           =   825
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManConcepGasto.frx":0010
      Height          =   4545
      Left            =   90
      TabIndex        =   9
      Top             =   795
   ...
   End
End
Attribute VB_Name = "frmManConcepGasto"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("rconcepgasto", "codgasto")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    SQL = "¿Seguro que desea eliminar el Concepto de Gasto?"
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from rconcepgasto where codgasto=" & adodc1.Recordset!Codgasto
        conn.Execute SQL
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
...
Private Sub CargaForaGrid()
    ...
    If IsNull(Me.adodc1.Recordset.Fields(4).Value) Then Exit Sub
    
    txtAux2(2).Text = DevuelveDesdeBDNew(cConta, "cuentas", "nommacta", "codmacta", Me.adodc1.Recordset.Fields(4).Value, "T")
 
 
    '[Monica]29/12/2011: nueva cuenta de gastos para la integracion de gastos de campo
    txtAux2(3).Text = ""
    
    If IsNull(Me.adodc1.Recordset.Fields(5).Value) Then Exit Sub
    
    txtAux2(3).Text = DevuelveDesdeBDNew(cConta, "cuentas", "nommacta", "codmacta", Me.adodc1.Recordset.Fields(5).Value, "T")
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codgasto=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rconcepgasto.codgasto, rconcepgasto.nomgasto, rconcepgasto.tipogasto,"
    CadenaConsulta = CadenaConsulta & "CASE rconcepgasto.tipogasto WHEN 0 THEN ""Entrada"" WHEN 1 THEN ""Factura"" END, "
    CadenaConsulta = CadenaConsulta & " rconcepgasto.codmacta, "
    CadenaConsulta = CadenaConsulta & " rconcepgasto.codmacgto "
    CadenaConsulta = CadenaConsulta & " FROM rconcepgasto "
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    SQL = SQL & " ORDER BY rconcepgasto.codgasto"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, SQL, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Código|800|;S|txtAux(1)|T|Descripción|4960|;N||||0|;S|Combo1(0)|C|Aplicado a|1220|;"
    tots = tots & "S|txtAux(2)|T|Cta.Contable|1500|;S|btnBuscar(2)|B|||;"
    tots = tots & "S|txtAux(3)|T|Cta.Conta.Gto|1500|;S|btnBuscar(3)|B|||;"
...
Dim Mens As String
    ...
    If B And (Modo = 3 Or Modo = 4) Then
        If Combo1(0).ListIndex = 1 And txtAux(2).Text = "" Then
            MsgBox "El concepto es de Factura, ha de tener una Cta.Contable asociada. Revise.", vbExclamation
            B = False
            PonerFoco txtAux(2)
        End If
    End If
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "rconcepgasto"
        .Informe2 = "rManConcepGasto.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rconcepgasto.codgasto}|"
...
Private Sub txtaux_KeyPress(Index As Integer, KeyAscii As Integer)
    If KeyAscii = teclaBuscar Then
        Select Case Index
            Case 2: KEYBusqueda KeyAscii, 2 'cuenta
            Case 3: KEYBusqueda KeyAscii, 3 'cuenta
        End Select
    Else
        KEYpress KeyAscii
    End If
