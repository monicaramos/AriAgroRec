...
Begin VB.Form frmManPueblos 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   3
      Tag             =   "Codigo I.N.E|N|N|||rpueblos|codigine|000||"
      Top             =   4905
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   2
      Tag             =   "Cod.SigPac|N|N|||rpueblos|codsigpa|000000||"
      Top             =   4905
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||rpueblos|despobla|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   0
      Tag             =   "Código|T|N|||rpueblos|codpobla||S|"
      Top             =   4920
      Width           =   800
   End
   ...
   End
End
Attribute VB_Name = "frmManPueblos"
...
'        NumF = NuevoCodigo
'    Else
'        NumF = SugerirCodigoSiguienteStr("rpueblos", "codpobla")
'    End If
    '********************************************************************
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codpobla=" & DBSet(CodigoActual, "T"), "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rpueblos.codpobla, rpueblos.despobla, rpueblos.codsigpa, rpueblos.codigine "
    CadenaConsulta = CadenaConsulta & " FROM rpueblos"
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rpueblos.codpobla}|"
