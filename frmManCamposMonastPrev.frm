...
Begin VB.Form frmManCamposMonastPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   9165
   Icon            =   "frmManCamposMonastPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6465
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManCamposMonastPrev.frx":000C
      Height          =   5265
      Left            =   120
      TabIndex        =   7
      Top             =   330
   ...
   End
End
Attribute VB_Name = "frmManCamposMonastPrev"
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select rcampos.codcampo, rcampos.codsocio, rsocios.nomsocio,  rpartida.nomparti "
    CadenaConsulta = CadenaConsulta & " from rcampos, rsocios, rpartida where rcampos.codsocio = rsocios.codsocio and  rcampos.codparti = rpartida.codparti "
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    tots = "S|txtAux(0)|T|Código|1100|;S|txtAux(1)|T|Socio|900|;S|txtAux(2)|T|Nombre|3300|;S|txtAux(3)|T|Calle|3000|;"
