...
Public Sub SubmnC_RecoleccionG_Pozos_Click(Index As Integer)
    Select Case Index
        ...
        Case 12: AbrirListadoPOZ (10) ' Listado de tallas (recibos mantenimiento) sólo para Escalona
        Case 13: AbrirListadoPOZ (11) ' Generacion Recibos de Talla (solo para Escalona)
                 
        Case 14: AbrirListadoPOZ (12) ' Calculo bonificacion recibos talla sólo para Escalona
                 
                
        Case 15: frmPOZRecibos.Show vbModal ' mantenimiento de historico de Recibos
        
        Case 16: AbrirListadoPOZ (6) ' Reimpresion de recibos de pozos
        
        Case 17: ' Impresion de carta de reclamacion para escalona
                Screen.MousePointer = vbHourglass
                frmPOZListadoOfer.OpcionListado = 1
                frmPOZListadoOfer.Show vbModal
                Screen.MousePointer = vbDefault
        
        Case 19: frmPOZIntTesor.Show vbModal ' Integracion contable
        Case 20: ' Integracion aridoc
                frmImpAridoc.Tipo = 6 ' Integracion de aridoc: Facturas de socio de pozos
                frmImpAridoc.Caption = "Exportar Facturas Socio a Aridoc"
                frmImpAridoc.Label4(16).Caption = "Fecha Factura"
                frmImpAridoc.Show vbModal 'vbModalConstruc("Integracion aridoc")
                
        Case 22: AbrirListadoPOZ (7) ' Informe de Facturas generadas por Hidrante
                
        Case 23: AbrirListadoPOZ (8) ' Impresion de Etiquetas de contadores
                 
        Case 25: AbrirListadoPOZ (9) ' Rectificación de Lecturas
        
        Case 26: frmPOZIndefa.Show vbModal  ' prueba de indefa
...
Public Sub SubmnE_Util_Click(Index As Integer)
    Select Case Index
        ...
        Case 17: frmLog.Show vbModal ' ver acciones
...
'
    ...
    MDIppal.mnRec_Pozos(25).Enabled = (vParamAplic.Cooperativa = 7)
    MDIppal.mnRec_Pozos(25).visible = (vParamAplic.Cooperativa = 7)
    ...
    MDIppal.mnRec_Pozos(14).Enabled = (vParamAplic.Cooperativa = 10)
    MDIppal.mnRec_Pozos(14).visible = (vParamAplic.Cooperativa = 10)
    '[Monica]26/11/2012: Cartas de reclamacion solo para escalona
    MDIppal.mnRec_Pozos(17).Enabled = (vParamAplic.Cooperativa = 8 Or vParamAplic.Cooperativa = 10)
    MDIppal.mnRec_Pozos(17).visible = (vParamAplic.Cooperativa = 8 Or vParamAplic.Cooperativa = 10)
...
Public Sub BloqueoMenusSegunNivelUsuario()
    ...
    MDIppal.mnE_Util(17).visible = (vUsu.Login = "root")
    MDIppal.mnE_Util(17).Enabled = (vUsu.Login = "root")
