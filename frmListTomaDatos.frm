...
'Frame para el listado de diferencias de produccion
    ...
    If visible = True Then
        ...
        Me.FrameDesviacionAforos.Width = 6685
...
'Frame para el listado de diferencias de produccion
    ...
    If visible = True Then
        ...
        Me.FrameClasificaSocio.Width = 6585
...
Private Sub CargaCombo()
    ...
    Combo1(1).Clear
    'tipo de recoleccion
    '[Monica]19/11/2018: para el caso de ribercaqui es recolecctado por SAT
