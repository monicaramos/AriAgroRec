...
Begin VB.Form frmBodBonifica 
   ...
   Begin VB.Frame FrameAux1 
      ...
      Begin VB.TextBox txtaux1 
         ...
         MaxLength       =   12
         TabIndex        =   13
         Tag             =   "Hasta Grado|N|N|||rbonifica_lineas|hastagrado|#,##0.00||"
         Text            =   "hasta"
         Top             =   2940
         Visible         =   0   'False
         Width           =   645
      ...
      Begin VB.TextBox txtaux1 
         ...
         MaxLength       =   7
         TabIndex        =   14
         Tag             =   "Porc.Boni|N|N|||rbonifica_lineas|porcentaje|##0.00||"
         Text            =   "pr.soci"
         Top             =   2925
         Visible         =   0   'False
         Width           =   645
      ...
      Begin VB.TextBox txtaux1 
         ...
         MaxLength       =   12
         TabIndex        =   12
         Tag             =   "Desde Grado|N|N|||rbonifica_lineas|desdegrado|#,##0.00||"
         Text            =   "desde"
         Top             =   2925
         Visible         =   0   'False
         Width           =   645
      ...
      Begin VB.TextBox txtaux1 
         ...
         MaxLength       =   6
         TabIndex        =   11
         Tag             =   "Num.Linea|N|N|0|9999|rbonifica_lineas|numlinea|0000|S|"
         Text            =   "linea"
         Top             =   2925
         Visible         =   0   'False
         Width           =   645
      ...
      Begin VB.TextBox txtaux1 
         ...
         MaxLength       =   6
         TabIndex        =   10
         Tag             =   "Código Variedad|N|N|1|999999|rbonifica_lineas|codvarie|000000|S|"
         Text            =   "var"
         Top             =   2925
         Visible         =   0   'False
         Width           =   645
      ...
      Begin MSDataGridLib.DataGrid DataGridAux 
         Bindings        =   "frmBodBonifica.frx":000C
         Height          =   4545
         Index           =   1
         Left            =   90
         TabIndex        =   15
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   6
         TabIndex        =   0
         Tag             =   "Código Variedad|N|N|1|999999|rbonifica|codvarie|000000|S|"
         Top             =   270
         Width           =   1095
      End
   ...
   End
End
Attribute VB_Name = "frmBodBonifica"
...
Private WithEvents frmBod As frmBasico2
Attribute frmBod.VB_VarHelpID = -1
        ...
        Case 3 'INSERTAR
            If DatosOK Then
                If InsertarDesdeForm2(Me, 1) Then
                    ...
                    TerminaBloquear
                    BloqueaRegistro "rbonifica", "codvarie = " & Trim(Text1(0).Text)
...
'    DataGridAux(0).ClearFields
    ...
    Data1.RecordSource = "Select * from " & NombreTabla & " where codvarie is null"
    Data1.Refresh
...
'    CadAncho(4) = False
    ...
    Else
        ...
        Text1(0).BackColor = vbLightBlue 'codvariedad
        ' ****************************************************************************
    End If
End Sub
...
Dim tabla As String
    ...
    Select Case Index
       Case 1 ' bonificaciones lineas
            tabla = "rbonifica_lineas"
            Sql = "SELECT rbonifica_lineas.codvarie, rbonifica_lineas.numlinea, "
            Sql = Sql & " rbonifica_lineas.desdegrado, rbonifica_lineas.hastagrado, "
            Sql = Sql & " rbonifica_lineas.porcentaje"
            Sql = Sql & " FROM " & tabla
            If enlaza Then
                Sql = Sql & ObtenerWhereCab(True)
            Else
                Sql = Sql & " WHERE rbonifica_lineas.codvarie = -1"
            End If
...
Private Sub frmBod_DatoSeleccionado(CadenaSeleccion As String)
    Dim Aux As String
...
'    cad = ""
'    cad = cad & "Código|rbonifica.codvarie|N|000000|9·"
'    cad = cad & "Variedad|variedades.nomvarie|T||90·"
'
'
'    NombreTabla1 = "(rbonifica inner join variedades on rbonifica.codvarie = variedades.codvarie)"
'
'    If cad <> "" Then
'        Screen.MousePointer = vbHourglass
...
'        frmB.vTitulo = "Bonificaciones" ' ***** repasa açò: títol de BuscaGrid *****
'        frmB.vSelElem = 0
'
'        frmB.Show vbModal
'        Set frmB = Nothing
...
'    End If
    ...
    Set frmBod = New frmBasico2

    AyudaBonificaciones frmBod
...
Dim cad As String
    ...
    ' *************** canviar la pregunta ****************
    cad = "¿Seguro que desea eliminar la Bonificación de la Variedad?"
...
EEliminar:
    Screen.MousePointer = vbDefault
    If Err.Number > 0 Then MuestraError Err.Number, "Eliminar Bonificación", Err.Description
End Sub
...
'Dim Datos As String
    ...
    If (Modo = 3) Then 'insertar
        ...
        Sql = DevuelveDesdeBDNew(cAgro, "rbonifica", "codvarie", "codvarie", Text1(0).Text, "N")
        If Sql <> "" Then
            MsgBox "Ya existen las bonificaciones para esta variedad. Revise.", vbExclamation
            B = False
        End If
    ...
    If vParamAplic.Cooperativa = 0 Or vParamAplic.Cooperativa = 9 Then ' caso de Catadau
...
Dim vWhere As String
    ...
    ' ***** elimina les llínies ****
    conn.Execute "DELETE FROM rbonifica_lineas " & vWhere
    ...
    Select Case Index
        Case 1 'calidad
            ...
            If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
                Eliminar = True
                Sql = "DELETE FROM rbonifica_lineas "
...
Dim I As Integer
    ...
    Select Case Index
        Case 1: vtabla = "rbonifica_lineas"
    End Select
    ' ********************************************************
...
'    PrimeraVez = False
    ...
    Select Case Index
        Case 1 'clasificacion segun la calidad
            ...
            tots = "N||||0|;S|txtaux1(2)|T|Linea|800|;"
            tots = tots & "S|txtaux1(3)|T|Desde Grado|2500|;"
            tots = tots & "S|txtaux1(4)|T|Hasta Grado|2500|;"
            tots = tots & "S|txtaux1(1)|T|Porcentaje|1400|;"
            arregla tots, DataGridAux(Index), Me, 350
        
            DataGridAux(Index).Columns(2).Alignment = dbgRight
...
Dim B As Boolean
    ...
    Select Case NumTabMto
        Case 1: nomframe = "FrameAux1" 'lineas
    End Select
    ' ***************************************************************
...
Dim cad As String
    ...
    ' *** posa els noms del frames, tant si son de grid com si no ***
    Select Case NumTabMto
        Case 1: nomframe = "FrameAux1" 'bonficaciones
    End Select
    ' **************************************************************
...
Dim vWhere As String
    ...
    vWhere = vWhere & " rbonifica_lineas.codvarie=" & Val(Text1(0).Text)
    ' *******************************************************
