...
Begin VB.Form frmTrzTipos 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   50
      TabIndex        =   1
      Tag             =   "Nombre|T|N|||trztipos|nomtipo|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   0
      Tag             =   "Código|N|N|0|999|trztipos|codtipo|000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmTrzTipos.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   6
      Top             =   675
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("trztipos", "codtipo")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    SQL = "¿Seguro que desea eliminar el Tipo?"
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from trztipos where codtipo=" & adodc1.Recordset!Codtipo
        conn.Execute SQL
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codtipo=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT trztipos.codtipo, trztipos.nomtipo"
    CadenaConsulta = CadenaConsulta & " FROM trztipos"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    SQL = SQL & " ORDER BY trztipos.codtipo"
    '**************************************************************++
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={trztipos.codtipo}|"
