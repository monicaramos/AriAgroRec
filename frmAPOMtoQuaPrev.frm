...
Begin VB.Form frmAPOMtoQuaPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   10725
   Icon            =   "frmAPOMtoQuaPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6465
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   14
      Tag             =   "Campo|N|N|||raporhco|codcampo|00000000||"
      Top             =   4950
      Width           =   1200
   End
   Begin VB.TextBox txtAux 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmAPOMtoQuaPrev.frx":000C
      Height          =   5265
      Left            =   120
      TabIndex        =   7
      Top             =   330
   ...
   End
End
Attribute VB_Name = "frmAPOMtoQuaPrev"
...
Private Sub BotonBuscar()
    ...
    CargaGrid "raporhco.numaport is null "
    '*******************************************************************************
    'Buscar
    For I = 0 To txtAux.Count - 1
        txtAux(I).Text = ""
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select numaport, fecaport, raporhco.codsocio, rsocios.nomsocio, raporhco.codvarie, variedades.nomvarie, raporhco.codcampo "
    CadenaConsulta = CadenaConsulta & " from raporhco, rsocios, variedades where raporhco.codsocio = rsocios.codsocio and raporhco.codvarie = variedades.codvarie "
