...
Begin VB.Form frmManAsesoria 
      ...
      Begin MSComctlLib.Toolbar Toolbar2 
         ...
         BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty Button1 {66833FEA-8583-11D1-B16A-00C0F0283628} 
               Object.ToolTipText     =   "Importación"
               Object.Tag             =   "2"
            EndProperty
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   2
      Tag             =   "Concepto|T|N|||rrecasesoria|concepto|||"
      Top             =   4980
      Width           =   3165
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   1
      Tag             =   "Fecha|F|N|||rrecasesoria|fechahora|dd/mm/yyyy|S|"
      Top             =   4950
      Width           =   1320
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   0
      Tag             =   "Código|N|N|0|999999|rrecasesoria|codtraba|000000|S|"
      Top             =   4950
      Width           =   800
   End
   ...
   End
End
Attribute VB_Name = "frmManAsesoria"
...
'    SelComboBool DataGrid1.Columns(2).Text, Combo1(0)
    ' *****************************************************
    txtAux(2).Text = DataGrid1.Columns(3).Text 'concepto
    txtAux(3).Text = DataGrid1.Columns(4).Text 'importe
    
    Me.chkAux(0).Value = Me.adodc1.Recordset!idconta
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from rrecasesoria where codtraba=" & adodc1.Recordset!CodTraba
...
'        .Buttons(10).Image = 35  'importacion
'        .Buttons(11).Image = 22  'generacion
'        .Buttons(12).Image = 28  'borrado masivo
'
...
'    End With
    ...
    With Me.Toolbar2
        ...
        .DisabledImageList = frmPpal.imgListComun_BN
        .ImageList = frmPpal.imgListComun
        .Buttons(1).Image = 35  'importacion
        .Buttons(2).Image = 22  'generacion
        .Buttons(3).Image = 28  'borrado masivo
    End With
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT  rrecasesoria.codtraba, straba.nomtraba, rrecasesoria.fechahora, "
    CadenaConsulta = CadenaConsulta & " rrecasesoria.concepto, rrecasesoria.importe,"
    CadenaConsulta = CadenaConsulta & " rrecasesoria.idconta,  IF(idconta=1,'*','') as intcont "
    CadenaConsulta = CadenaConsulta & " FROM  straba, rrecasesoria "
    CadenaConsulta = CadenaConsulta & " WHERE rrecasesoria.codtraba = straba.codtraba "
    '************************************************************************
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    If Ascendente Then
        SQL = SQL & " ORDER BY  rrecasesoria.fechahora "
    Else
        '********************* canviar el ORDER BY *********************++
        SQL = SQL & " ORDER BY  rrecasesoria.fechahora desc, rrecasesoria.codtraba "
        '**************************************************************++
    End If
...
Dim Mens As String
    ...
    If Modo = 3 Then   'Estamos insertando
        SQL = "select count(*) from rrecasesoria where codtraba= " & DBSet(txtAux(0).Text, "N")
...
Private Sub txtaux_KeyPress(Index As Integer, KeyAscii As Integer)
    If KeyAscii = teclaBuscar Then
        If Modo = 1 Or Modo = 3 Or Modo = 4 Then
            Select Case Index
                Case 0: KEYBusqueda KeyAscii, 1 'trabajador
                Case 1: KEYBusqueda KeyAscii, 0 'fechahora
            End Select
        End If
    Else
        KEYpress KeyAscii
...
Private Sub BotonImportacion()
    Shell App.Path & "\nomina.exe /I|" & vUsu.CadenaConexion & "|" & vUsu.Codigo & "|", vbNormalFocus
End Sub

Private Sub BotonBorradoMasivo()
    AbrirListadoNominas (35)
    CargaGrid
End Sub
...
Dim SQL As String
    ...
    SQL = "update rrecasesoria set "
    SQL = SQL & " importe = " & DBSet(ImporteSinFormato(txtAux(3).Text), "N")
    SQL = SQL & ", concepto = " & DBSet(ImporteSinFormato(txtAux(2).Text), "T")
