      ...
      Begin MSComctlLib.Toolbar Toolbar2 
         ...
         BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty Button13 {66833FEA-8583-11D1-B16A-00C0F0283628} 
               Object.ToolTipText     =   "Bajas de Campos"
               Object.Tag             =   "6"
            EndProperty
         EndProperty
      End
...
Dim Sql As String
    ...
    Select Case Operacion
        Case "I" ' insertar
            Sql = DevuelveDesdeBDNew(5, "usuariospush", "comunid", "codmunid", Text1(0).Text, "N")
            If Sql = "" Then
                Sql = "insert into usuariospush (nif,nombre,comunId,ariagroId,tiendaId,gasolineraId,telefoniaId,tratamientosId,login,"
                ...
                Sql = Sql & DBSet(Text1(8), "N") & "," 'telefono1
                Sql = Sql & DBSet(Text1(9), "N") & "," 'telefono2
                Sql = Sql & DBSet(Text1(27).Text & Text1(16).Text & Text1(17).Text & Text1(18).Text & Text1(19).Text, "T")
                Sql = Sql & ")"
            Else
                Sql = "update usuariopush set "
                ...
                Sql = Sql & ",telefono1 = " & DBSet(Text1(8), "N") & "," 'telefono1
                Sql = Sql & ",telefono2 = " & DBSet(Text1(9), "N") & "," 'telefono2
...
Private Sub ImprimirDocBaja(NroDoc As Long)
Dim vAux As String
...
'    imgBuscar(3).visible = b
    ...
    Me.imgDoc(0).Enabled = (Modo = 2 And (vParamAplic.Cooperativa = 0 Or vParamAplic.Cooperativa = 16))
    Me.imgDoc(0).visible = (Modo = 2 And (vParamAplic.Cooperativa = 0 Or vParamAplic.Cooperativa = 16))
...
Dim cadena As String
    ...
    Case 6
        ...
        ImprimirDocBaja lw1.SelectedItem.Text
...
'                txtAux2(0).Text = PonerNombreDeCod(txtaux1(6), "tiposiva", "nombriva", "codigiva", "N", cConta)
        ...
        Case 4 'movimientos
            'si es visible|control|tipo campo|nombre campo|ancho control
            tots = "N||||0|;N||||0|;S|txtAux5(2)|T|Campo|1250|;" 'codsocio,numfase
            tots = tots & "S|txtAux5(3)|T|Superficie|1450|;"
            tots = tots & "S|txtAux5(4)|T|Fecha|1400|;"
            tots = tots & "S|txtAux5(5)|T|Importe|1500|;"
            tots = tots & "S|txtAux5(6)|T|Causa|5000|;"
