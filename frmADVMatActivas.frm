...
Begin VB.Form frmADVMatActivas 
   ...
   ClientTop       =   30
   ClientWidth     =   9345
   Icon            =   "frmADVMatActivas.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6180
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   3
      Tag             =   "Plazo Reentrada|N|N|||advmatactiva|plazoent|#,##0||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   2
      Tag             =   "PlazoSeg|N|N|||advmatactiva|plazoseg|#,##0||"
      Top             =   4920
      Width           =   1395
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||advmatactiva|nommatact|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   0
      Tag             =   "Código|N|N|||advmatactiva|codmatact|000000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmADVMatActivas.frx":000C
      Height          =   4545
      Left            =   120
      TabIndex        =   8
      Top             =   855
   ...
   End
End
Attribute VB_Name = "frmADVMatActivas"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("advmatactiva", "codmatact")
    End If
    '********************************************************************
...
Private Sub BotonBuscar()
    ...
    CargaGrid "advmatactiva.codmatact = -1"
    '*******************************************************************************
    'Buscar
    For I = 0 To txtAux.Count - 1
        txtAux(I).Text = ""
...
Dim temp As Boolean
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from advmatactiva where codmatact=" & DBLet(adodc1.Recordset!codmatact, "N")
        conn.Execute SQL
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codmatact=" & DBSet(CodigoActual, "N"), "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT advmatactiva.codmatact, advmatactiva.nommatact, advmatactiva.plazoseg, advmatactiva.plazoent"
    CadenaConsulta = CadenaConsulta & " FROM advmatactiva"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    SQL = SQL & " ORDER BY advmatactiva.codmatact"
    '**************************************************************++
    ...
    tots = "S|txtAux(0)|T|Código|1000|;S|txtAux(1)|T|Descripción|3500|;S|txtAux(2)|T|Plazo Seguridad|1975|;S|txtAux(3)|T|Plazo Reentrada|1995|;"
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "advmatactiva"
        .Informe2 = "rADVMatActiva.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={advmatactiva.codmatact}|"
