...
Begin VB.Form frmFVARContadores 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Contadores de Facturas Varias"
   ClientHeight    =   6255
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   7605
   Icon            =   "frmFVARContadores.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6255
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFVARContadores.frx":000C
      Height          =   4545
      Left            =   120
      TabIndex        =   8
      Top             =   855
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   2
      TabIndex        =   10
      Tag             =   "TipoDocu|N|N|||stipom|tipodocu||N|"
      Text            =   "T"
      Top             =   4620
      Width           =   255
   End
   ...
   End
End
Attribute VB_Name = "frmFVARContadores"
...
'        NumF = NuevoCodigo
'    Else
'        NumF = SugerirCodigoSiguienteStr("rdesarrollo", "coddesa")
'    End If
    '********************************************************************
    ...
    'El tipo de documento es de facturas varias
    txtAux(4).Text = 12
...
'    SelComboBool DataGrid1.Columns(2).Text, Combo1(0)
    ...
    'Tipo de Documento 12=Facturas varias
    txtAux(4).Text = 12
...
Dim temp As Boolean
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from stipom where codtipom='" & adodc1.Recordset!CodTipom & "'"
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codigo=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "Select codtipom, nomtipom, contador, letraser "
    CadenaConsulta = CadenaConsulta & " FROM stipom "
    CadenaConsulta = CadenaConsulta & " WHERE tipodocu = 12 "
    '************************************************************************
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY stipom.codtipom"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Código|800|;S|txtAux(1)|T|Denominación|3500|;S|txtAux(2)|T|Contador|1125|;S|txtAux(3)|T|Letra Serie|1325|;"
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "rglobalgap"
        .Informe2 = "rManGlobalGap.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rglobalgap.codigo}|"
...
Dim B As Boolean
    ...
    If adodc1.Recordset.Fields(0).Value = "FVG" Or adodc1.Recordset.Fields(0).Value = "FVP" Then
        MsgBox "No se permite eliminar este tipo de movimiento.", vbExclamation
        Exit Function
    End If
    ...
    While Not Rs.EOF And B
        Sql1 = "select count(*) from " & Trim(Rs.Fields(0).Value) & ".fvarcabfact where codtipom= "
        Sql1 = Sql1 & DBSet(Me.adodc1.Recordset!CodTipom, "T")
    ...
    If Not B Then
        ...
        MsgBox cad & "Esta vinculada con Facturas Varias", vbExclamation
        Exit Function
    End If
    SepuedeBorrar = True
End Function
