...
Begin VB.Form frmLotApport 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   50
      TabIndex        =   11
      Tag             =   "Referencia|T|S|||lotapport|Reference|||"
      Top             =   4905
      Width           =   2340
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Fecha|FH|N|||lotapport|Creation_lot|dd/mm/yyyy hh:mm:ss||"
      Top             =   4920
      Width           =   2340
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   8
      TabIndex        =   0
      Tag             =   "Lote|N|N|0|99999999|lotapport|Numero_lot|00000000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmLotApport.frx":000C
      Height          =   4545
      Left            =   150
      TabIndex        =   6
      Top             =   840
   ...
   End
End
Attribute VB_Name = "frmLotApport"
...
Private Sub BotonBuscar()
    ...
    CargaGrid "lotapport.numero_lot = -1"
    '*******************************************************************************
    'Buscar
    For i = 0 To txtAux.Count - 1
        txtAux(i).Text = ""
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from lotapportresultat where numero_lot=" & adodc1.Recordset!numero_lot
        conn.Execute Sql
        
        Sql = "Delete from lotapport where numero_lot=" & adodc1.Recordset!numero_lot
        conn.Execute Sql
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT lotapport.numero_lot, lotapport.Creation_lot, lotapport.Reference "
    CadenaConsulta = CadenaConsulta & " FROM lotapport "
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY lotapport.Numero_lot"
    '**************************************************************++
