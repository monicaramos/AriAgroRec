...
'Dim mTag As CTag
    ...
    With Text
        ...
        If Modo = 1 Then
            ...
            'las comprobaciones
            Comprobar = ContieneCaracterBusqueda(.Text) Or InStr(1, UCase(.Text), "NULL")
            If Comprobar Then
                PerderFocoGnral = False
                Exit Function
            End If
...
Public Sub PosicionarCombo2(ByRef Combo1 As ComboBox, Valor As String, Optional Posiciones As Byte)
'Situa el combo en la posicion de un valor concreto
Dim J As Integer
    ...
    For J = 0 To Combo1.ListCount - 1
        If Posiciones = 0 Then
            ...
            End If
        Else
            If Mid(Combo1.List(J), 1, Posiciones) = Trim(Valor) Then
                Combo1.ListIndex = J
                Exit For
            End If
