...
'VRS:2.0.1(1) añadido el tipo de error
Case 1451
    pos1 = InStr(conn.Errors(0).Description, "(")
    cadena = "Falla porque el registro es clave referencial." & vbCrLf & vbCrLf & Mid(conn.Errors(0).Description, pos1 + 1, Len(Mid(conn.Errors(0).Description, pos1)) - 2)
Case 2003
