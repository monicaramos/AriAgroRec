...
Public Sub SubmnC_RecoleccionG_PagoSocios_Click(Index As Integer)
    Select Case Index
        ...
        Case 18: frmFactRectifSocio.Show vbModal   ' Generacion de Facturas Rectificativas
        
    
        Case 20: frmContrRecFact.Show vbModal  'Facturacion Contratos
...
Public Sub SubmnC_RecoleccionG_Traza1_Click(Index As Integer)
    Select Case Index
        Case 1: 'AbrirListadoTrazabilidad (8) ' Asignacion automática a palets
                frmTrzAsigAutomatica.Show vbModal
    End Select
End Sub
...
Public Sub SubmnC_RecoleccionG_Pozos_Click(Index As Integer)
    Select Case Index
        ...
        Case 37: AbrirListadoPOZ (2)  ' Listado de comprobacion
                
        Case 39: ' Exportacion de lecturas
...
'    MDIppal.mnRecG_Admon(25).visible = ((vParamAplic.Cooperativa = 0) Or (vParamAplic.Cooperativa = 2) Or (vParamAplic.Cooperativa = 4) Or (vParamAplic.Cooperativa = 5) Or (vParamAplic.Cooperativa = 9) Or (vParamAplic.Cooperativa = 16) Or (vParamAplic.Cooperativa = 18 Or vParamAplic.Cooperativa = 19))
    ...
    MDIppal.mnRec_Pozos(36).visible = (vParamAplic.Cooperativa = 17)
    MDIppal.mnRec_Pozos(37).Enabled = (vParamAplic.Cooperativa = 17)
    MDIppal.mnRec_Pozos(37).visible = (vParamAplic.Cooperativa = 17)
    MDIppal.mnRec_Pozos(38).visible = (vParamAplic.Cooperativa = 17)
    MDIppal.mnRec_Pozos(39).Enabled = (vParamAplic.Cooperativa = 17)
    MDIppal.mnRec_Pozos(39).visible = (vParamAplic.Cooperativa = 17)
    ...
    '[Monica]12/12/2013: el informe de fitosanitarios solo para catadau
        '[Monica]04/12/2018: ABN va a tener un informe de fitosanitarios que es el documento de campo
    MDIppal.mnRec_InforOfi(3).Enabled = (vParamAplic.Cooperativa = 0) Or (vParamAplic.Cooperativa = 4) Or (vParamAplic.Cooperativa = 18 Or vParamAplic.Cooperativa = 19) Or (vParamAplic.Cooperativa = 1)
    MDIppal.mnRec_InforOfi(3).visible = (vParamAplic.Cooperativa = 0) Or (vParamAplic.Cooperativa = 4) Or (vParamAplic.Cooperativa = 18 Or vParamAplic.Cooperativa = 19) Or (vParamAplic.Cooperativa = 1)
