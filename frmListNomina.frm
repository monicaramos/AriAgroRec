...
Begin VB.Form frmListNomina 
   ...
   Begin VB.Frame FrameBorradoMasivoETT 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   8
         Left            =   1605
         MouseIcon       =   "frmListNomina.frx":13ED
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   1335
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   8
         Left            =   1590
         Picture         =   "frmListNomina.frx":153F
         Top             =   2790
         Width           =   240
      End
      Begin VB.Image imgFecha 
   ...
   Begin VB.Frame FrameBorradoAsesoria 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   20
         Left            =   1605
         Picture         =   "frmListNomina.frx":1D02
         Top             =   2880
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   19
         Left            =   1605
         Picture         =   "frmListNomina.frx":1D8D
         Top             =   2475
         Width           =   240
      End
      Begin VB.Image imgBuscar 
         ...
         Index           =   23
         Left            =   1620
         MouseIcon       =   "frmListNomina.frx":1E18
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1725
         Width           =   240
