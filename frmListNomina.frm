...
Begin VB.Form frmListNomina 
   ...
   Begin VB.Frame FrameEntradasCapataz 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   18
         Left            =   1545
         Picture         =   "frmListNomina.frx":0CC8
         Top             =   2670
         Width           =   240
      End
      Begin VB.Image imgFecha 
   ...
   Begin VB.Frame FrameHorasDestajo 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   4
         Left            =   1575
         Picture         =   "frmListNomina.frx":13B1
         Top             =   3345
         Width           =   240
      End
      Begin VB.Image imgBuscar 
   ...
   Begin VB.Frame FrameBorradoMasivoETT 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   6
         Left            =   1575
         Picture         =   "frmListNomina.frx":1A0F
         Top             =   2370
         Width           =   240
      End
   End
   ...
   Begin VB.Frame FrameCalculoETT 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   6
         Left            =   1515
         MouseIcon       =   "frmListNomina.frx":1F6A
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   2085
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   7
         Left            =   1515
         Picture         =   "frmListNomina.frx":20BC
         Top             =   1605
         Width           =   240
      End
      Begin VB.Image imgBuscar 
   ...
   Begin VB.Frame FrameBorradoAsesoria 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   20
         Left            =   1605
         Picture         =   "frmListNomina.frx":2830
         Top             =   2730
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   19
         Left            =   1605
         Picture         =   "frmListNomina.frx":28BB
         Top             =   2385
         Width           =   240
      End
      Begin VB.Image imgBuscar 
