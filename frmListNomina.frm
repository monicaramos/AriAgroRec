...
Begin VB.Form frmListNomina 
   ...
   Begin VB.Frame FrameHorasDestajo 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":0FF7
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1665
         Width           =   240
   ...
   Begin VB.Frame FrameBorradoMasivoETT 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   8
         Left            =   1605
         MouseIcon       =   "frmListNomina.frx":129B
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   1335
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   8
         Left            =   1590
         Picture         =   "frmListNomina.frx":13ED
         Top             =   2790
         Width           =   240
      End
      Begin VB.Image imgFecha 
   ...
   Begin VB.Frame FrameHorasTrabajadas 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   3
         Left            =   1575
         Picture         =   "frmListNomina.frx":1AD6
         Top             =   2745
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   2
         Left            =   1575
         Picture         =   "frmListNomina.frx":1B61
         Top             =   2340
         Width           =   240
      End
   End
   ...
   Begin VB.Frame FrameInfComprobacion 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   21
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":1FA6
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1620
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   19
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":20F8
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1260
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   16
         Left            =   1560
         Picture         =   "frmListNomina.frx":224A
         Top             =   2520
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   15
         Left            =   1560
         Picture         =   "frmListNomina.frx":22D5
         Top             =   2115
         Width           =   240
      End
   End
   ...
   Begin VB.Frame FrameImpresionParte 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   31
         Left            =   1560
         MouseIcon       =   "frmListNomina.frx":34EC
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   3450
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   23
         Left            =   1575
         Picture         =   "frmListNomina.frx":36C9
         Top             =   2295
         Width           =   240
      End
   End
   Begin VB.Frame FrameCalculoETT 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   6
         Left            =   1515
         MouseIcon       =   "frmListNomina.frx":3754
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   2085
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   7
         Left            =   1515
         Picture         =   "frmListNomina.frx":38A6
         Top             =   1605
         Width           =   240
      End
      Begin VB.Image imgBuscar 
   ...
   Begin VB.Frame FrameTrabajadoresActivos 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   28
         Left            =   1575
         Picture         =   "frmListNomina.frx":3A83
         Top             =   1215
         Width           =   240
      End
   End
...
'    CommitConexion
    ...
    Case 28 ' Informe de Comprobacion
        ...
        Check7.visible = (vParamAplic.Cooperativa = 16 Or vParamAplic.Cooperativa = 0)
        Check7.Enabled = (vParamAplic.Cooperativa = 16 Or vParamAplic.Cooperativa = 0)
