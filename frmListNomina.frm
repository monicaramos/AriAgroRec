...
Begin VB.Form frmListNomina 
   ...
   Begin VB.Frame FramePaseABanco 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   22
         Left            =   1515
         Picture         =   "frmListNomina.frx":05DF
   ...
   Begin VB.Frame FrameBorradoMasivoETT 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   9
         Left            =   1605
         MouseIcon       =   "frmListNomina.frx":0AEB
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   8
         Left            =   1590
         Picture         =   "frmListNomina.frx":0D8F
         Top             =   2790
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   6
         Left            =   1605
         Picture         =   "frmListNomina.frx":0E1A
         Top             =   2400
         Width           =   240
      End
   End
   Begin VB.Frame FrameTrabajadoresCapataz 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   10
         Left            =   1545
         MouseIcon       =   "frmListNomina.frx":1082
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   2115
         Width           =   240
   ...
   Begin VB.Frame FrameHorasTrabajadas 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   15
         Left            =   1620
         MouseIcon       =   "frmListNomina.frx":11D4
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1665
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   14
         Left            =   1620
         MouseIcon       =   "frmListNomina.frx":1326
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1305
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   3
         Left            =   1575
         Picture         =   "frmListNomina.frx":1478
         Top             =   2745
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   2
         Left            =   1575
         Picture         =   "frmListNomina.frx":1503
         Top             =   2340
         Width           =   240
      End
   End
   Begin VB.Frame FramePagoPartesCampo 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   1
         Left            =   1395
         Picture         =   "frmListNomina.frx":158E
         Top             =   2745
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   0
         Left            =   1395
         Picture         =   "frmListNomina.frx":1619
         Top             =   2340
         Width           =   240
      End
      Begin VB.Label Label2 
   ...
   Begin VB.Frame FrameInfComprobacion 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   19
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":1A9A
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1260
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   16
         Left            =   1560
         Picture         =   "frmListNomina.frx":1BEC
         Top             =   2520
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   15
         Left            =   1560
         Picture         =   "frmListNomina.frx":1C77
         Top             =   2115
         Width           =   240
      End
   End
   ...
   Begin VB.Frame FrameCalculoHorasProductivas 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   13
         Left            =   1350
         Picture         =   "frmListNomina.frx":2360
         Top             =   1290
         Width           =   240
      End
      Begin VB.Label Label2 
   ...
   Begin VB.Frame FrameBorradoAsesoria 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   23
         Left            =   1620
         MouseIcon       =   "frmListNomina.frx":2501
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1725
         Width           =   240
   ...
   Begin VB.Frame FrameCapatazServicios 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   36
         Left            =   1545
         MouseIcon       =   "frmListNomina.frx":27A5
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   1695
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   26
         Left            =   1545
         Picture         =   "frmListNomina.frx":28F7
         Top             =   1245
         Width           =   240
      End
   End
   Begin VB.Frame FrameAltaRapida 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.Image imgFecha 
            ...
            Index           =   10
            Left            =   1200
            Picture         =   "frmListNomina.frx":2982
            Top             =   900
            Width           =   240
         End
         Begin VB.Image imgFecha 
            ...
            Index           =   9
            Left            =   1215
            Picture         =   "frmListNomina.frx":2A0D
            Top             =   480
            Width           =   240
         End
         Begin VB.Image imgBuscar 
            ...
            Index           =   4
            Left            =   1215
            MouseIcon       =   "frmListNomina.frx":2A98
            MousePointer    =   4  'Icon
            ToolTipText     =   "Buscar trabajador"
            Top             =   1470
            Width           =   240
   ...
   Begin VB.Frame FrameImpresionParte 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   32
         Left            =   1545
         MouseIcon       =   "frmListNomina.frx":2D3C
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   3855
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   31
         Left            =   1560
         MouseIcon       =   "frmListNomina.frx":2E8E
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   3450
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   24
         Left            =   1560
         Picture         =   "frmListNomina.frx":2FE0
         Top             =   2670
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   23
         Left            =   1575
         Picture         =   "frmListNomina.frx":306B
         Top             =   2295
         Width           =   240
      End
   End
   ...
   Begin VB.Frame FrameTrabajadoresActivos 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   28
         Left            =   1575
         Picture         =   "frmListNomina.frx":3425
         Top             =   1215
         Width           =   240
      End
   End
   Begin VB.Frame FrameEntradasCapataz 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   18
         Left            =   1320
         Picture         =   "frmListNomina.frx":34B0
         Top             =   2715
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   17
         Left            =   1335
         Picture         =   "frmListNomina.frx":353B
         Top             =   2340
         Width           =   240
      End
      Begin VB.Image imgBuscar 
         ...
         Index           =   18
         Left            =   1335
         MouseIcon       =   "frmListNomina.frx":35C6
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   1680
         Width           =   240
   ...
   Begin VB.Frame FrameHorasDestajo 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   5
         Left            =   1575
         Picture         =   "frmListNomina.frx":3B0E
         Top             =   3780
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   4
         Left            =   1575
         Picture         =   "frmListNomina.frx":3B99
         Top             =   3390
         Width           =   240
      End
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":3C24
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1305
         Width           =   240
...
Private frmLis As frmListNominaAux
                ...
                If vParamAplic.Cooperativa = 16 Or vParamAplic.Cooperativa = 0 Or vParamAplic.Cooperativa = 18 Or vParamAplic.Cooperativa = 19 Then
                    ...
                    If GeneraNominaA3(Fec1) Then
                        ...
                        If vParamAplic.Cooperativa = 0 Then
                            ...
                            Me.Refresh
                        Else
                            '[Monica]29/04/2019: hacemos un fichero xml para frutas inma
                            If vParamAplic.Cooperativa = 18 Or vParamAplic.Cooperativa = 19 Then
                                
                                Set frmLis = New frmListNominaAux
                                frmLis.Opcionlistado = 36
                                frmLis.Show vbModal
                                Set frmLis = Nothing
...
On Error GoTo eProcesoPaseABanco
    ...
    '[Monica]03/06/2019: caso unicamente de frutas inma
...
On Error GoTo eCargarTemporalListNominaCoopic
    ...
    '[Monica]07/06/2018: añadimos los kilometros ( importe en euros )
...
Dim BrutoAnt As Currency
    ...
    SQL = "select sum(importe) from horasanticipos where idcontador in (" & SQL & ") and codtraba = " & DBSet(vTrabajador, "N")
        
    Set Rs = New ADODB.Recordset
    Rs.Open SQL, conn, adOpenForwardOnly, adLockPessimistic, adCmdText
    If Not Rs.EOF Then
        If Rs.Fields(0).Value > 0 Then BrutoAnt = BrutoAnt + DBLet(Rs.Fields(0).Value, "N")  'Solo es para saber que hay registros que mostrar
    End If
    Rs.Close
    Set Rs = Nothing
...
'        '[Monica]04/10/2018: lo que quiero añadir como anticipado
...
eBrutoAnticipado:
    MuestraError Err.Number, "Error en el cálculo de Bruto Anticipado", Err.Description
End Function
...
Dim SQL As String
    ...
    SQL = SQL & " and month(fecharec) = " & Combo1(1).ItemData(Combo1(1).ListIndex) & " and year(fecharec) = " & DBSet(txtCodigo(61).Text, "N")
