...
Begin VB.Form frmListNomina 
   ...
   Begin VB.Frame FrameInfComprobacion 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   21
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":07F8
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1665
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   19
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":094A
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1305
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   16
         Left            =   1560
         Picture         =   "frmListNomina.frx":0A9C
         Top             =   2520
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   15
         Left            =   1560
         Picture         =   "frmListNomina.frx":0B27
         Top             =   2160
         Width           =   240
      End
   End
   Begin VB.Frame FrameImpresionParte 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   32
         Left            =   1545
         MouseIcon       =   "frmListNomina.frx":0BB2
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   3810
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   31
         Left            =   1560
         MouseIcon       =   "frmListNomina.frx":0D04
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   3450
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   24
         Left            =   1560
         Picture         =   "frmListNomina.frx":0E56
         Top             =   2670
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   23
         Left            =   1575
         Picture         =   "frmListNomina.frx":0EE1
         Top             =   2340
         Width           =   240
      End
   End
   ...
   Begin VB.Frame FrameHorasDestajo 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   2
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":1478
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   2325
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   5
         Left            =   1575
         Picture         =   "frmListNomina.frx":15CA
         Top             =   3690
         Width           =   240
      End
      Begin VB.Image imgFecha 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":16E0
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1305
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":1832
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1665
         Width           =   240
   ...
   Begin VB.Frame FrameBorradoMasivoETT 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   9
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":1984
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   1665
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   8
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":1AD6
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   1305
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   8
         Left            =   1560
         Picture         =   "frmListNomina.frx":1C28
         Top             =   2700
         Width           =   240
      End
      Begin VB.Image imgFecha 
   ...
   Begin VB.Frame FrameHorasTrabajadas 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   15
         Left            =   1620
         MouseIcon       =   "frmListNomina.frx":1D3E
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1665
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   14
         Left            =   1620
         MouseIcon       =   "frmListNomina.frx":1E90
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1305
         Width           =   240
   ...
   Begin VB.Frame FrameCalculoETT 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   5
         Left            =   1545
         MouseIcon       =   "frmListNomina.frx":23EB
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   1125
         Width           =   240
   ...
   Begin VB.Frame FrameCalculoHorasProductivas 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   20
         Left            =   1290
         MouseIcon       =   "frmListNomina.frx":253D
         MousePointer    =   4  'Icon
   ...
   Begin VB.Frame FrameAltaRapida 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.Image imgFecha 
            ...
            Index           =   10
            Left            =   1200
            Picture         =   "frmListNomina.frx":271A
            Top             =   900
            Width           =   240
         End
         Begin VB.Image imgFecha 
   ...
   Begin VB.Frame FrameEventuales 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   12
            Left            =   1215
            MouseIcon       =   "frmListNomina.frx":2FE0
            MousePointer    =   4  'Icon
            ToolTipText     =   "Buscar trabajador"
            Top             =   1620
            Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   11
         Left            =   1545
         MouseIcon       =   "frmListNomina.frx":3248
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   1140
         Width           =   240
   ...
   Begin VB.Frame FrameTrabajadoresCapataz 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   16
         Left            =   1545
         MouseIcon       =   "frmListNomina.frx":339A
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   1125
         Width           =   240
   ...
   Begin VB.Frame FramePaseABanco 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   25
         Left            =   1530
         MouseIcon       =   "frmListNomina.frx":381B
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1215
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   22
         Left            =   1515
         Picture         =   "frmListNomina.frx":396D
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   21
         Left            =   1530
         Picture         =   "frmListNomina.frx":39F8
         ToolTipText     =   "Buscar fecha"
         Top             =   2220
         Width           =   240
      End
...
'        If Me.Check2.Value = 1 Then cadNombreRPT = Replace(cadNombreRPT, ".rpt", "1.rpt") '"rInfAsesoriaNomiMes1.rpt"
        ...
        If CargarTemporalListNominaCoopic(cadSelect, Fdesde, Fhasta) Then
            tabla = "{tmpinformes}"
...
'    If txtCodigo(Index).Text = "" Then Exit Sub
    ...
    Select Case Index
        ...
        Case 35, 26, 33, 37, 46, 44, 48, 52, 53, 56, 57, 59, 60, 70, 71 'FECHAS
            If txtCodigo(Index).Text <> "" Then
                PonerFormatoFecha txtCodigo(Index)
            End If
        ...
        Case 31, 32, 34, 45, 38, 43, 72, 73, 76, 77 'CAPATAZ
            PonerFormatoEntero txtCodigo(Index)
            txtNombre(Index).Text = PonerNombreDeCod(txtCodigo(Index), "rcapataz", "nomcapat", "codcapat", "N")
...
Dim Rs As ADODB.Recordset
    ...
    While Not Rs.EOF
        ...
        Sql2 = Sql2 & " and codvarie = " & DBSet(Rs.Fields(3).Value, "N")
        Sql2 = Sql2 & " and codcapat = " & DBSet(Rs.Fields(4).Value, "N")
        Sql2 = Sql2 & " and codforfait = " & DBSet(Rs.Fields(5).Value, "N")
        ...
        If TotalRegistros(Sql2) = 0 Then
            ...
            Sql3 = Sql3 & DBSet(Rs.Fields(0).Value, "N") & "," & DBSet(Rs.Fields(3).Value, "N") & ","
            Sql3 = Sql3 & DBSet(Rs.Fields(4).Value, "N") & ","
            Sql3 = Sql3 & DBSet(Rs.Fields(7).Value, "N") & "," & DBSet(Rs.Fields(5).Value, "N") & "),"
        End If
