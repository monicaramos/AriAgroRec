...
Begin VB.Form frmListNomina 
   ...
   Begin VB.Frame FrameEventuales 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Image imgFecha 
            ...
            Index           =   12
            Left            =   1215
            Picture         =   "frmListNomina.frx":07BC
            Top             =   540
            Width           =   240
         End
         Begin VB.Image imgFecha 
   ...
   Begin VB.Frame FrameHorasDestajo 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":2B9B
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1665
         Width           =   240
   ...
   Begin VB.Frame FrameBorradoMasivoETT 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   9
         Left            =   1605
         MouseIcon       =   "frmListNomina.frx":2CED
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   1725
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   8
         Left            =   1605
         MouseIcon       =   "frmListNomina.frx":2E3F
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   1335
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   8
         Left            =   1590
         Picture         =   "frmListNomina.frx":2F91
         Top             =   2790
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   6
         Left            =   1605
         Picture         =   "frmListNomina.frx":301C
         Top             =   2400
         Width           =   240
      End
   End
   Begin VB.Frame FrameHorasTrabajadas 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   15
         Left            =   1620
         MouseIcon       =   "frmListNomina.frx":30A7
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1665
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   14
         Left            =   1620
         MouseIcon       =   "frmListNomina.frx":31F9
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1305
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   2
         Left            =   1575
         Picture         =   "frmListNomina.frx":33D6
         Top             =   2340
         Width           =   240
      End
   End
