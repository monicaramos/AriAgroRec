...
Begin VB.Form frmListNomina 
   ...
   Begin VB.Frame FrameHorasDestajo 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   3
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":0F6C
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   2685
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   2
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":10BE
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   2325
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   5
         Left            =   1575
         Picture         =   "frmListNomina.frx":1210
         Top             =   3690
         Width           =   240
      End
      Begin VB.Image imgFecha 
   ...
   Begin VB.Frame FrameBorradoMasivoETT 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   9
         Left            =   1605
         MouseIcon       =   "frmListNomina.frx":15CA
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   1725
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   8
         Left            =   1605
         MouseIcon       =   "frmListNomina.frx":171C
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   1335
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   8
         Left            =   1590
         Picture         =   "frmListNomina.frx":186E
         Top             =   2790
         Width           =   240
      End
      Begin VB.Image imgFecha 
   ...
   Begin VB.Frame FrameTrabajadoresCapataz 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   16
         Left            =   1545
         MouseIcon       =   "frmListNomina.frx":25C8
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   1155
         Width           =   240
   ...
   Begin VB.Frame FrameEventuales 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Image imgBuscar 
            ...
            Index           =   12
            Left            =   1215
            MouseIcon       =   "frmListNomina.frx":2A49
            MousePointer    =   4  'Icon
            ToolTipText     =   "Buscar trabajador"
            Top             =   1680
            Width           =   240
         ...
         Begin VB.Image imgFecha 
            ...
            Index           =   12
            Left            =   1215
            Picture         =   "frmListNomina.frx":2B9B
            Top             =   540
            Width           =   240
         End
         Begin VB.Image imgFecha 
   ...
   Begin VB.Frame FrameImpresionParte 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   31
         Left            =   1560
         MouseIcon       =   "frmListNomina.frx":3C60
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   3450
         Width           =   240
