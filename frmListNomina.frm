...
Begin VB.Form frmListNomina 
   ...
   Begin VB.Frame FrameTrabajadoresCapataz 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   14
         Left            =   1545
         Picture         =   "frmListNomina.frx":015E
         Top             =   1635
         Width           =   240
      End
      Begin VB.Image imgBuscar 
   ...
   Begin VB.Frame FrameListMensAsesoria 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Image imgFecha 
            ...
            Index           =   25
            Left            =   1305
            Picture         =   "frmListNomina.frx":0847
            Top             =   2250
            Width           =   240
         End
         Begin VB.Label Label2 
   ...
   Begin VB.Frame FrameImpresionParte 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   23
         Left            =   1575
         Picture         =   "frmListNomina.frx":0EA5
         Top             =   2340
         Width           =   240
      End
   End
   ...
   Begin VB.Frame FrameEntradasCapataz 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   18
         Left            =   1545
         Picture         =   "frmListNomina.frx":1832
         Top             =   2670
         Width           =   240
      End
      Begin VB.Image imgFecha 
   ...
   Begin VB.Frame FrameHorasDestajo 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   3
         Left            =   1575
         MouseIcon       =   "frmListNomina.frx":1BEC
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   2685
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   5
         Left            =   1575
         Picture         =   "frmListNomina.frx":1E90
         Top             =   3690
         Width           =   240
      End
      Begin VB.Image imgFecha 
   ...
   Begin VB.Frame FrameBorradoMasivoETT 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   9
         Left            =   1605
         MouseIcon       =   "frmListNomina.frx":224A
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   1725
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   8
         Left            =   1605
         MouseIcon       =   "frmListNomina.frx":239C
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   1335
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   8
         Left            =   1590
         Picture         =   "frmListNomina.frx":24EE
         Top             =   2790
         Width           =   240
      End
      Begin VB.Image imgFecha 
   ...
   Begin VB.Frame FrameHorasTrabajadas 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   15
         Left            =   1620
         MouseIcon       =   "frmListNomina.frx":2604
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1665
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   14
         Left            =   1620
         MouseIcon       =   "frmListNomina.frx":2756
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar trabajador"
         Top             =   1305
         Width           =   240
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   3
         Left            =   1575
         Picture         =   "frmListNomina.frx":28A8
         Top             =   2745
         Width           =   240
      End
      Begin VB.Image imgFecha 
   ...
   Begin VB.Frame FrameCalculoETT 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   7
         Left            =   1515
         Picture         =   "frmListNomina.frx":2C26
         Top             =   1605
         Width           =   240
      End
      Begin VB.Image imgBuscar 
   ...
   Begin VB.Frame FrameBorradoAsesoria 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   20
         Left            =   1605
         Picture         =   "frmListNomina.frx":339A
         Top             =   2880
         Width           =   240
      End
      Begin VB.Image imgFecha 
...
'    If txtCodigo(Index).Text = "" Then Exit Sub
    ...
    Select Case Index
        ...
        Case 35, 26, 33, 37, 46, 44, 48, 52, 53, 56, 57, 59, 60, 70, 71, 78 'FECHAS
            If txtCodigo(Index).Text <> "" Then
                PonerFormatoFecha txtCodigo(Index)
            End If
