...
Begin VB.Form frmListNomina 
   ...
   Begin VB.Frame FrameBorradoAsesoria 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   20
         Left            =   1605
         Picture         =   "frmListNomina.frx":01E9
         Top             =   2880
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   19
         Left            =   1605
         Picture         =   "frmListNomina.frx":0274
         Top             =   2475
         Width           =   240
      End
      Begin VB.Image imgBuscar 
   ...
   Begin VB.Frame FrameCalculoETT 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   7
         Left            =   1515
         Picture         =   "frmListNomina.frx":1552
         Top             =   1605
         Width           =   240
      End
      Begin VB.Image imgBuscar 
         ...
         Index           =   5
         Left            =   1545
         MouseIcon       =   "frmListNomina.frx":15DD
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar variedad"
         Top             =   1125
         Width           =   240
   ...
   Begin VB.Frame FrameTrabajadoresActivos 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   28
         Left            =   1575
         Picture         =   "frmListNomina.frx":172F
         Top             =   1215
         Width           =   240
      End
   End
   Begin VB.Frame FrameEntradasCapataz 
      ...
      Begin VB.Image imgFecha 
         ...
         Index           =   18
         Left            =   1320
         Picture         =   "frmListNomina.frx":17BA
         Top             =   2715
         Width           =   240
      End
      Begin VB.Image imgFecha 
         ...
         Index           =   17
         Left            =   1335
         Picture         =   "frmListNomina.frx":1845
         Top             =   2340
         Width           =   240
      End
      Begin VB.Image imgBuscar 
         ...
         Index           =   18
         Left            =   1335
         MouseIcon       =   "frmListNomina.frx":18D0
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   1680
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   17
         Left            =   1350
         MouseIcon       =   "frmListNomina.frx":1A22
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar capataz"
         Top             =   1320
         Width           =   240
