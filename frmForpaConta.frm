...
Begin VB.Form frmForpaConta 
   ...
   Caption         =   "Formas de Pago Tesorería"
   ClientHeight    =   5925
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5355
   Icon            =   "frmForpaConta.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5925
   ...
   Begin VB.ComboBox Combo1 
      Appearance      =   0  'Flat
      Height          =   315
      ItemData        =   "frmForpaConta.frx":000C
      Left            =   2520
      List            =   "frmForpaConta.frx":000E
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmForpaConta.frx":0010
      Height          =   4410
      Left            =   120
      TabIndex        =   3
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmForpaConta"
