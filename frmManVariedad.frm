...
Begin VB.Form frmManVariedad 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(27)=   "text2(3)"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "text1(9)"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "text2(9)"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "Frame3"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "text2(26)"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "text1(26)"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "text1(27)"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "text2(27)"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "Frame4"
      Tab(0).Control(35).Enabled=   0   'False
      Tab(0).Control(36)=   "Frame6"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "Combo1(1)"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "Combo1(2)"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "text1(38)"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "text1(39)"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "text1(40)"
      Tab(0).Control(41).Enabled=   0   'False
      Tab(0).Control(42)=   "text1(41)"
      ...
      Begin VB.TextBox text1 
         ...
         MaxLength       =   10
         TabIndex        =   7
         Tag             =   "Codigo NC|T|S|||variedades|codigonc|||"
         Top             =   3105
         Width           =   1405
      End
...
'    End If
    ...
    '[Monica]21/11/2018: cambiamos el label de variedad de retirada por variedad de segunda para Mogente(Almazara)itel
    If vParamAplic.Cooperativa = 3 Then
        Label1(3).Caption = "Variedad Segunda"
    End If

    '[Monica]05/12/2018: si es picassent
    If vParamAplic.Cooperativa = 2 Then
        Label14.Caption = "Euros/Kg Socio"
    End If
...
Dim vCadena As String
    Select Case Index
        ...
        Case 1
            '[Monica]21/11/2018: variedad de segunda de almazara para Mogente
            If vParamAplic.Cooperativa = 3 Then
                 vCadena = "Indica la variedad de segunda asociada a la variedad de almazara." & vbCrLf & vbCrLf & _
                           "En las entradas de almazara se grabará esta variedad si la calidad es de segunda." & vbCrLf & _
                           vbCrLf
            Else
                ' "____________________________________________________________"
...
'    Text2(25).Text = NombreCuentaCorrecta(Text1(25).Text)
        ...
        '[Monica]15/10/2018: contabilidad nueva
...
Private Sub TxtAux4_LostFocus(Index As Integer)
    ...
    Select Case Index
        Case 1 'codigo de calibre
            ...
            Else
                If ModoLineas = 1 Then
                    txtAux4(2).Text = SugerirCodigoSiguienteStr("rcalidad_calibrador", "numlinea", "codvarie = " & DBSet(txtAux4(0).Text, "N") & " and codcalid = " & DBSet(txtAux4(1).Text, "N"))
                End If
            End If
