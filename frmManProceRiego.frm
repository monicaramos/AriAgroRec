...
Begin VB.Form frmManProceRiego 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Procedencia de Riego"
   ClientHeight    =   6240
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   5925
   Icon            =   "frmManProceRiego.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6240
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||rproceriego|nomproce|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|99|rproceriego|codproce|00|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManProceRiego.frx":000C
      Height          =   4545
      Left            =   120
      TabIndex        =   6
      Top             =   855
   ...
   End
End
Attribute VB_Name = "frmManProceRiego"
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("rproceriego", "codproce")
    End If
    '********************************************************************
...
Private Sub BotonBuscar()
    ...
    CargaGrid "rproceriego.codproce = -1"
    '*******************************************************************************
    'Buscar
    For i = 0 To txtAux.Count - 1
        txtAux(i).Text = ""
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar la Procedencia de Riego?"
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from rproceriego where codproce=" & adodc1.Recordset!Codproce
        conn.Execute Sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codproce=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT rproceriego.codproce, rproceriego.nomproce"
    CadenaConsulta = CadenaConsulta & " FROM rproceriego"
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY rproceriego.codproce"
    '**************************************************************++
    
    CargaGridGnral Me.DataGrid1, Me.adodc1, Sql, PrimeraVez
    
    ' *******************canviar els noms i si fa falta la cantitat********************
    tots = "S|txtAux(0)|T|Código|800|;S|txtAux(1)|T|Descripción|4250|;"
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "rproceriego"
        .Informe2 = "rManProceRiego.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={rproceriego.codproce}|"
